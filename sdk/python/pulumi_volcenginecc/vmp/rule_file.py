...
class RuleFileArgs:
    def __init__(__self__, *,
                 ...
                 target_workspace_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a RuleFile resource.

        :param pulumi.Input[_builtins.str] content: Rule file content in YAML format. Content length limits:
    ...
    def target_workspace_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def target_workspace_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _RuleFileState:
    def __init__(__self__, *,
                 ...
                 rule_file_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def rule_file_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Rule file ID.
        """
    ...
    @rule_file_id.setter
    def rule_file_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class RuleFile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            target_workspace_id: pulumi.Input[Optional[_builtins.str]] = None,
            workspace_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RuleFile':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="ruleFileId")
    def rule_file_id(self) -> pulumi.Output[_builtins.str]:
        """
        Rule file ID.
        """
        return pulumi.get(self, "rule_file_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetWorkspaceId")
    def target_workspace_id(self) -> pulumi.Output[_builtins.str]:
        """
        Target workspace ID to write to. If empty, writes to the source workspace.
        """
        return pulumi.get(self, "target_workspace_id")
