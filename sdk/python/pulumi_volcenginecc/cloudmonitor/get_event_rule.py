...
class GetEventRuleResult:
    ...
    def filter_pattern_input(self) -> builtins.str:
...
def get_event_rule(id: Optional[builtins.str] = None,
...
def get_event_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
