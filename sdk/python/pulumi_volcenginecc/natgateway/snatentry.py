...
class SnatentryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] nat_gateway_id: ID of the NAT gateway associated with the SNAT rule
        :param pulumi.Input[_builtins.str] eip_id: ID of the public IP associated with the SNAT rule. Returns the ID for a single public IP. Returns IDs for multiple public IPs.
        :param pulumi.Input[_builtins.str] nat_ip_id: ID of the transit IP for the private NAT gateway
        :param pulumi.Input[_builtins.str] snat_entry_name: Name of the SNAT rule
        :param pulumi.Input[_builtins.str] source_cidr: Network segment corresponding to the SNAT rule
        :param pulumi.Input[_builtins.str] subnet_id: ID of the subnet associated with the SNAT rule
        """
...
class _SnatentryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] eip_address: IP address of the public IP associated with the SNAT rule. Returns the IP address for a single public IP. Returns IP addresses for multiple public IPs.
        :param pulumi.Input[_builtins.str] eip_id: ID of the public IP associated with the SNAT rule. Returns the ID for a single public IP. Returns IDs for multiple public IPs.
        :param pulumi.Input[_builtins.str] nat_gateway_id: ID of the NAT gateway associated with the SNAT rule
        :param pulumi.Input[_builtins.str] nat_ip_id: ID of the transit IP for the private NAT gateway
        :param pulumi.Input[_builtins.str] snat_entry_id: ID of the SNAT rule
        :param pulumi.Input[_builtins.str] snat_entry_name: Name of the SNAT rule
        :param pulumi.Input[_builtins.str] source_cidr: Network segment corresponding to the SNAT rule
        :param pulumi.Input[_builtins.str] status: Status of the SNAT rule. Creating: being created. Deleting: being deleted. Available: available.
        :param pulumi.Input[_builtins.str] subnet_id: ID of the subnet associated with the SNAT rule
        """
...
class Snatentry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_cidr: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            subnet_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'Snatentry':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="snatEntryName")
    def snat_entry_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the SNAT rule
        """
        return pulumi.get(self, "snat_entry_name")
