...
class DnatentryArgs:
    def __init__(__self__, *,
                 ...
                 dnat_entry_name: pulumi.Input[Optional[_builtins.str]] = None,
                 port_type: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Dnatentry resource.

        :param pulumi.Input[_builtins.str] external_ip: IP address used by the NAT gateway for network address translation. If the NAT gateway is a public NAT gateway, enter its bound public IP address. If the NAT gateway is a private NAT gateway, enter its transit IP address.
        :param pulumi.Input[_builtins.str] external_port: Port or port range that receives requests from the public network.
        :param pulumi.Input[_builtins.str] internal_ip: Private IP address of the cloud server instance.
        :param pulumi.Input[_builtins.str] internal_port: Port or port range of the private IP address of the cloud server instance.
        :param pulumi.Input[_builtins.str] nat_gateway_id: ID of the NAT gateway to which the DNAT rule belongs.
        :param pulumi.Input[_builtins.str] protocol: Protocol type. tcp: Forwards TCP protocol packets. udp: Forwards UDP protocol packets.
        :param pulumi.Input[_builtins.str] dnat_entry_name: Name of the DNAT rule.
        :param pulumi.Input[_builtins.str] port_type: Port type of the DNAT rule. specified: Specified port. any: Any port, i.e., IP mapping.
        """
    ...
    def dnat_entry_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def dnat_entry_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _DnatentryState:
    def __init__(__self__, *,
                 dnat_entry_id: pulumi.Input[Optional[_builtins.str]] = None,
                 dnat_entry_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] dnat_entry_id: ID of the DNAT rule.
        :param pulumi.Input[_builtins.str] dnat_entry_name: Name of the DNAT rule.
        :param pulumi.Input[_builtins.str] external_ip: IP address used by the NAT gateway for network address translation. If the NAT gateway is a public NAT gateway, enter its bound public IP address. If the NAT gateway is a private NAT gateway, enter its transit IP address.
        :param pulumi.Input[_builtins.str] external_port: Port or port range that receives requests from the public network.
        :param pulumi.Input[_builtins.str] internal_ip: Private IP address of the cloud server instance.
        ...
        :param pulumi.Input[_builtins.str] port_type: Port type of the DNAT rule. specified: Specified port. any: Any port, i.e., IP mapping.
        :param pulumi.Input[_builtins.str] protocol: Protocol type. tcp: Forwards TCP protocol packets. udp: Forwards UDP protocol packets.
        :param pulumi.Input[_builtins.str] status: Status of the DNAT rule. Creating: Creating. Deleting: Deleting. Available: Available.
        """
    ...
    def dnat_entry_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ID of the DNAT rule.
        """
    ...
    def dnat_entry_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Dnatentry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port_type: pulumi.Input[Optional[_builtins.str]] = None,
            protocol: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None) -> 'Dnatentry':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dnatEntryId")
    def dnat_entry_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the DNAT rule.
        """
        return pulumi.get(self, "dnat_entry_id")
    ...
    @_builtins.property
    @pulumi.getter(name="dnatEntryName")
    def dnat_entry_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the DNAT rule.
        """
        return pulumi.get(self, "dnat_entry_name")
