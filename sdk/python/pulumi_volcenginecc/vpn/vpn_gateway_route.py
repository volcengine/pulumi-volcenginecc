...
class VpnGatewayRouteArgs:
    def __init__(__self__, *,
                 ...
                 next_hop_id: pulumi.Input[_builtins.str],
                 vpn_gateway_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a VpnGatewayRoute resource.

        :param pulumi.Input[_builtins.str] destination_cidr_block: Destination network segment of the VPN gateway route entry.
        :param pulumi.Input[_builtins.str] next_hop_id: ID of the IPsec connection for the route's next hop. You can call DescribeVpnConnections to query the IPsec connection ID.
        :param pulumi.Input[_builtins.str] vpn_gateway_id: ID of the VPN gateway for the route entry to be added.
        """
    ...
    def next_hop_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @next_hop_id.setter
    def next_hop_id(self, value: pulumi.Input[_builtins.str]):
...
class _VpnGatewayRouteState:
    def __init__(__self__, *,
                 as_paths: pulumi.Input[Optional[Sequence[pulumi.Input['VpnGatewayRouteAsPathArgs']]]] = None,
                 ...
                 next_tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 vpn_gateway_route_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering VpnGatewayRoute resources.

        :param pulumi.Input[Sequence[pulumi.Input['VpnGatewayRouteAsPathArgs']]] as_paths: AS path information traversed by the BGP route entry.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] creation_time: Time when the VPN gateway route entry was created.
        :param pulumi.Input[_builtins.str] destination_cidr_block: Destination network segment of the VPN gateway route entry.
        :param pulumi.Input[_builtins.str] next_hop_id: ID of the IPsec connection for the route's next hop. You can call DescribeVpnConnections to query the IPsec connection ID.
        :param pulumi.Input[_builtins.str] next_tunnel_id: Next hop tunnel ID. This parameter is returned only for VPN gateways in dual-tunnel mode.
        :param pulumi.Input[_builtins.str] route_type: Route type. Static: static route; BGP: BGP route; Cloud: VPC route in the cloud. Note: Route types synchronized from transit routers (TR) are not currently supported for display.
        :param pulumi.Input[_builtins.str] status: Status of the VPN gateway route entry. Creating: being created; Deleting: being deleted; Pending: being configured; Available: preferred route in effect; Conflicted: not preferred or not in effect. Note: When route prefixes are the same, the route priority is Cloud > Static route > BGP route. Therefore, there may be multiple routes with the same prefix, some with status Available and others with status Conflicted.
        :param pulumi.Input[_builtins.str] update_time: Time when the VPN gateway route entry was modified.
        :param pulumi.Input[_builtins.str] vpn_gateway_id: ID of the VPN gateway for the route entry to be added.
        :param pulumi.Input[_builtins.str] vpn_gateway_route_id: ID of the VPN gateway route entry.
        """
    ...
    def as_paths(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpnGatewayRouteAsPathArgs']]]]:
        """
    ...
    @as_paths.setter
    def as_paths(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpnGatewayRouteAsPathArgs']]]]):
    ...
    def next_tunnel_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def next_tunnel_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def vpn_gateway_route_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def vpn_gateway_route_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class VpnGatewayRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            as_paths: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpnGatewayRouteAsPathArgs', 'VpnGatewayRouteAsPathArgsDict']]]]] = None,
            creation_time: pulumi.Input[Optional[_builtins.str]] = None,
            destination_cidr_block: pulumi.Input[Optional[_builtins.str]] = None,
            next_hop_id: pulumi.Input[Optional[_builtins.str]] = None,
            next_tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            vpn_gateway_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpn_gateway_route_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'VpnGatewayRoute':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpnGatewayRouteAsPathArgs', 'VpnGatewayRouteAsPathArgsDict']]]] as_paths: AS path information traversed by the BGP route entry.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] creation_time: Time when the VPN gateway route entry was created.
        :param pulumi.Input[_builtins.str] destination_cidr_block: Destination network segment of the VPN gateway route entry.
        :param pulumi.Input[_builtins.str] next_hop_id: ID of the IPsec connection for the route's next hop. You can call DescribeVpnConnections to query the IPsec connection ID.
    ...
    @_builtins.property
    @pulumi.getter(name="nextHopId")
    def next_hop_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the IPsec connection for the route's next hop. You can call DescribeVpnConnections to query the IPsec connection ID.
        """
        return pulumi.get(self, "next_hop_id")
    ...
    @_builtins.property
    @pulumi.getter(name="nextTunnelId")
    def next_tunnel_id(self) -> pulumi.Output[_builtins.str]:
        """
        Next hop tunnel ID. This parameter is returned only for VPN gateways in dual-tunnel mode.
        """
        return pulumi.get(self, "next_tunnel_id")
    ...
    @_builtins.property
    @pulumi.getter(name="vpnGatewayRouteId")
    def vpn_gateway_route_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the VPN gateway route entry.
        """
        return pulumi.get(self, "vpn_gateway_route_id")
