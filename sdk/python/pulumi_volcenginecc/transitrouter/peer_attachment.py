...
class PeerAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 peer_transit_router_region_id: pulumi.Input[_builtins.str],
                 transit_router_id: pulumi.Input[_builtins.str],
                 bandwidth: pulumi.Input[Optional[_builtins.int]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['PeerAttachmentTagArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] peer_transit_router_id: ID of the peer transit router instance. You can call the DescribeTransitRouters API to obtain the transit router instance ID.
        :param pulumi.Input[_builtins.str] peer_transit_router_region_id: Region ID of the peer transit router instance. Refer to the region documentation to obtain the region ID.
        :param pulumi.Input[_builtins.str] transit_router_id: ID of the local transit router instance.
        :param pulumi.Input[_builtins.int] bandwidth: Bandwidth for cross-region connection, measured in Mbps. The maximum bandwidth cannot exceed the remaining unallocated bandwidth limit of the specified transit router bandwidth package.
        :param pulumi.Input[_builtins.str] description: Description of the cross-region connection. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: English comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length limit: 0–255 characters. If this parameter is not provided or no value is specified, the default is an empty string.
        :param pulumi.Input[Sequence[pulumi.Input['PeerAttachmentTagArgs']]] tags: Tag list for the cross-region connection.
    ...
    def peer_transit_router_region_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def peer_transit_router_region_id(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PeerAttachmentTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PeerAttachmentTagArgs']]]]):
...
class _PeerAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] auto_publish_route_enabled: Automatically synchronize TR routes to the network instance route table. true: Yes. false: No.
        :param pulumi.Input[_builtins.int] bandwidth: Bandwidth for cross-region connection, measured in Mbps. The maximum bandwidth cannot exceed the remaining unallocated bandwidth limit of the specified transit router bandwidth package.
        :param pulumi.Input[_builtins.str] creation_time: Creation time of the cross-region connection.
        :param pulumi.Input[_builtins.str] description: Description of the cross-region connection. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: English comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length limit: 0–255 characters. If this parameter is not provided or no value is specified, the default is an empty string.
        :param pulumi.Input[_builtins.bool] ipv6_enabled: Enable IPv6. true: Yes. false: No.
        :param pulumi.Input[_builtins.str] peer_transit_router_id: ID of the peer transit router instance. You can call the DescribeTransitRouters API to obtain the transit router instance ID.
        :param pulumi.Input[_builtins.str] peer_transit_router_region_id: Region ID of the peer transit router instance. Refer to the region documentation to obtain the region ID.
        :param pulumi.Input[_builtins.str] status: Status of the cross-region connection. Creating: In progress. Deleting: In progress. Pending: Configuring. Available: Available.
        :param pulumi.Input[Sequence[pulumi.Input['PeerAttachmentTagArgs']]] tags: Tag list for the cross-region connection.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] transit_router_attachment_id: ID of the cross-region connection.
        :param pulumi.Input[_builtins.str] transit_router_attachment_name: Name of the cross-region connection. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length limit: 1–128 characters. If this parameter is not provided or no value is specified, the default is the transit router instance ID.
        :param pulumi.Input[_builtins.str] transit_router_bandwidth_package_id: ID of the transit router bandwidth package. You can call the DescribeTransitRouters API to obtain the transit router instance ID. If this parameter is provided, the Bandwidth parameter must also be provided. If this parameter is not provided, the Bandwidth parameter is not required.
        ...
        :param pulumi.Input[_builtins.str] transit_router_id: ID of the local transit router instance.
        :param pulumi.Input[_builtins.str] transit_router_route_table_id: Associated forwarding route table for the cross-region connection.
        :param pulumi.Input[_builtins.str] transit_router_traffic_qos_marking_policy_id: ID of the traffic marking policy associated with the cross-region connection.
        ...
        :param pulumi.Input[_builtins.str] update_time: Last operation time of the cross-region connection.
        """
...
class PeerAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 peer_transit_router_id: pulumi.Input[Optional[_builtins.str]] = None,
                 peer_transit_router_region_id: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PeerAttachmentTagArgs', 'PeerAttachmentTagArgsDict']]]]] = None,
                 transit_router_attachment_name: pulumi.Input[Optional[_builtins.str]] = None,
                 transit_router_bandwidth_package_id: pulumi.Input[Optional[_builtins.str]] = None,
                 transit_router_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] peer_transit_router_id: ID of the peer transit router instance. You can call the DescribeTransitRouters API to obtain the transit router instance ID.
        :param pulumi.Input[_builtins.str] peer_transit_router_region_id: Region ID of the peer transit router instance. Refer to the region documentation to obtain the region ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PeerAttachmentTagArgs', 'PeerAttachmentTagArgsDict']]]] tags: Tag list for the cross-region connection.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] transit_router_attachment_name: Name of the cross-region connection. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length limit: 1–128 characters. If this parameter is not provided or no value is specified, the default is the transit router instance ID.
        :param pulumi.Input[_builtins.str] transit_router_bandwidth_package_id: ID of the transit router bandwidth package. You can call the DescribeTransitRouters API to obtain the transit router instance ID. If this parameter is provided, the Bandwidth parameter must also be provided. If this parameter is not provided, the Bandwidth parameter is not required.
        :param pulumi.Input[_builtins.str] transit_router_id: ID of the local transit router instance.
    ...
    def get(resource_name: str,
            ...
            transit_router_traffic_qos_marking_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            transit_router_traffic_qos_queue_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'PeerAttachment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="peerTransitRouterRegionId")
    def peer_transit_router_region_id(self) -> pulumi.Output[_builtins.str]:
        """
        Region ID of the peer transit router instance. Refer to the region documentation to obtain the region ID.
        """
        return pulumi.get(self, "peer_transit_router_region_id")
