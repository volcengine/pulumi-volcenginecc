...
class TransitRouterRouteTableArgs:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['TransitRouterRouteTableTagArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TransitRouterRouteTableTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TransitRouterRouteTableTagArgs']]]]):
...
class _TransitRouterRouteTableState:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 in_route_policy_table_id: pulumi.Input[Optional[_builtins.str]] = None,
                 out_route_policy_table_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] created_time: Creation time of the TR routing table
        :param pulumi.Input[_builtins.str] description: Description of the TR routing table. Must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length limit: 0–255 characters. If this parameter is not provided or no value is specified, the default is an empty string.
        :param pulumi.Input[_builtins.str] in_route_policy_table_id: ID of the inbound routing policy associated with the TR routing table
        :param pulumi.Input[_builtins.str] out_route_policy_table_id: ID of the outbound routing policy associated with the TR routing table
        :param pulumi.Input[_builtins.str] status: Status of the TR routing table. Creating: creating. Deleting: deleting. Pending: configuring. Available: available
        :param pulumi.Input[Sequence[pulumi.Input['TransitRouterRouteTableTagArgs']]] tags: Tag information for the TR routing table
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] transit_router_id: Transit Router instance ID
        :param pulumi.Input[_builtins.str] transit_router_route_table_id: TR routing table ID
        :param pulumi.Input[_builtins.str] transit_router_route_table_name: Name of the TR routing table. Must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length limit: 1–128 characters. If this parameter is not provided or no value is specified, the default is the TR routing table ID
        :param pulumi.Input[_builtins.str] transit_router_route_table_type: Type of TR routing table. System: system routing table. Custom: custom routing table.
        :param pulumi.Input[_builtins.str] updated_time: Last operation time of the TR routing table
        """
    ...
    def in_route_policy_table_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def in_route_policy_table_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "in_route_policy_table_id", value)

    @_builtins.property
    @pulumi.getter(name="outRoutePolicyTableId")
    def out_route_policy_table_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def out_route_policy_table_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class TransitRouterRouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TransitRouterRouteTableTagArgs', 'TransitRouterRouteTableTagArgsDict']]]]] = None,
                 transit_router_id: pulumi.Input[Optional[_builtins.str]] = None,
                 transit_router_route_table_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: Description of the TR routing table. Must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length limit: 0–255 characters. If this parameter is not provided or no value is specified, the default is an empty string.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TransitRouterRouteTableTagArgs', 'TransitRouterRouteTableTagArgsDict']]]] tags: Tag information for the TR routing table
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] transit_router_id: Transit Router instance ID
        :param pulumi.Input[_builtins.str] transit_router_route_table_name: Name of the TR routing table. Must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length limit: 1–128 characters. If this parameter is not provided or no value is specified, the default is the TR routing table ID
        """
    ...
    def get(resource_name: str,
            ...
            transit_router_route_table_name: pulumi.Input[Optional[_builtins.str]] = None,
            transit_router_route_table_type: pulumi.Input[Optional[_builtins.str]] = None,
            updated_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'TransitRouterRouteTable':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="inRoutePolicyTableId")
    def in_route_policy_table_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the inbound routing policy associated with the TR routing table
        """
        return pulumi.get(self, "in_route_policy_table_id")
    ...
    @_builtins.property
    @pulumi.getter(name="outRoutePolicyTableId")
    def out_route_policy_table_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the outbound routing policy associated with the TR routing table
        """
        return pulumi.get(self, "out_route_policy_table_id")
    ...
    @_builtins.property
    @pulumi.getter(name="transitRouterRouteTableName")
    def transit_router_route_table_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the TR routing table. Must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length limit: 1–128 characters. If this parameter is not provided or no value is specified, the default is the TR routing table ID
        """
        return pulumi.get(self, "transit_router_route_table_name")
