...
class _TransitRouterRouteTableAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Status of the forwarding association. Available: Available. Creating: Creating. Configuring: Being configured. Deleting: Deleting.
        :param pulumi.Input[builtins.str] transit_router_attachment_id: ID of the network instance connection.
        :param pulumi.Input[builtins.str] transit_router_route_table_id: ID of the route table associated with the transit router instance.
        """
...
@pulumi.type_token("volcenginecc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation")
class TransitRouterRouteTableAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        transit_router_route_table_association_demo = volcenginecc.transitrouter.TransitRouterRouteTableAssociation("TransitRouterRouteTableAssociationDemo",
    ...
    def _internal_init(__self__,
        ...
        super(TransitRouterRouteTableAssociation, __self__).__init__(
            'volcenginecc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation',
            resource_name,
            __props__,
            opts)
