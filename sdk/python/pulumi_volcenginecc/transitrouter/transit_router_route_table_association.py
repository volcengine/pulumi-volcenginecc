...
class TransitRouterRouteTableAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] transit_router_attachment_id: ID of the network instance connection.
...
class _TransitRouterRouteTableAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status: Status of the forwarding association. Available: Available. Creating: Creating. Configuring: Being configured. Deleting: Deleting.
        :param pulumi.Input[_builtins.str] transit_router_attachment_id: ID of the network instance connection.
        :param pulumi.Input[_builtins.str] transit_router_route_table_id: ID of the route table associated with the transit router instance.
        """
