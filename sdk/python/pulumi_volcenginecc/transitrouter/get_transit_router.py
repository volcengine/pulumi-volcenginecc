...
class GetTransitRouterResult:
    ...
    def grant_source_type(self) -> _builtins.str:
        """
    ...
    def multicast_enabled(self) -> _builtins.bool:
        """
...
def get_transit_router(id: Optional[_builtins.str] = None,
...
def get_transit_router_output(id: pulumi.Input[Optional[_builtins.str]] = None,
