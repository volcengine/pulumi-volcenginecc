...
def get_direct_connect_gateway_attachment(id: Optional[_builtins.str] = None,
...
def get_direct_connect_gateway_attachment_output(id: pulumi.Input[Optional[_builtins.str]] = None,
