...
class DirectConnectGatewayAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] direct_connect_gateway_id: Direct connect gateway ID. You can call the DescribeDirectConnectGateways API to obtain the direct connect gateway ID
        :param pulumi.Input[builtins.str] transit_router_id: Transit router instance ID. You can call the DescribeTransitRouters API to obtain the transit router instance ID
...
class _DirectConnectGatewayAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: Account ID to which the network instance connection belongs
        :param pulumi.Input[builtins.bool] auto_publish_route_enabled: Whether to automatically synchronize TR routes to the network instance route table
        :param pulumi.Input[builtins.int] bandwidth: Maximum bandwidth of the network instance connection, in Gbps
        ...
        :param pulumi.Input[builtins.str] status: Status of the network instance connection. Creating means being created, Deleting means being deleted, Pending means being configured, Available means available
        :param pulumi.Input[builtins.str] transit_router_attachment_id: Network instance connection ID
        :param pulumi.Input[builtins.str] transit_router_attachment_name: Name of the network instance connection. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length can be 1–128 characters. If this parameter is not provided or no value is passed, the default is the network instance connection ID
        :param pulumi.Input[builtins.str] transit_router_id: Transit router instance ID. You can call the DescribeTransitRouters API to obtain the transit router instance ID
        :param pulumi.Input[builtins.str] update_time: Most recent operation time of the network instance connection
        """
...
class DirectConnectGatewayAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 direct_connect_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DirectConnectGatewayAttachmentTagArgs', 'DirectConnectGatewayAttachmentTagArgsDict']]]]] = None,
                 transit_router_attachment_name: Optional[pulumi.Input[builtins.str]] = None,
                 transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            transit_router_attachment_name: Optional[pulumi.Input[builtins.str]] = None,
            transit_router_id: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'DirectConnectGatewayAttachment':
        """
