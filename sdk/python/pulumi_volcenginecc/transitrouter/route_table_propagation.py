...
class _RouteTablePropagationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] creation_time: Route learning creation time.
        :param pulumi.Input[_builtins.str] status: Route learning status. Available: Available. Creating: Creating. Pending: Pending. Deleting: Deleting.
        :param pulumi.Input[_builtins.str] transit_router_attachment_id: ID of the network instance connection.
        :param pulumi.Input[_builtins.str] transit_router_route_table_id: ID of the route table associated with the transit router instance.
        """
...
class RouteTablePropagation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            transit_router_attachment_id: pulumi.Input[Optional[_builtins.str]] = None,
            transit_router_route_table_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RouteTablePropagation':
        """
