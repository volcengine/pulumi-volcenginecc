...
def get_transit_router_route_table_association(id: Optional[_builtins.str] = None,
...
def get_transit_router_route_table_association_output(id: pulumi.Input[Optional[_builtins.str]] = None,
