...
class EndpointAclPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] registry: Name of the image repository instance. On the Instance List page in the Image Repository Console, obtain the instance name
        :param pulumi.Input[_builtins.str] type: Network type of the allowlist; currently only Public is supported
        :param pulumi.Input[_builtins.str] description: Description of the allowlist IPs
        :param pulumi.Input[_builtins.str] entry: Allowlist IPs to be added
        """
...
class EndpointAclPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entry: pulumi.Input[Optional[_builtins.str]] = None,
            registry: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'EndpointAclPolicy':
        """
