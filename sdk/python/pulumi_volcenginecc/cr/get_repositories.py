...
def get_repositories(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRepositoriesResult:
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:cr/getRepositories:getRepositories', __args__, opts=opts, typ=GetRepositoriesResult).value
...
def get_repositories_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRepositoriesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:cr/getRepositories:getRepositories', __args__, opts=opts, typ=GetRepositoriesResult)
