...
class GetRegistryResult:
    ...
    def proxy_cache_enabled(self) -> _builtins.bool:
        """
...
def get_registry(id: Optional[_builtins.str] = None,
...
def get_registry_output(id: pulumi.Input[Optional[_builtins.str]] = None,
