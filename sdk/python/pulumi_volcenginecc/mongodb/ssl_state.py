...
class _SslStateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Instance ID
        :param pulumi.Input[_builtins.bool] is_valid: Whether the SSL certificate is valid. Possible values:   - true: Valid   - false: Invalid
        :param pulumi.Input[_builtins.str] ssl_action: Perform operations on the SSL encryption feature. Possible values:   - Open (default): Enable SSL encryption   - Close: Disable SSL encryption   - Update: Update SSL certificate validity period. You can update the SSL certificate validity period only after SSL encryption is enabled.
        :param pulumi.Input[_builtins.bool] ssl_enable: Whether SSL encryption is enabled. Possible values:   - true: Enabled   - false: Disabled
        :param pulumi.Input[_builtins.str] ssl_expired_time: SSL certificate expiration time, formatted as yyyy-MM-ddTHH:mm:ssZ (UTC). This parameter is returned only when the SSL certificate is valid (that is, IsValid is true).
        """
...
class SslState(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_action: pulumi.Input[Optional[_builtins.str]] = None,
            ssl_enable: pulumi.Input[Optional[_builtins.bool]] = None,
            ssl_expired_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'SslState':
        """
