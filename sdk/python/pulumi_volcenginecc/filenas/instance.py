...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 cache_performance: pulumi.Input[Optional['InstanceCachePerformanceArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] charge_type: Billing type. Value: PayAsYouGo, indicates pay-as-you-go billing
        :param pulumi.Input[_builtins.str] file_system_name: File system name
        :param pulumi.Input[_builtins.str] file_system_type: File system type. Possible values: Extreme: NAS Extreme type; Capacity: NAS Capacity type; Cache: NAS Cache type
        :param pulumi.Input[_builtins.str] protocol_type: File system protocol type. Value: NFS, indicates NFS protocol, commonly used for Linux clients
        ...
        :param pulumi.Input[_builtins.str] project_name: Project, default value is the Default project
        :param pulumi.Input[_builtins.str] snapshot_id: Snapshot ID used at creation. If this parameter is provided, the file system will be created from the snapshot
        :param pulumi.Input[_builtins.str] storage_type: Storage type. Value: Standard, indicates standard type
        :param pulumi.Input[Sequence[pulumi.Input['InstanceTagArgs']]] tags: File system tag information
    ...
    def cache_performance(self) -> pulumi.Input[Optional['InstanceCachePerformanceArgs']]:
        """
    ...
    def cache_performance(self, value: pulumi.Input[Optional['InstanceCachePerformanceArgs']]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_name: Project, default value is the Default project
        :param pulumi.Input[_builtins.str] protocol_type: File system protocol type. Value: NFS, indicates NFS protocol, commonly used for Linux clients
        :param pulumi.Input[_builtins.int] snapshot_count: Number of snapshots
        :param pulumi.Input[_builtins.str] snapshot_id: Snapshot ID used at creation. If this parameter is provided, the file system will be created from the snapshot
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cache_performance: pulumi.Input[Optional[Union['InstanceCachePerformanceArgs', 'InstanceCachePerformanceArgsDict']]] = None,
        ...
        :param pulumi.Input[_builtins.str] snapshot_id: Snapshot ID used at creation. If this parameter is provided, the file system will be created from the snapshot
        :param pulumi.Input[_builtins.str] storage_type: Storage type. Value: Standard, indicates standard type
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceTagArgs', 'InstanceTagArgsDict']]]] tags: File system tag information
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] zone_id: Availability Zone ID
        """
        ...
