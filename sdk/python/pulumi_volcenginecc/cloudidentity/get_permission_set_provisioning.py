...
def get_permission_set_provisioning(id: Optional[_builtins.str] = None,
...
def get_permission_set_provisioning_output(id: pulumi.Input[Optional[_builtins.str]] = None,
