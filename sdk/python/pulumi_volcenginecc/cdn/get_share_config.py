...
class GetShareConfigResult:
    ...
    def rule_content(self) -> _builtins.str:
        """
...
def get_share_config(id: Optional[_builtins.str] = None,
...
def get_share_config_output(id: pulumi.Input[Optional[_builtins.str]] = None,
