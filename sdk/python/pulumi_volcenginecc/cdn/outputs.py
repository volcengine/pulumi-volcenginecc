...
__all__ = [
    ...
    'DomainBrowserCache',
    'DomainBrowserCacheCacheAction',
    'DomainBrowserCacheCondition',
    'DomainBrowserCacheConditionConditionRule',
    'DomainCache',
    'DomainCacheCacheAction',
    'DomainCacheCondition',
    'DomainCacheConditionConditionRule',
    'DomainCacheHost',
    ...
    'DomainMultiRange',
    'DomainNegativeCache',
    'DomainNegativeCacheCondition',
    'DomainNegativeCacheConditionConditionRule',
    'DomainNegativeCacheNegativeCacheRule',
    'DomainOfflineCache',
    'DomainOrigin',
    ...
    'GetDomainBrowserCacheResult',
    'GetDomainBrowserCacheCacheActionResult',
    'GetDomainBrowserCacheConditionResult',
    'GetDomainBrowserCacheConditionConditionRuleResult',
    'GetDomainCacheResult',
    'GetDomainCacheCacheActionResult',
    'GetDomainCacheConditionResult',
    'GetDomainCacheConditionConditionRuleResult',
    ...
    'GetDomainNegativeCacheResult',
    'GetDomainNegativeCacheConditionResult',
    'GetDomainNegativeCacheConditionConditionRuleResult',
    'GetDomainNegativeCacheNegativeCacheRuleResult',
...
class DomainAreaAccessRule(dict):
    ...
    def __init__(__self__, *,
                 areas: Optional[Sequence[_builtins.str]] = None,
                 rule_type: Optional[_builtins.str] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] areas: Indicates a list of countries to which an allowlist or denylist is applied. When Switch is true, this parameter is required. Country names are represented in abbreviated form. Multiple country names are separated by commas (,).
        :param _builtins.str rule_type: Indicates the rule type for the 'region access control' feature. This parameter has the following values: deny: indicates Denylist. allow: indicates Allowlist.
        :param _builtins.bool switch: Indicates whether to enable this feature. This parameter has the following values: true: Enables this feature. false: Disables this feature.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def areas(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DomainBrowserCache(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainBrowserCache. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainBrowserCache.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 cache_action: Optional['outputs.DomainBrowserCacheCacheAction'] = None,
                 condition: Optional['outputs.DomainBrowserCacheCondition'] = None):
        """
        :param 'DomainBrowserCacheCacheActionArgs' cache_action: Indicates the relevant configuration for cache behavior.
        :param 'DomainBrowserCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
    ...
    def cache_action(self) -> Optional['outputs.DomainBrowserCacheCacheAction']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> Optional['outputs.DomainBrowserCacheCondition']:
        """
...
@pulumi.output_type
class DomainBrowserCacheCacheAction(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainBrowserCacheCacheAction. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainBrowserCacheCacheAction.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Indicates caching behavior. Currently, you can only specify cache. cache means the behavior is caching.
        :param _builtins.str default_policy: This parameter is shared by multiple CDN features.
        :param _builtins.bool ignore_case: Indicates whether Value is case sensitive. The parameter has the following values: true: not case sensitive. false: case sensitive. The default value is false.
        :param _builtins.int ttl: Indicates the cache duration in seconds. The valid range is 0–315,360,000. 315,360,000 represents 10 years. If you do not want the content delivery network to cache the specified content, set this parameter to 0.
        """
...
@pulumi.output_type
class DomainBrowserCacheCondition(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainBrowserCacheCondition. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainBrowserCacheCondition.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 condition_rules: Optional[Sequence['outputs.DomainBrowserCacheConditionConditionRule']] = None,
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainBrowserCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
    ...
    def condition_rules(self) -> Optional[Sequence['outputs.DomainBrowserCacheConditionConditionRule']]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def connective(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class DomainBrowserCacheConditionConditionRule(dict):
    def __init__(__self__, *,
...
class DomainCache(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainCache. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainCache.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 cache_action: Optional['outputs.DomainCacheCacheAction'] = None,
                 condition: Optional['outputs.DomainCacheCondition'] = None):
        """
        :param 'DomainCacheCacheActionArgs' cache_action: Indicates the relevant configuration for cache behavior.
        :param 'DomainCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        if cache_action is not None:
            pulumi.set(__self__, "cache_action", cache_action)
        if condition is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="cacheAction")
    def cache_action(self) -> Optional['outputs.DomainCacheCacheAction']:
        """
        Indicates the relevant configuration for cache behavior.
        """
        return pulumi.get(self, "cache_action")
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> Optional['outputs.DomainCacheCondition']:
        """
        Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        return pulumi.get(self, "condition")
...
@pulumi.output_type
class DomainCacheCacheAction(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "defaultPolicy":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainCacheCacheAction. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainCacheCacheAction.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class DomainCacheCondition(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "conditionRules":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainCacheCondition. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainCacheCondition.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 condition_rules: Optional[Sequence['outputs.DomainCacheConditionConditionRule']] = None,
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="conditionRules")
    def condition_rules(self) -> Optional[Sequence['outputs.DomainCacheConditionConditionRule']]:
        """
        Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
@pulumi.output_type
class DomainCacheConditionConditionRule(dict):
    def __init__(__self__, *,
                 name: Optional[_builtins.str] = None,
                 object: Optional[_builtins.str] = None,
                 operator: Optional[_builtins.str] = None,
...
class DomainCacheHost(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainCacheHostCacheHostRuleArgs'] cache_host_rules: Indicates a set of shared cache HOST configurations. Currently, you can only create one configuration. When Switch is true, this parameter is required.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether to enable this feature. This parameter has the following values: true: enables the feature; false: disables the feature. The default value is false.
        """
...
class DomainCacheHostCacheHostRuleCacheHostAction(dict):
    ...
    def __init__(__self__, *,
                 cache_host: Optional[_builtins.str] = None):
        """
        :param _builtins.str cache_host: Specifies the target domain name. The target domain name must be an acceleration domain under your account. This parameter indicates that Domain shares the cache of CacheHost.
        """
    ...
    def cache_host(self) -> Optional[_builtins.str]:
        """
...
class DomainCacheHostCacheHostRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainCacheHostCacheHostRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainCacheKeyCacheKeyAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainCacheKeyCacheKeyActionCacheKeyComponentArgs'] cache_key_components: Indicates a list of operation configurations. Currently, you can only set one operation configuration.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainCacheKeyCacheKeyActionCacheKeyComponent(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def subobject(self) -> Optional[_builtins.str]:
        """
...
class DomainCacheKeyCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainCacheKeyConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainCompression(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainCompressionCompressionRuleArgs'] compression_rules: Indicates a set of smart compression configuration rules. This parameter is required when Switch is true.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Smart compression configuration switch. This parameter has the following values: true: enables smart compression. false: disables smart compression.
        """
...
class DomainCompressionCompressionRuleCompressionAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 compression_target: Optional[_builtins.str] = None,
                 compression_types: Optional[Sequence[_builtins.str]] = None,
                 max_file_size_kb: Optional[_builtins.int] = None,
                 min_file_size_kb: Optional[_builtins.int] = None):
        """
        :param _builtins.str compression_format: If the matching condition is based on the Content-Type header (when Condition is null or not specified), this parameter specifies the matching criteria for Content-Type. The values are as follows: default: matches file types included in the default Content-Type list. customize: matches custom file types in the Content-Type header. If Condition is not null, the matching criteria are defined in ConditionRule. In this case, this parameter must be set to all.
        :param _builtins.str compression_target: Specifies the file types to compress. The parameter is described as follows: If CompressionFormat is default, this parameter must be set to *, indicating the default Content-Type list. The list includes the following file types: text/html, text/xml, text/plain, text/css, application/javascript, application/x-javascript, application/rss+xml, text/javascript, image/tiff, image/svg+xml, application/json, application/xml, text/plain; charset=utf-8. If CompressionFormat is customize, you need to specify one or more file types. Multiple file types are separated by commas (,). If CompressionFormat is all, this parameter must be set to *.
        :param Sequence[_builtins.str] compression_types: Compression algorithm: gzip and br specify the compression type. default: compresses all files by default, with the target count as *. customize: compresses custom file types. Choices: [default, customize]
        :param _builtins.int max_file_size_kb: Indicates the minimum value for the file size range. CDN only compresses files within the range specified by MinFileSizeKB and MaxFileSizeKB. The parameter value range is 0   - 2,147,483,647, the unit is KB, and the base is 1,024. The default value is 0.
        :param _builtins.int min_file_size_kb: Indicates the maximum value for the file size range. The value range is 0   - 2,147,483,647, in KB, using a base of 1,024. If this parameter is not specified, there is no upper limit for file size.
        """
    ...
    def compression_target(self) -> Optional[_builtins.str]:
        """
    ...
    def compression_types(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def max_file_size_kb(self) -> Optional[_builtins.int]:
        """
    ...
    def min_file_size_kb(self) -> Optional[_builtins.int]:
        """
...
class DomainCompressionCompressionRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainCompressionCompressionRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainConditionalOrigin(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter has the following values: true: enables the feature. false: disables the feature. The default value is false.
        """
...
class DomainConditionalOriginOriginRuleActions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainConditionalOriginOriginRuleActionsOriginLineArgs'] origin_lines: Indicates a list of origin configurations. Currently, the list can contain only one origin configuration.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainConditionalOriginOriginRuleActionsOriginLine(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: Represents the address of an origin server. When InstanceType is ip, Address specifies an IPv4 or IPv6 address. When InstanceType is domain, Address specifies a domain name. The domain name cannot be a wildcard domain. If you specify OriginLines, Address is required.
        :param _builtins.str http_port: Indicates the port used by the content delivery network to access the origin server via the HTTP protocol. The valid range is 1–65535, with a default value of 80. If the origin server does not have this port open, you do not need to specify this parameter.
        :param _builtins.str https_port: Specifies the port used by the content delivery network to access the origin server via HTTPS. The value range is 1–65535, and the default is 443. If the origin server does not open this port, you do not need to specify this parameter.
        :param _builtins.str instance_type: Indicates the type of origin. The parameter has the following values: ip: indicates an IP address. domain: indicates a domain name. InstanceType is required if OriginLines is specified.
        :param _builtins.str origin_host: If there are multiple sites on the origin server, this parameter specifies the domain name accessed by the origin request. This parameter takes precedence over the global OriginHost parameter. The value of this parameter cannot exceed 1,024 characters. The default value is the same as the global OriginHost.
        """
...
class DomainConditionalOriginOriginRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainConditionalOriginOriginRuleConditionConditionGroupArgs'] condition_groups: ConditionGroups
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Specifies the relationship between these condition groups. This parameter has the following values: or: Indicates an 'or' relationship. In this case, if any condition group is met, the user request matches the rule. and: Indicates an 'and' relationship. In this case, all condition groups must be met for the user request to match the rule. The default value is or.
        :param _builtins.bool is_group: Indicates whether each filter condition is a condition group. The value of this parameter is always true, meaning each filter condition is a condition group. Currently, each condition group can only contain one filter condition.
        """
...
class DomainCustomErrorPage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainCustomErrorPageErrorPageRuleArgs'] error_page_rules: Indicates a set of configuration rules. You can add up to 50 rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter values are: true: Enabled. false: Disabled. The default value is false.
        """
...
class DomainCustomErrorPageErrorPageRuleErrorPageAction(dict):
    ...
    def __init__(__self__, *,
                 action: Optional[_builtins.str] = None,
                 redirect_code: Optional[_builtins.str] = None,
                 redirect_url: Optional[_builtins.str] = None,
                 status_code: Optional[_builtins.str] = None):
        """
        :param _builtins.str action: Indicates the actual operation. Currently, you can only set this parameter to redirect. This means the client request will be redirected.
        :param _builtins.str redirect_code: Indicates the response status code for redirection. You can select an appropriate status code as needed. The available values are 301, 302, 303, 307, and 308. Note: For 301 and 302, if the original request method is not GET, the client may use GET when sending the new request to the new URL. For 303, the new request method is GET. For 307 and 308, the new request method remains the same as the original request and will not be changed.
        :param _builtins.str redirect_url: Indicates the target address for redirection. The length must not exceed 1,024 characters. The address must include the protocol, domain name, and path, and comply with URL specifications.
        :param _builtins.str status_code: Indicates a status code, with a value range of 400–599. You can enter 4xx or 5xx. 4xx covers all status codes from 400 to 499. 5xx covers all status codes from 500 to 599.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    def redirect_code(self) -> Optional[_builtins.str]:
        """
...
class DomainCustomizeAccessRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainCustomizeAccessRuleCustomizeInstanceArgs'] customize_instances: Describes a rule list. Each rule in the list defines a Denylist or Allowlist configuration. The list can contain up to 10 rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether this feature is enabled. This parameter has the following options: true: Enable this feature. false: Disable this feature. The default value for this parameter is false.
        """
...
class DomainCustomizeAccessRuleCustomizeInstanceCustomizeRuleAccessAction(dict):
    ...
    def list_rules(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def request_header(self) -> Optional[_builtins.str]:
        """
...
class DomainDomainLock(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str remark: Indicates the reason why the acceleration domain is locked. If Status is on, this parameter provides a description of the reason. If Status is off, this parameter is empty ("")
        :param _builtins.str status: Indicates the lock status of the acceleration domain name. The parameter has the following values: on: the acceleration domain name is locked. off: the acceleration domain name is not locked.
        """
...
class DomainDownloadSpeedLimit(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainDownloadSpeedLimitDownloadSpeedLimitRuleArgs'] download_speed_limit_rules: Indicates the rule for download rate limiting. This parameter is required when Switch is true.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter has the following values: true: enables the feature. false: disables the feature. The default value is false.
        """
...
class DomainDownloadSpeedLimitDownloadSpeedLimitRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainDownloadSpeedLimitDownloadSpeedLimitRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainDownloadSpeedLimitDownloadSpeedLimitRuleDownloadSpeedLimitAction(dict):
    ...
    def __init__(__self__, *,
                 speed_limit_rate: Optional[_builtins.int] = None,
                 speed_limit_rate_after: Optional[_builtins.int] = None,
        ...
        """
        :param _builtins.int speed_limit_rate: Indicates the maximum download speed for a single request, measured in B/S. The parameter range is 1–1,073,741,824,000,000, using a base conversion of 1,024.
        :param _builtins.int speed_limit_rate_after: Represents a data volume. Download throttling is enabled for a request only when the amount of data downloaded in a single request reaches this value. Unit: Byte. The parameter range is 0–1,073,741,824,000,000, using a base of 1,024 for conversion.
    ...
    def speed_limit_rate(self) -> Optional[_builtins.int]:
        """
    ...
    def speed_limit_rate_after(self) -> Optional[_builtins.int]:
        """
...
class DomainDownloadSpeedLimitDownloadSpeedLimitRuleDownloadSpeedLimitActionSpeedLimitTime(dict):
    ...
    def __init__(__self__, *,
                 ...
                 day_week: Optional[_builtins.str] = None,
                 end_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str begin_time: Indicates the start time for rate limiting. The time format is mm:ss. If the DayWeek parameter value is unlimited, the default values for BeginTime and EndTime will be set to 00:00 and 23:59, respectively.
        :param _builtins.str day_week: Specifies the date when rate limiting occurs. This parameter has the following values: monday, tuesday, wednesday, thursday, friday, saturday, sunday, unlimited. unlimited means every day. You can specify one or more values. Separate multiple values with a semicolon (;).
        :param _builtins.str end_time: Indicates the end time for rate limiting. The time format is mm:ss. If the DayWeek parameter is set to unlimited, the default values for BeginTime and EndTime are 00:00 and 23:59, respectively.
        """
    ...
    def day_week(self) -> Optional[_builtins.str]:
        """
...
class DomainHttpForcedRedirect(dict):
    ...
    def __init__(__self__, *,
                 enable_forced_redirect: Optional[_builtins.bool] = None,
                 status_code: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enable_forced_redirect: Indicates whether this feature is enabled. The parameter values are: true: enables the feature. When enabled, the content delivery network redirects incoming HTTPS requests to HTTP requests. false: disables the feature. The content delivery network does not redirect HTTPS requests to HTTP requests. To enable this feature, your acceleration domain must have HTTPS enabled.
        :param _builtins.str status_code: Indicates the redirect status code returned by the content delivery network when it receives an HTTPS request. This parameter has the following values: 301: indicates the 301 response status code. 302: indicates the 302 response status code. The default value for this parameter is 301.
        """
    ...
    def enable_forced_redirect(self) -> Optional[_builtins.bool]:
        """
...
class DomainHttps(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_http: Optional[_builtins.bool] = None,
                 ...
                 ocsp: Optional[_builtins.bool] = None,
                 switch: Optional[_builtins.bool] = None,
        ...
        :param Sequence['DomainHttpsCertInfoListArgs'] cert_info_lists: Indicates the dual certificate to be associated with the acceleration domain name.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool disable_http: Indicates whether to allow requests where the URL scheme is HTTP. The parameter values are: true: allows requests with HTTP scheme. false: does not allow requests with HTTP scheme. The default value is false.
    ...
    def disable_http(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def ocsp(self) -> Optional[_builtins.bool]:
        """
...
class DomainHttpsCertInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source: Optional[_builtins.str] = None):
        """
        :param _builtins.str cert_id: Represents the ID of a CA certificate hosted on the content delivery network. The ID starts with cert_hosting-.
        :param _builtins.str cert_name: Indicates the content of the Common Name (CN) field in the CA certificate.
        ...
        :param _builtins.int effective_time: Indicates the issuance time of the certificate, in Unix timestamp.
        :param _builtins.str encry_type: Indicates the encryption algorithm used by the certificate. The parameter has the following values: inter*cert: RSA or ECC encryption algorithm. sm*cert: SM2 encryption algorithm.
        :param _builtins.int expire_time: Indicates the expiration time of the certificate, in Unix timestamp.
        :param _builtins.str source: Indicates the location where the certificate is hosted. This parameter has the following values: volc*cert*center: Certificate Center. cdn*cert*hosting: Content Delivery Network.
        """
        if cert_id is not None:
            pulumi.set(__self__, "cert_id", cert_id)
        if cert_name is not None:
...
class DomainHttpsForcedRedirect(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status_code: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enable_forced_redirect: Indicates whether to enable this feature. This parameter has the following values: true: enables the feature. When enabled, the content delivery network redirects HTTP requests to HTTPS requests. false: disables the feature. When disabled, the content delivery network does not redirect HTTP requests to HTTPS requests. To enable this feature, your acceleration domain must have HTTPS enabled.
        :param _builtins.str status_code: Indicates the redirect response status code for the CDN when receiving HTTPS requests. The parameter values are: 301: returns status code 301. 302: returns status code 302. The default value is 301.
        """
        if enable_forced_redirect is not None:
            pulumi.set(__self__, "enable_forced_redirect", enable_forced_redirect)
        if status_code is not None:
...
class DomainIPv6(dict):
    def __init__(__self__, *,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool switch: Specifies whether to enable IPv6 configuration. This parameter has the following values: true: Enables IPv6. false: Disables IPv6.
        """
        if switch is not None:
            pulumi.set(__self__, "switch", switch)
...
class DomainIpAccessRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] ips: Specifies IP addresses in the denylist or allowlist. This parameter is required when Switch is true. You can specify one or more IP addresses and IP address ranges. IP addresses and ranges can be in IPv4 or IPv6 format. You can enter up to 1,000 addresses. If you specify SharedConfig, you cannot specify this parameter.
        :param _builtins.str rule_type: Indicates the type of IP list. This parameter is required when Switch is true. Valid values are: allow: indicates Allowlist. deny: indicates Denylist. If you specify SharedConfig, you cannot specify this parameter.
        ...
        :param _builtins.bool switch: Indicates whether this feature is enabled. This parameter has the following values: true: enables the feature. false: disables the feature.
        """
        if ips is not None:
...
class DomainIpAccessRuleSharedConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str config_name: Indicates the name of a global configuration.
        """
...
class DomainMethodDeniedRule(dict):
    def __init__(__self__, *,
                 methods: Optional[_builtins.str] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.str methods: Indicates one or more HTTP request methods that are disabled. When Switch is true, this parameter is required. Use commas (,) to separate multiple methods. The parameter values are: get: disables the GET request method. post: disables the POST request method. delete: disables the DELETE request method. put: disables the PUT request method. head: disables the HEAD request method. patch: disables the PATCH request method. connect: disables the CONNECT request method. options: disables the OPTIONS request method.
        :param _builtins.bool switch: Configuration switch for disabling methods. Use commas to separate multiple methods. Required when enabled. choices: [get, post, head, delete, put]
        """
    ...
    @_builtins.property
    @pulumi.getter
    def methods(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class DomainNegativeCache(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainNegativeCache. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainNegativeCache.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 condition: Optional['outputs.DomainNegativeCacheCondition'] = None,
                 negative_cache_rule: Optional['outputs.DomainNegativeCacheNegativeCacheRule'] = None):
        """
        :param 'DomainNegativeCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        :param 'DomainNegativeCacheNegativeCacheRuleArgs' negative_cache_rule: Represents a list. Each element in the list is a status code cache rule.
        """
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> Optional['outputs.DomainNegativeCacheCondition']:
        """
        Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        return pulumi.get(self, "condition")
    ...
    def negative_cache_rule(self) -> Optional['outputs.DomainNegativeCacheNegativeCacheRule']:
        """
...
@pulumi.output_type
class DomainNegativeCacheCondition(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "conditionRules":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainNegativeCacheCondition. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainNegativeCacheCondition.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 condition_rules: Optional[Sequence['outputs.DomainNegativeCacheConditionConditionRule']] = None,
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainNegativeCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="conditionRules")
    def condition_rules(self) -> Optional[Sequence['outputs.DomainNegativeCacheConditionConditionRule']]:
        """
        Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
@pulumi.output_type
class DomainNegativeCacheConditionConditionRule(dict):
    def __init__(__self__, *,
                 name: Optional[_builtins.str] = None,
                 object: Optional[_builtins.str] = None,
                 operator: Optional[_builtins.str] = None,
...
@pulumi.output_type
class DomainNegativeCacheNegativeCacheRule(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "ignoreCase":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainNegativeCacheNegativeCacheRule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DomainNegativeCacheNegativeCacheRule.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 ttl: Optional[_builtins.int] = None):
        """
        :param _builtins.str action: Represents the cache behavior. Currently, you can only specify cache. cache means the behavior is caching.
        :param _builtins.bool ignore_case: Indicates whether the CDN ignores case when matching files in a request with ConditionRule. The parameter has the following options: true: ignore case. false: do not ignore case. The default value is false.
        :param _builtins.str status_code: Specify a status code to cache. The status code range is 400–599. You can also specify 4xx or 5xx. 4xx refers to all status codes from 400 to 499. 5xx refers to all status codes from 500 to 599.
        :param _builtins.int ttl: Indicates the cache duration for status codes, in seconds. The range is 1–315,360,000. 315,360,000 means 10 years.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if ignore_case is not None:
...
class DomainOriginAccessRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_empty: Specifies whether requests are allowed when the Origin header in the user request is empty (""). The parameter values are: true: allow; false: do not allow. The default value is false.
        :param _builtins.bool ignore_case: Indicates whether Origin is case sensitive. This parameter has the following values: true: Origin is case insensitive; false: Origin is case sensitive. The default value is true.
        :param Sequence[_builtins.str] origins: The address list corresponding to RuleType. When Switch is true, this parameter is required. You can specify one or more IP addresses, CIDR blocks, domain names, and wildcard domain names. Domain names can be second-level domains. IP addresses can be in IPv4 or IPv6 format. You can enter up to 100 addresses. When entering domain names, you do not need to include http:// or https://. The value length cannot exceed 3,000 characters.
        :param _builtins.str rule_type: Origin list configuration type. When Switch is true, this parameter is required. The parameter has the following values: allow: indicates allowlist. deny: indicates denylist.
        :param _builtins.bool switch: Indicates whether this feature is enabled. This parameter has the following values: true: enables the feature. false: disables the feature.
        """
        if allow_empty is not None:
            pulumi.set(__self__, "allow_empty", allow_empty)
...
class DomainOriginArgCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainOriginArgConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainOriginArgOriginArgAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainOriginArgOriginArgActionOriginArgComponentArgs'] origin_arg_components: Indicates a list of operations. These operations define how the CDN sets query parameters in origin requests. Currently, only one operation can be included in the list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainOriginCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainOriginConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainOriginOriginAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainOriginOriginActionOriginLineArgs'] origin_lines: Indicates a list of origin configurations. Each configuration can include one or more origins.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        pulumi.set(__self__, "origin_lines", origin_lines)
...
class DomainOriginOriginActionOriginLine(dict):
    ...
    def __init__(__self__, *,
                 ...
                 https_port: Optional[_builtins.str] = None,
                 origin_host: Optional[_builtins.str] = None,
                 private_bucket_access: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.str address: Indicates the origin address. The parameter has the following instructions: If InstanceType is ip, you can set an IP address. The IP address can be either IPv4 or IPv6. If InstanceType is domain, you can set a domain name. The domain name cannot be a wildcard domain. If InstanceType is tos, you can set the domain name of an object storage bucket. The bucket can be from Alibaba Cloud, Tencent Cloud, or AWS. If you specify multiple origin configurations in this API request: All primary origin configurations must have the same InstanceType. All backup origin configurations must also have the same InstanceType. If the InstanceType in the primary origin configuration is ip or domain, the InstanceType in the backup origin configuration must also be ip or domain. The total number of primary and backup origin addresses cannot exceed 50.
        :param _builtins.str instance_type: Indicates the type of origin server. This parameter has the following values: ip: The origin server is accessed via IP address. domain: The origin server is accessed via domain name. tos: The origin server is an object storage bucket.
        :param _builtins.str origin_type: Indicates the type of origin server. This parameter has the following values:   - primary: Primary origin server.   - backup: Backup origin server. At least one primary origin server configuration must be included in this API request. Backup origin server configuration is optional.
        :param _builtins.str http_port: Indicates the port used by the content delivery network to access the origin server via the HTTP protocol. The value range is 1–65535, and the default value is 80. If the origin server does not support access on this port, you can specify the default value. This parameter is only valid when InstanceType is ip or domain.
        :param _builtins.str https_port: Indicates the port used by the content delivery network to access the origin server via HTTPS. The value range is 1-65535, and the default value is 443. If the origin server does not support access on this port, you can specify the default value. This parameter is only valid when InstanceType is ip or domain.
        :param _builtins.str origin_host: If there are multiple sites on the origin server, this parameter specifies the domain name accessed by the origin request. This parameter applies to all origin configurations, but has lower priority than the OriginHost parameter in the origin configuration. The default value of this parameter is the same as Domain. If the origin is an object storage bucket, you do not need to specify this parameter. Its default value is the same as the Address in the origin configuration.
        :param _builtins.bool private_bucket_access: Indicates whether private read permissions are enabled for the object storage bucket. This parameter is only valid when InstanceType is tos. The parameter values are: true: Enabled. false: Not enabled. The default value is false.
        ...
        :param _builtins.str region: This parameter is not currently available externally. Do not use this parameter.
        :param _builtins.str weight: Specifies the weight of the origin. Value range is 1–100, default is 1. The higher the weight, the more likely this origin is selected when the content delivery network sends a request to the origin. This parameter is only valid when InstanceType is ip or domain.
        """
        pulumi.set(__self__, "address", address)
        pulumi.set(__self__, "instance_type", instance_type)
    ...
    def private_bucket_access(self) -> Optional[_builtins.bool]:
        """
...
class DomainOriginOriginActionOriginLinePrivateBucketAuth(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str auth_type: Indicates the third-party cloud provider where the object storage bucket is located. The parameter values are: cos: Tencent Cloud. oss: Alibaba Cloud. aws: Amazon AWS.
        :param _builtins.bool switch: Indicates whether the object storage bucket is from a third-party cloud provider. This parameter has the following values: true: the object storage bucket is from a third-party cloud provider. The default value is false
...
class DomainOriginOriginActionOriginLinePrivateBucketAuthTosAuthInformation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str access_key_id: Specifies the AccessKey ID for your Alibaba Cloud account, SecretId for your Tencent Cloud account, or access key ID for your AWS account.
        :param _builtins.str access_key_secret: Indicates the AccessKey Secret for your Alibaba Cloud account, the SecretKey for your Tencent Cloud account, or the secret access key for your AWS account.
        """
...
class DomainOriginRetry(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.str status_code: Indicates one or more status codes in the range 400–599. Separate multiple status codes with a semicolon (;). You can enter 4xx or 5xx to represent all status codes starting with the digit 4 or 5.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter values are: true: Enabled. false: Disabled. The default value is false.
        """
        if status_code is not None:
            pulumi.set(__self__, "status_code", status_code)
...
class DomainOriginRewriteOriginRewriteRuleOriginRewriteAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str rewrite_type: Indicates the rewrite type. This parameter supports the following values: rewrite*path: rewrites the path in the request URL. rewrite*url: rewrites both the path and query string in the request URL. The default value is rewrite_path.
        :param _builtins.str source_path: Indicates a regular expression, with a maximum length of 1,024 characters, used to match objects in the user's request URL. For a user request, if the regular expression matches any part of the object, this rule applies to the request. When RewriteType is rewrite*path, the object refers to the path in the request URL. When RewriteType is rewrite*url, the object refers to both the path and query string in the request URL.
        :param _builtins.str target_path: Indicates the object in the origin request URL after rewriting. When RewriteType is rewrite*path, this object is the path in the origin request URL. When RewriteType is rewrite*url, this object is the path and query string in the origin request URL. You can use $1, $2, $3, etc. in TargetPath to represent groups defined in the regular expression of SourcePath.
        """
...
class DomainOriginSni(dict):
    ...
    def __init__(__self__, *,
                 sni_domain: Optional[_builtins.str] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.str sni_domain: Specifies the domain name for origin SNI. When Switch is true, this parameter is required. The value cannot exceed 1,024 characters.
        :param _builtins.bool switch: Indicates whether this feature is enabled. This parameter has the following options: true: Enable this feature. false: Disable this feature. The default value for this parameter is false.
        """
    ...
    def sni_domain(self) -> Optional[_builtins.str]:
        """
...
class DomainPageOptimization(dict):
    ...
    def __init__(__self__, *,
                 optimization_types: Optional[Sequence[_builtins.str]] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] optimization_types: Specifies the optimization target. This parameter has the following values: html: HTML page. js: JavaScript code. css: CSS code. The default value is html. If you specify js or css, html must also be specified.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter values are: true: The feature is enabled. false: The feature is disabled.
        """
    ...
    def optimization_types(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DomainQuic(dict):
    def __init__(__self__, *,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool switch: QUIC configuration switch. The parameter values are as follows: true: enables QUIC. false: disables QUIC. To enable QUIC, you must first enable HTTPS.
        """
        if switch is not None:
            pulumi.set(__self__, "switch", switch)
...
class DomainRedirectionRewrite(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainRedirectionRewriteRedirectionRuleArgs'] redirection_rules: Indicates a list of URL redirect rewrite rules. When Switch is true, this parameter is required. The list can contain up to 50 rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether this configuration is enabled. This parameter has the following values: true: enables URL redirect rewrite. false: disables URL redirect rewrite.
        """
...
class DomainRedirectionRewriteRedirectionRuleRedirectionAction(dict):
    ...
    def __init__(__self__, *,
                 redirect_code: Optional[_builtins.str] = None,
                 source_path: Optional[_builtins.str] = None,
                 target_host: Optional[_builtins.str] = None,
                 target_path: Optional[_builtins.str] = None,
                 target_protocol: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str redirect_code: Indicates the response status code for URL redirection. Valid values are 301, 302, 303, 307, and 308. Note: For 301 and 302, if the original request method is not GET, the client may use GET when sending the new request to the new URL. For 303, the new request method is GET. For 307 and 308, the new request method remains the same as the original and is not changed.
        :param _builtins.str source_path: Specifies the original file path, which is the path included in the request. The path must start with a slash (/) and cannot contain consecutive slashes (//), percent signs (%), or spaces. The value of this parameter cannot exceed 1,024 characters.
        :param _builtins.str target_host: Indicates the domain name or IP address of the site to which the target path belongs. The IP address must be IPv4. The parameter value cannot exceed 1,024 characters. The default value is your acceleration domain name.
        :param _builtins.str target_path: Indicates the target path after redirection. The path must start with a slash (/) and cannot contain consecutive slashes (//), percent signs (%), or spaces. The value cannot exceed 1,024 characters.
        :param _builtins.str target_protocol: Specifies the protocol used for the new request after URL redirection. The parameter values are: followclient: use the protocol of the original request; http: force the new request to use HTTP; https: force the new request to use HTTPS.
    ...
    def target_host(self) -> Optional[_builtins.str]:
        """
    ...
    def target_protocol(self) -> Optional[_builtins.str]:
        """
...
class DomainRedirectionRewriteRedirectionRuleRedirectionActionTargetQueryComponents(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str action: Indicates how to handle query parameters in the original request URL. This parameter has the following values: include: includes all query parameters from the original request URL in the redirected URL. exclude: excludes all query parameters from the original request URL in the redirected URL. includePart: includes specific query parameters from the original request URL in the redirected URL. excludePart: excludes specific query parameters from the original request URL in the redirected URL.
        :param _builtins.str value: Indicates the query parameters to retain or remove. Multiple query parameters are separated by a semicolon (;). The specified query parameters cannot contain consecutive slashes (//), percent signs ("), or spaces. The default value of Value is *, which means all query parameters. If Action is include or exclude, Value must be *. If Action is includePart or excludePart, you can specify one or more query parameters. In this case, the specified query parameters cannot be *.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if value is not None:
...
class DomainRefererAccessRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_empty: Specifies whether the content delivery network accepts a request when the Referer header in the user's request is empty (""). This parameter has the following values: true: accepts the request; false: rejects the request. The default value is false.
        :param Sequence[_builtins.str] referers: Indicates a list of Referers. The input requirements for this parameter are consistent with those for Referers under the CommonType of ReferersType. We recommend using ReferersType to specify the Referer list. If you specify SharedConfig, you cannot specify this parameter.
        ...
        :param _builtins.str rule_type: Indicates the type of Referer list. This parameter is required when Switch is true. This parameter has the following values: allow: indicates Allowlist. deny: indicates Denylist.
...
class DomainRefererAccessRuleReferersTypeCommonType(dict):
    ...
    def ignore_scheme(self) -> Optional[_builtins.bool]:
        """
...
class DomainRefererAccessRuleReferersTypeRegularType(dict):
    def __init__(__self__, *,
                 referers: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] referers: Indicates a list of Referer regular expressions. The value of this parameter cannot exceed 30,000 characters.
        """
        if referers is not None:
            pulumi.set(__self__, "referers", referers)
...
class DomainRemoteAuth(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainRemoteAuthRemoteAuthRuleArgs'] remote_auth_rules: Specifies the list of remote authentication configuration rules. When Switch is true, this parameter is required. You can add only one configuration rule.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter values are as follows: true: enables the feature. false: disables the feature.
        """
...
class DomainRemoteAuthRemoteAuthRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainRemoteAuthRemoteAuthRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 request_body_rules: Optional[_builtins.str] = None,
        ...
        :param _builtins.str request_body_rules: Indicates the rule for the authentication request body. You can leave this parameter unspecified or set its value to default. default means the request body is empty ("").
    ...
    def request_body_rules(self) -> Optional[_builtins.str]:
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthModeConfig(dict):
    ...
    def __init__(__self__, *,
                 backup_remote_addr: Optional[_builtins.str] = None,
                 master_remote_addr: Optional[_builtins.str] = None,
                 path_type: Optional[_builtins.str] = None,
                 path_value: Optional[_builtins.str] = None,
                 request_method: Optional[_builtins.str] = None):
        """
        :param _builtins.str backup_remote_addr: Indicates the backup address of the authentication server. The address format and requirements are the same as the primary address.
        :param _builtins.str master_remote_addr: Indicates the primary address of the authentication server. The length must not exceed 100 characters. The primary address format is \\n\\n://\\n\\n:\\n\\n or \\n\\n://\\n\\n:\\n\\n, where: \\n\\n is http or https. \\n\\n cannot be localhost. \\n\\n cannot be 127.0.0.1. \\n\\n is optional.
        :param _builtins.str path_type: Indicates the path for the authentication request. The authentication address and request path together form the complete authentication URL. The content delivery network forwards the user's request to this authentication URL. The parameter accepts the following values: constant: The path in the authentication request is the same as the path in the user's request. variable: You need to specify a path for the authentication request in the pathValue parameter.
        :param _builtins.str path_value: Represents the path for an authentication request. The path cannot exceed 100 characters. It must start with a slash (/), and can include any printable ASCII characters except the following: consecutive slashes (//), percent sign (%), dollar sign ($), space, question mark (?), and Delete (ASCII code 127).
        :param _builtins.str request_method: Indicates the request method used by the content delivery network when sending authentication requests. The parameter has the following values: default: uses the same method as the user's request. get: uses the GET method. post: uses the POST method. head: uses the HEAD method.
        """
    ...
    def backup_remote_addr(self) -> Optional[_builtins.str]:
        """
    ...
    def master_remote_addr(self) -> Optional[_builtins.str]:
        """
    ...
    def path_value(self) -> Optional[_builtins.str]:
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigCacheAction(dict):
    ...
    def __init__(__self__, *,
                 action: Optional[_builtins.str] = None,
                 cache_keys: Optional[Sequence[_builtins.str]] = None,
                 ttl: Optional[_builtins.int] = None):
        """
        :param _builtins.str action: Indicates whether the CDN caches authentication status codes. The parameter values are: nocache: CDN does not cache authentication status codes. cache: CDN caches authentication status codes.
        :param Sequence[_builtins.str] cache_keys: The cache key specifies the query parameters used to distinguish different request URIs. Each parameter must start with $.
        :param _builtins.int ttl: Indicates the cache duration for authentication status codes, measured in seconds. The range is 1–86400. 86400 seconds equals 24 hours.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    def cache_keys(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigResponseAction(dict):
    ...
    def __init__(__self__, *,
                 status_code: Optional[_builtins.str] = None):
        """
        :param _builtins.str status_code: Indicates the status code returned by the content delivery network to the user when authentication fails. You can specify any status code in the range 400–499. The default value is 403.
        """
        if status_code is not None:
            pulumi.set(__self__, "status_code", status_code)
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigStatusCodeAction(dict):
    ...
    def fail_code(self) -> Optional[_builtins.str]:
        """
    ...
    def success_code(self) -> Optional[_builtins.str]:
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigTimeOutAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Indicates the strategy for handling authentication requests after a timeout in the content delivery network. This parameter supports the following values: reject: The content delivery network considers authentication failed. pass: The content delivery network considers authentication successful.
        :param _builtins.int time: Specifies the authentication timeout in milliseconds. The default value is 200. The valid range is 200–3600.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
        if time is not None:
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionQueryStringRules(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionQueryStringRulesQueryStringInstanceArgs'] query_string_instances: Indicates additional parameter settings in the authentication request. You can set up to 50 parameters.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionRequestHeaderRules(dict):
    ...
    def __init__(__self__, *,
                 ...
                 request_host: Optional[_builtins.str] = None):
        """
    ...
    def request_host(self) -> Optional[_builtins.str]:
        """
...
class DomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionRequestHeaderRulesRequestHeaderComponents(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str action: Indicates whether the authentication request header includes user request headers. The parameter values are: exclude: the authentication request header does not include any user request headers. include: the authentication request header includes all user request headers. includePart: the authentication request header includes specified user request headers.
...
class DomainRequestBlockRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainRequestBlockRuleBlockRuleArgs'] block_rules: Represents a list of interception rules. The list can contain up to 10 rules. When Switch is true, this parameter is required.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates the configuration switch for this module. This parameter has the following values: true: enables the module. false: disables the module. The default value is false.
        """
...
class DomainRequestBlockRuleBlockRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str rule_name: Indicates the name of the rule, which must not exceed 20 characters and can include letters, numbers, underscores (_), hyphens (-), and Chinese characters. One Chinese character counts as 3 characters.
        """
...
class DomainRequestBlockRuleBlockRuleBlockAction(dict):
    ...
    def error_page(self) -> Optional[_builtins.str]:
        """
...
class DomainRequestBlockRuleBlockRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainRequestBlockRuleBlockRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainRequestHeaderCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainRequestHeaderConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainRequestHeaderRequestHeaderAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainRequestHeaderRequestHeaderActionRequestHeaderInstanceArgs'] request_header_instances: Indicates a list of configuration rules for request headers. Each rule includes settings for header-related operations. You can add up to 50 rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        if request_header_instances is not None:
            pulumi.set(__self__, "request_header_instances", request_header_instances)
...
class DomainResponseHeaderCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainResponseHeaderConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainResponseHeaderResponseHeaderAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainResponseHeaderResponseHeaderActionResponseHeaderInstanceArgs'] response_header_instances: Specifies a list of configuration rules for response headers Each rule includes settings for header-related operations You can add up to 50 rules
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainResponseHeaderResponseHeaderActionResponseHeaderInstance(dict):
    ...
    def access_origin_control(self) -> Optional[_builtins.bool]:
        """
...
class DomainRewriteHls(dict):
    ...
    def __init__(__self__, *,
                 sign_name: Optional[_builtins.str] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.str sign_name: Indicates the name of the signature parameter, which cannot exceed 100 characters. Parameter names are case-sensitive and can include letters, numbers, underscores (_), hyphens (-), commas (,), periods (.), and exclamation marks (!). The default value is DrmAuthToken.
        :param _builtins.bool switch: Indicates whether this feature is enabled. This parameter has the following options: true: Enable this feature. false: Disable this feature. The default value for this parameter is false.
        """
    ...
    def sign_name(self) -> Optional[_builtins.str]:
        """
...
class DomainSignedUrlAuth(dict):
    ...
    def __init__(__self__, *,
                 ...
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence['DomainSignedUrlAuthSignedUrlAuthRuleArgs'] signed_url_auth_rules: Represents the configuration module for the 'URL authentication' feature. This feature is disabled by default.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.bool switch: Indicates whether to enable this feature. This parameter has the following values: true: Enables this feature. false: Disables this feature.
        """
...
class DomainSignedUrlAuthSignedUrlAuthRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainSignedUrlAuthSignedUrlAuthRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthAction(dict):
    ...
    def __init__(__self__, *,
                 auth_algorithm: Optional[_builtins.str] = None,
                 ...
                 keep_origin_arg: Optional[_builtins.bool] = None,
                 master_secret_key: Optional[_builtins.str] = None,
                 rewrite_m3_u8: Optional[_builtins.bool] = None,
                 rewrite_m3_u8_rule: Optional['outputs.DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionRewriteM3U8Rule'] = None,
                 sign_name: Optional[_builtins.str] = None,
                 signature_rules: Optional[Sequence[_builtins.str]] = None,
                 time_format: Optional[_builtins.str] = None,
                 time_name: Optional[_builtins.str] = None,
                 url_auth_type: Optional[_builtins.str] = None):
        """
        :param _builtins.str auth_algorithm: Indicates the algorithm used for signature calculation. This configuration has the following values: md5: MD5 algorithm. sha256: SHA-256 algorithm. The default value for this parameter is md5.
        :param _builtins.str backup_secret_key: Indicates the backup secret key. The backup secret key must be 6–40 characters long and can contain any printable ASCII character except Delete (ASCII code 127).
        ...
        :param _builtins.int duration: The validity period of the signature, in seconds. This parameter is used with the timestamp included in the request to calculate the expiration time of the signature. The value range for this parameter is 0–315,360,000. Signature expiration time = timestamp + Duration. When the content delivery network receives a request, if the signature expiration time is less than the current time, the content delivery network determines that the signature has expired.
        :param _builtins.bool keep_origin_arg: This parameter is not currently available to external users. Do not use this parameter.
        :param _builtins.str master_secret_key: Indicates the primary key, with a length of 6–40 characters. It can include printable ASCII characters except Delete (ASCII code 127)
        :param _builtins.bool rewrite_m3_u8: Indicates whether the content delivery network adds signature parameters to the URL of each segment file in a .m3u8 file when responding to a .m3u8 file request. The signature for each segment URL is calculated based on the rewritten segment URL using the signature rules. The parameter values are as follows: true: enabled. false: disabled.
    ...
    def auth_algorithm(self) -> Optional[_builtins.str]:
        """
    ...
    def keep_origin_arg(self) -> Optional[_builtins.bool]:
        """
    ...
    def master_secret_key(self) -> Optional[_builtins.str]:
        """
    ...
    def rewrite_m3_u8(self) -> Optional[_builtins.bool]:
        """
    ...
    def signature_rules(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def time_name(self) -> Optional[_builtins.str]:
        """
    ...
    def url_auth_type(self) -> Optional[_builtins.str]:
        """
        Signature type
        """
...
class DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionCustomVariableRules(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionCustomVariableRulesCustomVariableInstanceArgs'] custom_variable_instances: Indicates a variable list
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionCustomVariableRulesCustomVariableInstance(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str operator: Indicates the matching method for the variable. The value of this parameter can only be match.
        :param _builtins.str type: Indicates the variable type. This parameter has the following values: queryString: indicates the variable is a query parameter in the request. requestHeader: indicates the variable is a header field in the request.
        :param _builtins.str value: Specifies the variable name, with a maximum length of 100 characters. Variable name requirements are as follows: If Type is queryString, the variable name can include letters, numbers, hyphens (-), commas (,), periods (.), and exclamation marks (!). If Type is requestHeader, the variable name can include any printable ASCII character except: underscore (_), space, double quotes ("), colon (:), and Delete (ASCII code 127).
        """
        if operator is not None:
            pulumi.set(__self__, "operator", operator)
        if type is not None:
...
class DomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionRewriteM3U8Rule(dict):
    ...
    def __init__(__self__, *,
                 delete_param: Optional[_builtins.bool] = None,
                 keep_m3_u8_param: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool delete_param: Indicates whether to retain the original parameters in the URL when rewriting the shard URL. This parameter has the following values: true: removes the original parameters. false: retains the original parameters.
        :param _builtins.bool keep_m3_u8_param: Indicates whether to add unsigned query parameters from the M3U8 file request to the segment URL. The parameter has the following options: true: add query parameters to the segment URL. false: do not add query parameters.
        """
    ...
    def delete_param(self) -> Optional[_builtins.bool]:
        """
    ...
    def keep_m3_u8_param(self) -> Optional[_builtins.bool]:
        """
...
class DomainTimeout(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool switch: Specify whether to enable origin timeout configuration. This parameter has the following values: true: enables origin timeout configuration. false: disables origin timeout configuration. In this case, the system default timeout values are used for TCP and HTTP requests, which are 2 seconds and 60 seconds respectively.
        :param Sequence['DomainTimeoutTimeoutRuleArgs'] timeout_rules: Represents a set of timeout configurations. Currently, you can specify only one configuration. This parameter is required when Switch is true.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        if switch is not None:
            pulumi.set(__self__, "switch", switch)
...
class DomainTimeoutTimeoutRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connective: Optional[_builtins.str] = None):
        """
        :param Sequence['DomainTimeoutTimeoutRuleConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        if condition_rules is not None:
...
class DomainTimeoutTimeoutRuleTimeoutAction(dict):
    ...
    def __init__(__self__, *,
                 http_timeout: Optional[_builtins.int] = None,
                 tcp_timeout: Optional[_builtins.int] = None):
        """
        :param _builtins.int http_timeout: Indicates the timeout period for HTTP requests. The value range for this parameter is 5–60.
        :param _builtins.int tcp_timeout: Indicates the timeout for TCP requests. The valid range for this parameter is 2–60.
        """
    ...
    def http_timeout(self) -> Optional[_builtins.int]:
        """
...
class DomainUaAccessRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_empty: Indicates whether requests with an empty UA ("") or without a UA field are allowed to access the acceleration domain. The parameter has the following values: true: allowed. false: not allowed. The default value is false.
        :param _builtins.bool ignore_case: Indicates whether the UA string is case-sensitive. The parameter has the following options: true: The UA string is case-insensitive. false: The UA string is case-sensitive. The default value for this parameter is false.
        :param _builtins.str rule_type: Specifies whether a denylist or allowlist is used. When Switch is true, this parameter is required. The parameter values are as follows: deny: specifies a denylist. allow: specifies an allowlist.
        :param _builtins.bool switch: Indicates whether the UA allowlist and blocklist feature is enabled. This parameter has the following values: true: enabled. false: disabled.
        :param Sequence[_builtins.str] user_agents: Represents a list of UAs. When Switch is true, this parameter is required. The list can contain up to 1,000 UAs. The parameter details are as follows: The value length cannot exceed 30,000 characters. If RuleType is allow, only requests containing UAs in the list are permitted to access the acceleration domain. If RuleType is deny, requests containing UAs in the list are not permitted to access the acceleration domain. UA character restrictions are as follows: You can use * in a UA to represent one or more characters. * can only appear at the beginning or end of the UA. A UA cannot consist only of * or spaces. A UA can contain printable ASCII characters except Delete (ASCII code 127). If a UA contains symbols, the symbols must be HTML encoded.
        """
        if allow_empty is not None:
            pulumi.set(__self__, "allow_empty", allow_empty)
        if ignore_case is not None:
...
class DomainUrlNormalize(dict):
    ...
    def __init__(__self__, *,
                 normalize_objects: Optional[Sequence[_builtins.str]] = None,
                 switch: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] normalize_objects: This specifies the list of URL normalization options you need to enable. When Switch is true, this parameter is required. The list can include the following options: dot*segments: replaces the following in the request URL: /./: replaced with a single slash (/). /../: if there is a directory level before /../, removes /../ and that directory. If there is no directory before /../, the original URL is retained. back*slashes: replaces backslashes () in the request URL with a single slash (/). successive_slashes: replaces consecutive slashes (//) in the request URL with a single slash (/).
        :param _builtins.bool switch: This specifies the list of URL normalization options you need to enable. When Switch is true, this parameter is required. The list can include the following options: dot*segments: replaces the following in the request URL: /./: replaced with a single slash (/). /../: if there is a directory level before /../, removes /../ and that directory. If there is no directory before /../, the original URL is retained. back*slashes: replaces backslashes () in the request URL with a single slash (/). successive_slashes: replaces consecutive slashes (//) in the request URL with a single slash (/).
        """
    ...
    def normalize_objects(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class DomainVideoDrag(dict):
    def __init__(__self__, *,
                 switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool switch: Smart compression configuration switch. The parameter has the following options: true: enable video seeking. false: disable video seeking.
        """
        if switch is not None:
            pulumi.set(__self__, "switch", switch)
...
class ShareConfigAllowIpAccessRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] rules: Specifies a list of entries. Each entry in the list is an IP address or CIDR block. IP addresses and blocks can be in IPv4 or IPv6 format. List limits: For AddSharedConfig, the number of entries in the list cannot exceed 30,000.
        """
...
class ShareConfigAllowRefererAccessRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_empty: Indicates whether requests with an empty Referer header or without a Referer header are not allowed. This parameter has the following values: true: Not allowed. If the Referer header is empty or missing, the content delivery network rejects the request. false: Allowed. The default value is false.
...
class ShareConfigAllowRefererAccessRuleCommonType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rules: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool ignore_case: Indicates whether entries in Rules are case-sensitive. This parameter has the following values: true: Not case-sensitive. false: Case-sensitive. The default value is true.
        :param Sequence[_builtins.str] rules: Indicates an entry list, where each entry is a string. List quotas are as follows: The list can contain up to 4,000 entries. The total length of all entries cannot exceed 200,000 characters. When the CDN creates this global configuration, duplicate entries in the list are removed. Duplicate entries do not count toward the quota.
        """
        if ignore_case is not None:
            pulumi.set(__self__, "ignore_case", ignore_case)
        if rules is not None:
...
class ShareConfigDenyIpAccessRule(dict):
    def __init__(__self__, *,
                 rules: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] rules: Specifies the configuration for an IP denylist, where ConfigType is deny*ip*access_rule.
        """
        if rules is not None:
            pulumi.set(__self__, "rules", rules)
...
class ShareConfigDenyRefererAccessRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_empty: Indicates whether requests with an empty Referer header or without a Referer header are allowed. This parameter has the following values: true: Allowed. false: Not allowed. If the Referer header is empty or missing, the content delivery network rejects the request. The default value is true.
...
class GetDomainAreaAccessRuleResult(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def areas(self) -> Sequence[_builtins.str]:
        """
        Indicates a list of countries to which an allowlist or denylist is applied. When Switch is true, this parameter is required. Country names are represented in abbreviated form. Multiple country names are separated by commas (,).
        """
        return pulumi.get(self, "areas")
...
@pulumi.output_type
class GetDomainBrowserCacheResult(dict):
    def __init__(__self__, *,
                 cache_action: 'outputs.GetDomainBrowserCacheCacheActionResult',
                 condition: 'outputs.GetDomainBrowserCacheConditionResult'):
        """
        :param 'GetDomainBrowserCacheCacheActionArgs' cache_action: Indicates the relevant configuration for cache behavior.
        :param 'GetDomainBrowserCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        pulumi.set(__self__, "cache_action", cache_action)
        pulumi.set(__self__, "condition", condition)
    ...
    @_builtins.property
    @pulumi.getter(name="cacheAction")
    def cache_action(self) -> 'outputs.GetDomainBrowserCacheCacheActionResult':
        """
        Indicates the relevant configuration for cache behavior.
        """
        return pulumi.get(self, "cache_action")
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> 'outputs.GetDomainBrowserCacheConditionResult':
        """
        Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        return pulumi.get(self, "condition")
...
@pulumi.output_type
class GetDomainBrowserCacheCacheActionResult(dict):
    def __init__(__self__, *,
                 action: _builtins.str,
                 default_policy: _builtins.str,
                 ignore_case: _builtins.bool,
                 ttl: _builtins.int):
        """
        :param _builtins.str action: Indicates caching behavior. Currently, you can only specify cache. cache means the behavior is caching.
        :param _builtins.str default_policy: This parameter is shared by multiple CDN features.
    ...
    @_builtins.property
    @pulumi.getter(name="ignoreCase")
    def ignore_case(self) -> _builtins.bool:
        """
        Indicates whether Value is case sensitive. The parameter has the following values: true: not case sensitive. false: case sensitive. The default value is false.
        """
        return pulumi.get(self, "ignore_case")
...
@pulumi.output_type
class GetDomainBrowserCacheConditionResult(dict):
    def __init__(__self__, *,
                 condition_rules: Sequence['outputs.GetDomainBrowserCacheConditionConditionRuleResult'],
                 connective: _builtins.str):
        """
        :param Sequence['GetDomainBrowserCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        pulumi.set(__self__, "condition_rules", condition_rules)
        pulumi.set(__self__, "connective", connective)
    ...
    @_builtins.property
    @pulumi.getter(name="conditionRules")
    def condition_rules(self) -> Sequence['outputs.GetDomainBrowserCacheConditionConditionRuleResult']:
        """
        Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        """
        return pulumi.get(self, "condition_rules")
    ...
    @_builtins.property
    @pulumi.getter
    def connective(self) -> _builtins.str:
        """
        Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        return pulumi.get(self, "connective")
...
@pulumi.output_type
class GetDomainBrowserCacheConditionConditionRuleResult(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
...
@pulumi.output_type
class GetDomainCacheResult(dict):
    def __init__(__self__, *,
                 cache_action: 'outputs.GetDomainCacheCacheActionResult',
                 condition: 'outputs.GetDomainCacheConditionResult'):
        """
        :param 'GetDomainCacheCacheActionArgs' cache_action: Indicates the relevant configuration for cache behavior.
        :param 'GetDomainCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        pulumi.set(__self__, "cache_action", cache_action)
        pulumi.set(__self__, "condition", condition)
    ...
    @_builtins.property
    @pulumi.getter(name="cacheAction")
    def cache_action(self) -> 'outputs.GetDomainCacheCacheActionResult':
        """
        Indicates the relevant configuration for cache behavior.
        """
        return pulumi.get(self, "cache_action")
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> 'outputs.GetDomainCacheConditionResult':
        """
        Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        return pulumi.get(self, "condition")
...
@pulumi.output_type
class GetDomainCacheCacheActionResult(dict):
    def __init__(__self__, *,
                 action: _builtins.str,
                 default_policy: _builtins.str,
                 ignore_case: _builtins.bool,
...
@pulumi.output_type
class GetDomainCacheConditionResult(dict):
    def __init__(__self__, *,
                 condition_rules: Sequence['outputs.GetDomainCacheConditionConditionRuleResult'],
                 connective: _builtins.str):
        """
        :param Sequence['GetDomainCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        pulumi.set(__self__, "condition_rules", condition_rules)
        pulumi.set(__self__, "connective", connective)
    ...
    @_builtins.property
    @pulumi.getter(name="conditionRules")
    def condition_rules(self) -> Sequence['outputs.GetDomainCacheConditionConditionRuleResult']:
        """
        Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        """
        return pulumi.get(self, "condition_rules")
...
@pulumi.output_type
class GetDomainCacheConditionConditionRuleResult(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 object: _builtins.str,
                 operator: _builtins.str,
...
class GetDomainCacheHostCacheHostRuleCacheHostActionResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="cacheHost")
    def cache_host(self) -> _builtins.str:
        """
        Specifies the target domain name. The target domain name must be an acceleration domain under your account. This parameter indicates that Domain shares the cache of CacheHost.
        """
        return pulumi.get(self, "cache_host")
...
class GetDomainCacheKeyCacheKeyActionCacheKeyComponentResult(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def subobject(self) -> _builtins.str:
        """
        Specify one or more objects of the Object type. Parameter details: If Action is include or exclude, Subobject must be *. * means all query parameters. If Action is includePart or excludePart, you can specify one or more query parameters. The query parameters you specify cannot be *, and cannot contain consecutive slashes (//), percent signs (%), or spaces. Use a semicolon (;) to separate multiple query parameter names. The default value for Subobject is *.
        """
        return pulumi.get(self, "subobject")
...
class GetDomainCompressionCompressionRuleCompressionActionResult(dict):
    def __init__(__self__, *,
                 compression_format: _builtins.str,
                 compression_target: _builtins.str,
                 compression_types: Sequence[_builtins.str],
                 max_file_size_kb: _builtins.int,
                 min_file_size_kb: _builtins.int):
        """
        :param _builtins.str compression_format: If the matching condition is based on the Content-Type header (when Condition is null or not specified), this parameter specifies the matching criteria for Content-Type. The values are as follows: default: matches file types included in the default Content-Type list. customize: matches custom file types in the Content-Type header. If Condition is not null, the matching criteria are defined in ConditionRule. In this case, this parameter must be set to all.
        :param _builtins.str compression_target: Specifies the file types to compress. The parameter is described as follows: If CompressionFormat is default, this parameter must be set to *, indicating the default Content-Type list. The list includes the following file types: text/html, text/xml, text/plain, text/css, application/javascript, application/x-javascript, application/rss+xml, text/javascript, image/tiff, image/svg+xml, application/json, application/xml, text/plain; charset=utf-8. If CompressionFormat is customize, you need to specify one or more file types. Multiple file types are separated by commas (,). If CompressionFormat is all, this parameter must be set to *.
        :param Sequence[_builtins.str] compression_types: Compression algorithm: gzip and br specify the compression type. default: compresses all files by default, with the target count as *. customize: compresses custom file types. Choices: [default, customize]
    ...
    @_builtins.property
    @pulumi.getter(name="compressionFormat")
    def compression_format(self) -> _builtins.str:
        """
        If the matching condition is based on the Content-Type header (when Condition is null or not specified), this parameter specifies the matching criteria for Content-Type. The values are as follows: default: matches file types included in the default Content-Type list. customize: matches custom file types in the Content-Type header. If Condition is not null, the matching criteria are defined in ConditionRule. In this case, this parameter must be set to all.
        """
        return pulumi.get(self, "compression_format")
    ...
    @_builtins.property
    @pulumi.getter(name="compressionTarget")
    def compression_target(self) -> _builtins.str:
        """
        Specifies the file types to compress. The parameter is described as follows: If CompressionFormat is default, this parameter must be set to *, indicating the default Content-Type list. The list includes the following file types: text/html, text/xml, text/plain, text/css, application/javascript, application/x-javascript, application/rss+xml, text/javascript, image/tiff, image/svg+xml, application/json, application/xml, text/plain; charset=utf-8. If CompressionFormat is customize, you need to specify one or more file types. Multiple file types are separated by commas (,). If CompressionFormat is all, this parameter must be set to *.
        """
        return pulumi.get(self, "compression_target")
    ...
    @_builtins.property
    @pulumi.getter(name="compressionTypes")
    def compression_types(self) -> Sequence[_builtins.str]:
        """
        Compression algorithm: gzip and br specify the compression type. default: compresses all files by default, with the target count as *. customize: compresses custom file types. Choices: [default, customize]
        """
        return pulumi.get(self, "compression_types")
    ...
    @_builtins.property
    @pulumi.getter(name="maxFileSizeKb")
    def max_file_size_kb(self) -> _builtins.int:
        """
        Indicates the minimum value for the file size range. CDN only compresses files within the range specified by MinFileSizeKB and MaxFileSizeKB. The parameter value range is 0   - 2,147,483,647, the unit is KB, and the base is 1,024. The default value is 0.
        """
        return pulumi.get(self, "max_file_size_kb")
    ...
    @_builtins.property
    @pulumi.getter(name="minFileSizeKb")
    def min_file_size_kb(self) -> _builtins.int:
        """
        Indicates the maximum value for the file size range. The value range is 0   - 2,147,483,647, in KB, using a base of 1,024. If this parameter is not specified, there is no upper limit for file size.
        """
        return pulumi.get(self, "min_file_size_kb")
...
class GetDomainCustomErrorPageErrorPageRuleErrorPageActionResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="redirectCode")
    def redirect_code(self) -> _builtins.str:
        """
        Indicates the response status code for redirection. You can select an appropriate status code as needed. The available values are 301, 302, 303, 307, and 308. Note: For 301 and 302, if the original request method is not GET, the client may use GET when sending the new request to the new URL. For 303, the new request method is GET. For 307 and 308, the new request method remains the same as the original request and will not be changed.
        """
        return pulumi.get(self, "redirect_code")
...
class GetDomainCustomizeAccessRuleCustomizeInstanceCustomizeRuleAccessActionResult(dict):
    def __init__(__self__, *,
                 ...
                 list_rules: Sequence[_builtins.str],
                 request_header: _builtins.str,
                 rule_type: _builtins.str):
        """
        :param _builtins.bool allow_empty: Indicates whether the CDN accepts user requests where the RequestHeader value is empty. An empty header value refers to either of the following situations: The user request does not include RequestHeader. The user request includes RequestHeader, but the header value is empty ("").
        :param Sequence[_builtins.str] list_rules: Indicates a list of regular expressions used to match the value of the request header. The list can contain up to 20 regular expressions, and the total length of all expressions cannot exceed 1,024 characters. The relationship between the regular expressions is OR. That is, if the value of RequestHeader in a user request matches any regular expression, the rule applies to the request.
    ...
    @_builtins.property
    @pulumi.getter(name="listRules")
    def list_rules(self) -> Sequence[_builtins.str]:
        """
        Indicates a list of regular expressions used to match the value of the request header. The list can contain up to 20 regular expressions, and the total length of all expressions cannot exceed 1,024 characters. The relationship between the regular expressions is OR. That is, if the value of RequestHeader in a user request matches any regular expression, the rule applies to the request.
        """
        return pulumi.get(self, "list_rules")
    ...
    @_builtins.property
    @pulumi.getter(name="requestHeader")
    def request_header(self) -> _builtins.str:
        """
        Indicates a specified request header. Header names are case-insensitive and must meet the following requirements: The name must not exceed 1,024 characters. The name cannot be Referer, User-Agent, or Origin. The name can contain letters, digits, underscores (_), and hyphens (-). The name cannot start with a digit.
        """
        return pulumi.get(self, "request_header")
...
class GetDomainDownloadSpeedLimitDownloadSpeedLimitRuleDownloadSpeedLimitActionResult(dict):
    def __init__(__self__, *,
                 speed_limit_rate: _builtins.int,
                 speed_limit_rate_after: _builtins.int,
    ...
    @_builtins.property
    @pulumi.getter(name="speedLimitRate")
    def speed_limit_rate(self) -> _builtins.int:
        """
        Indicates the maximum download speed for a single request, measured in B/S. The parameter range is 1–1,073,741,824,000,000, using a base conversion of 1,024.
        """
        return pulumi.get(self, "speed_limit_rate")
    ...
    @_builtins.property
    @pulumi.getter(name="speedLimitRateAfter")
    def speed_limit_rate_after(self) -> _builtins.int:
        """
        Represents a data volume. Download throttling is enabled for a request only when the amount of data downloaded in a single request reaches this value. Unit: Byte. The parameter range is 0–1,073,741,824,000,000, using a base of 1,024 for conversion.
        """
        return pulumi.get(self, "speed_limit_rate_after")
...
class GetDomainDownloadSpeedLimitDownloadSpeedLimitRuleDownloadSpeedLimitActionSpeedLimitTimeResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="dayWeek")
    def day_week(self) -> _builtins.str:
        """
        Specifies the date when rate limiting occurs. This parameter has the following values: monday, tuesday, wednesday, thursday, friday, saturday, sunday, unlimited. unlimited means every day. You can specify one or more values. Separate multiple values with a semicolon (;).
        """
        return pulumi.get(self, "day_week")
...
class GetDomainHttpForcedRedirectResult(dict):
    def __init__(__self__, *,
                 enable_forced_redirect: _builtins.bool,
                 status_code: _builtins.str):
        """
        :param _builtins.bool enable_forced_redirect: Indicates whether this feature is enabled. The parameter values are: true: enables the feature. When enabled, the content delivery network redirects incoming HTTPS requests to HTTP requests. false: disables the feature. The content delivery network does not redirect HTTPS requests to HTTP requests. To enable this feature, your acceleration domain must have HTTPS enabled.
        :param _builtins.str status_code: Indicates the redirect status code returned by the content delivery network when it receives an HTTPS request. This parameter has the following values: 301: indicates the 301 response status code. 302: indicates the 302 response status code. The default value for this parameter is 301.
    ...
    @_builtins.property
    @pulumi.getter(name="enableForcedRedirect")
    def enable_forced_redirect(self) -> _builtins.bool:
        """
        Indicates whether this feature is enabled. The parameter values are: true: enables the feature. When enabled, the content delivery network redirects incoming HTTPS requests to HTTP requests. false: disables the feature. The content delivery network does not redirect HTTPS requests to HTTP requests. To enable this feature, your acceleration domain must have HTTPS enabled.
        """
        return pulumi.get(self, "enable_forced_redirect")
...
class GetDomainHttpsResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="disableHttp")
    def disable_http(self) -> _builtins.bool:
        """
        Indicates whether to allow requests where the URL scheme is HTTP. The parameter values are: true: allows requests with HTTP scheme. false: does not allow requests with HTTP scheme. The default value is false.
        """
        return pulumi.get(self, "disable_http")
...
class GetDomainMethodDeniedRuleResult(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def methods(self) -> _builtins.str:
        """
        Indicates one or more HTTP request methods that are disabled. When Switch is true, this parameter is required. Use commas (,) to separate multiple methods. The parameter values are: get: disables the GET request method. post: disables the POST request method. delete: disables the DELETE request method. put: disables the PUT request method. head: disables the HEAD request method. patch: disables the PATCH request method. connect: disables the CONNECT request method. options: disables the OPTIONS request method.
        """
        return pulumi.get(self, "methods")
...
@pulumi.output_type
class GetDomainNegativeCacheResult(dict):
    def __init__(__self__, *,
                 condition: 'outputs.GetDomainNegativeCacheConditionResult',
                 negative_cache_rule: 'outputs.GetDomainNegativeCacheNegativeCacheRuleResult'):
        """
        :param 'GetDomainNegativeCacheConditionArgs' condition: Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        :param 'GetDomainNegativeCacheNegativeCacheRuleArgs' negative_cache_rule: Represents a list. Each element in the list is a status code cache rule.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "negative_cache_rule", negative_cache_rule)
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> 'outputs.GetDomainNegativeCacheConditionResult':
        """
        Indicates the conditions under which this configuration module takes effect, consisting of a set of rules.
        """
        return pulumi.get(self, "condition")
    ...
    @_builtins.property
    @pulumi.getter(name="negativeCacheRule")
    def negative_cache_rule(self) -> 'outputs.GetDomainNegativeCacheNegativeCacheRuleResult':
        """
        Represents a list. Each element in the list is a status code cache rule.
        """
        return pulumi.get(self, "negative_cache_rule")
...
@pulumi.output_type
class GetDomainNegativeCacheConditionResult(dict):
    def __init__(__self__, *,
                 condition_rules: Sequence['outputs.GetDomainNegativeCacheConditionConditionRuleResult'],
                 connective: _builtins.str):
        """
        :param Sequence['GetDomainNegativeCacheConditionConditionRuleArgs'] condition_rules: Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        :param _builtins.str connective: Represents the logical relationship between multiple ConditionRule entries. This parameter has the following values: AND: indicates the logical relationship is 'AND'. OR: indicates the logical relationship is 'OR'. The default value is OR.
        """
        pulumi.set(__self__, "condition_rules", condition_rules)
        pulumi.set(__self__, "connective", connective)
    ...
    @_builtins.property
    @pulumi.getter(name="conditionRules")
    def condition_rules(self) -> Sequence['outputs.GetDomainNegativeCacheConditionConditionRuleResult']:
        """
        Indicates a rule set. When a user request is received, the content delivery network matches the rules in the set to the request in order. If a rule matches the request, the content delivery network stops matching the remaining rules.
        """
        return pulumi.get(self, "condition_rules")
...
@pulumi.output_type
class GetDomainNegativeCacheConditionConditionRuleResult(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 object: _builtins.str,
                 operator: _builtins.str,
...
@pulumi.output_type
class GetDomainNegativeCacheNegativeCacheRuleResult(dict):
    def __init__(__self__, *,
                 action: _builtins.str,
                 ignore_case: _builtins.bool,
                 status_code: _builtins.str,
...
class GetDomainOriginOriginActionOriginLineResult(dict):
    def __init__(__self__, *,
                 ...
                 origin_host: _builtins.str,
                 origin_type: _builtins.str,
                 private_bucket_access: _builtins.bool,
    ...
    @_builtins.property
    @pulumi.getter(name="privateBucketAccess")
    def private_bucket_access(self) -> _builtins.bool:
        """
        Indicates whether private read permissions are enabled for the object storage bucket. This parameter is only valid when InstanceType is tos. The parameter values are: true: Enabled. false: Not enabled. The default value is false.
        """
        return pulumi.get(self, "private_bucket_access")
...
class GetDomainOriginSniResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="sniDomain")
    def sni_domain(self) -> _builtins.str:
        """
        Specifies the domain name for origin SNI. When Switch is true, this parameter is required. The value cannot exceed 1,024 characters.
        """
        return pulumi.get(self, "sni_domain")
...
class GetDomainPageOptimizationResult(dict):
    def __init__(__self__, *,
                 optimization_types: Sequence[_builtins.str],
                 switch: _builtins.bool):
        """
        :param Sequence[_builtins.str] optimization_types: Specifies the optimization target. This parameter has the following values: html: HTML page. js: JavaScript code. css: CSS code. The default value is html. If you specify js or css, html must also be specified.
        :param _builtins.bool switch: Indicates whether this feature is enabled. The parameter values are: true: The feature is enabled. false: The feature is disabled.
    ...
    @_builtins.property
    @pulumi.getter(name="optimizationTypes")
    def optimization_types(self) -> Sequence[_builtins.str]:
        """
        Specifies the optimization target. This parameter has the following values: html: HTML page. js: JavaScript code. css: CSS code. The default value is html. If you specify js or css, html must also be specified.
        """
        return pulumi.get(self, "optimization_types")
...
class GetDomainRefererAccessRuleReferersTypeCommonTypeResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="ignoreScheme")
    def ignore_scheme(self) -> _builtins.bool:
        """
        Indicates whether the Referer header value in this Referers list under CommonType must start with HTTP or HTTPS. This parameter has the following values: true: Referer header values that do not start with HTTP or HTTPS are valid. In this case, the content delivery network will attempt to match them with the Referers list. false: Referer header values that do not start with HTTP or HTTPS are invalid. In this case, the content delivery network determines that they do not match the Referers list under CommonType. The default value is false.
        """
        return pulumi.get(self, "ignore_scheme")
...
class GetDomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionResult(dict):
    def __init__(__self__, *,
                 ...
                 request_body_rules: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="requestBodyRules")
    def request_body_rules(self) -> _builtins.str:
        """
        Indicates the rule for the authentication request body. You can leave this parameter unspecified or set its value to default. default means the request body is empty ("").
        """
        return pulumi.get(self, "request_body_rules")
...
class GetDomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthModeConfigResult(dict):
    def __init__(__self__, *,
                 backup_remote_addr: _builtins.str,
                 master_remote_addr: _builtins.str,
                 path_type: _builtins.str,
                 path_value: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="backupRemoteAddr")
    def backup_remote_addr(self) -> _builtins.str:
        """
        Indicates the backup address of the authentication server. The address format and requirements are the same as the primary address.
        """
        return pulumi.get(self, "backup_remote_addr")
    ...
    @_builtins.property
    @pulumi.getter(name="masterRemoteAddr")
    def master_remote_addr(self) -> _builtins.str:
        """
        Indicates the primary address of the authentication server. The length must not exceed 100 characters. The primary address format is \\n\\n://\\n\\n:\\n\\n or \\n\\n://\\n\\n:\\n\\n, where: \\n\\n is http or https. \\n\\n cannot be localhost. \\n\\n cannot be 127.0.0.1. \\n\\n is optional.
        """
        return pulumi.get(self, "master_remote_addr")
    ...
    @_builtins.property
    @pulumi.getter(name="pathValue")
    def path_value(self) -> _builtins.str:
        """
        Represents the path for an authentication request. The path cannot exceed 100 characters. It must start with a slash (/), and can include any printable ASCII characters except the following: consecutive slashes (//), percent sign (%), dollar sign ($), space, question mark (?), and Delete (ASCII code 127).
        """
        return pulumi.get(self, "path_value")
...
class GetDomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigCacheActionResult(dict):
    def __init__(__self__, *,
                 action: _builtins.str,
                 cache_keys: Sequence[_builtins.str],
                 ttl: _builtins.int):
        """
        :param _builtins.str action: Indicates whether the CDN caches authentication status codes. The parameter values are: nocache: CDN does not cache authentication status codes. cache: CDN caches authentication status codes.
        :param Sequence[_builtins.str] cache_keys: The cache key specifies the query parameters used to distinguish different request URIs. Each parameter must start with $.
    ...
    @_builtins.property
    @pulumi.getter(name="cacheKeys")
    def cache_keys(self) -> Sequence[_builtins.str]:
        """
        The cache key specifies the query parameters used to distinguish different request URIs. Each parameter must start with $.
        """
        return pulumi.get(self, "cache_keys")
...
class GetDomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionAuthResponseConfigStatusCodeActionResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="successCode")
    def success_code(self) -> _builtins.str:
        """
        Indicates the authentication status code for successful authentication. You can specify one or more status codes in the range 200–299. Separate multiple status codes with a semicolon (;). You can also specify 2xx to represent any status code from 200–299. The default value is 200.
        """
        return pulumi.get(self, "success_code")
...
class GetDomainRemoteAuthRemoteAuthRuleRemoteAuthRuleActionRequestHeaderRulesResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="requestHost")
    def request_host(self) -> _builtins.str:
        """
        Indicates the value of the HOST header in authentication requests. The default value for this parameter is default, meaning the HOST header matches your acceleration domain name.
        """
        return pulumi.get(self, "request_host")
...
class GetDomainRequestBlockRuleBlockRuleBlockActionResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="errorPage")
    def error_page(self) -> _builtins.str:
        """
        When Action is refuse, this parameter is optional, as explained below: If specified, this parameter indicates the name of a custom response page under global configuration. When the content delivery network refuses a request, it returns this custom page. Note that 'global configuration' is an Allowlist feature. To use this feature, submit a ticket. If this parameter is not specified, the content delivery network uses the standard response body for the error code specified in StatusCode. When Action is redirect, this parameter is invalid and can be omitted.
        """
        return pulumi.get(self, "error_page")
...
class GetDomainResponseHeaderResponseHeaderActionResponseHeaderInstanceResult(dict):
    def __init__(__self__, *,
                 access_origin_control: _builtins.bool,
                 action: _builtins.str,
                 key: _builtins.str,
                 value: _builtins.str,
                 value_type: _builtins.str):
    ...
    @_builtins.property
    @pulumi.getter(name="accessOriginControl")
    def access_origin_control(self) -> _builtins.bool:
        """
        Indicates whether the Origin field in the request header is validated when the content delivery network responds to user requests. Valid values are: true: The content delivery network validates the Origin field. If validation succeeds, the response header includes the Access-Control-Allow-Origin field, with the value matching the Origin field. If validation fails, the response header does not include the Access-Control-Allow-Origin field. false: The content delivery network does not validate the Origin field. The response header includes the Access-Control-Allow-Origin field, with the value set to your configured Access-Control-Allow-Origin content. The default value is false. This parameter is only effective when all the following conditions are met: Action is set. Key is Access-Control-Allow-Origin. ValueType is constant.
        """
        return pulumi.get(self, "access_origin_control")
...
class GetDomainRewriteHlsResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="signName")
    def sign_name(self) -> _builtins.str:
        """
        Indicates the name of the signature parameter, which cannot exceed 100 characters. Parameter names are case-sensitive and can include letters, numbers, underscores (_), hyphens (-), commas (,), periods (.), and exclamation marks (!). The default value is DrmAuthToken.
        """
        return pulumi.get(self, "sign_name")
...
class GetDomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionResult(dict):
    def __init__(__self__, *,
                 auth_algorithm: _builtins.str,
                 backup_secret_key: _builtins.str,
                 ...
                 keep_origin_arg: _builtins.bool,
                 master_secret_key: _builtins.str,
                 rewrite_m3_u8: _builtins.bool,
                 rewrite_m3_u8_rule: 'outputs.GetDomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionRewriteM3U8RuleResult',
                 sign_name: _builtins.str,
                 signature_rules: Sequence[_builtins.str],
                 time_format: _builtins.str,
                 time_name: _builtins.str,
                 url_auth_type: _builtins.str):
        """
        :param _builtins.str auth_algorithm: Indicates the algorithm used for signature calculation. This configuration has the following values: md5: MD5 algorithm. sha256: SHA-256 algorithm. The default value for this parameter is md5.
        :param _builtins.str backup_secret_key: Indicates the backup secret key. The backup secret key must be 6–40 characters long and can contain any printable ASCII character except Delete (ASCII code 127).
    ...
    @_builtins.property
    @pulumi.getter(name="authAlgorithm")
    def auth_algorithm(self) -> _builtins.str:
        """
        Indicates the algorithm used for signature calculation. This configuration has the following values: md5: MD5 algorithm. sha256: SHA-256 algorithm. The default value for this parameter is md5.
        """
        return pulumi.get(self, "auth_algorithm")
    ...
    @_builtins.property
    @pulumi.getter(name="backupSecretKey")
    def backup_secret_key(self) -> _builtins.str:
        """
        Indicates the backup secret key. The backup secret key must be 6–40 characters long and can contain any printable ASCII character except Delete (ASCII code 127).
        """
        return pulumi.get(self, "backup_secret_key")
    ...
    @_builtins.property
    @pulumi.getter(name="keepOriginArg")
    def keep_origin_arg(self) -> _builtins.bool:
        """
        This parameter is not currently available to external users. Do not use this parameter.
        """
        return pulumi.get(self, "keep_origin_arg")
    ...
    @_builtins.property
    @pulumi.getter(name="masterSecretKey")
    def master_secret_key(self) -> _builtins.str:
        """
        Indicates the primary key, with a length of 6–40 characters. It can include printable ASCII characters except Delete (ASCII code 127)
        """
        return pulumi.get(self, "master_secret_key")
    ...
    @_builtins.property
    @pulumi.getter(name="rewriteM3U8")
    def rewrite_m3_u8(self) -> _builtins.bool:
        """
        Indicates whether the content delivery network adds signature parameters to the URL of each segment file in a .m3u8 file when responding to a .m3u8 file request. The signature for each segment URL is calculated based on the rewritten segment URL using the signature rules. The parameter values are as follows: true: enabled. false: disabled.
        """
        return pulumi.get(self, "rewrite_m3_u8")
    ...
    @_builtins.property
    @pulumi.getter(name="signatureRules")
    def signature_rules(self) -> Sequence[_builtins.str]:
        """
        When URLAuthType is set to typee, this parameter is required and specifies the fields to be included in the signature calculation. The following fields must be included in the signature calculation: key: the secret key, which is the parameter value for MasterSecretKey or BackupSecretKey. uri: the URI of the resource requested by the user. If the URI contains Chinese characters, you need to encode the URI. TimeName: the parameter value for the timestamp. The following fields can optionally be included in the signature calculation: domain: the acceleration domain name. referer: the referer value carried in the user's request. ua: the User-Agent value carried in the user's request. ip: the client IP of the user's request. origin: the Origin value carried in the user's request. Custom variables: the variable names you define in CustomVariableInstances. The order in which the fields are listed determines the order of values in MD5() during signature calculation.
        """
        return pulumi.get(self, "signature_rules")
    ...
    @_builtins.property
    @pulumi.getter(name="timeName")
    def time_name(self) -> _builtins.str:
        """
        Indicates the name of the timestamp parameter. The value of TimeName can include English letters, numbers, underscores (_), hyphens (-), periods (.), commas (,), and exclamation marks (!), with a length of 1–100 characters. TimeName cannot be the same as SignName. When URLAuthType is typed or typee, this parameter is required. For other types, this parameter does not apply.
        """
        return pulumi.get(self, "time_name")
    ...
    @_builtins.property
    @pulumi.getter(name="urlAuthType")
    def url_auth_type(self) -> _builtins.str:
        """
        Signature type
        """
        return pulumi.get(self, "url_auth_type")
...
class GetDomainSignedUrlAuthSignedUrlAuthRuleSignedUrlAuthActionRewriteM3U8RuleResult(dict):
    def __init__(__self__, *,
                 delete_param: _builtins.bool,
                 keep_m3_u8_param: _builtins.bool):
        """
        :param _builtins.bool delete_param: Indicates whether to retain the original parameters in the URL when rewriting the shard URL. This parameter has the following values: true: removes the original parameters. false: retains the original parameters.
        :param _builtins.bool keep_m3_u8_param: Indicates whether to add unsigned query parameters from the M3U8 file request to the segment URL. The parameter has the following options: true: add query parameters to the segment URL. false: do not add query parameters.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deleteParam")
    def delete_param(self) -> _builtins.bool:
        """
        Indicates whether to retain the original parameters in the URL when rewriting the shard URL. This parameter has the following values: true: removes the original parameters. false: retains the original parameters.
        """
        return pulumi.get(self, "delete_param")
    ...
    @_builtins.property
    @pulumi.getter(name="keepM3U8Param")
    def keep_m3_u8_param(self) -> _builtins.bool:
        """
        Indicates whether to add unsigned query parameters from the M3U8 file request to the segment URL. The parameter has the following options: true: add query parameters to the segment URL. false: do not add query parameters.
        """
        return pulumi.get(self, "keep_m3_u8_param")
...
class GetDomainTimeoutTimeoutRuleTimeoutActionResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="httpTimeout")
    def http_timeout(self) -> _builtins.int:
        """
        Indicates the timeout period for HTTP requests. The value range for this parameter is 5–60.
        """
        return pulumi.get(self, "http_timeout")
...
class GetDomainUrlNormalizeResult(dict):
    def __init__(__self__, *,
                 normalize_objects: Sequence[_builtins.str],
                 switch: _builtins.bool):
        """
        :param Sequence[_builtins.str] normalize_objects: This specifies the list of URL normalization options you need to enable. When Switch is true, this parameter is required. The list can include the following options: dot*segments: replaces the following in the request URL: /./: replaced with a single slash (/). /../: if there is a directory level before /../, removes /../ and that directory. If there is no directory before /../, the original URL is retained. back*slashes: replaces backslashes () in the request URL with a single slash (/). successive_slashes: replaces consecutive slashes (//) in the request URL with a single slash (/).
        :param _builtins.bool switch: This specifies the list of URL normalization options you need to enable. When Switch is true, this parameter is required. The list can include the following options: dot*segments: replaces the following in the request URL: /./: replaced with a single slash (/). /../: if there is a directory level before /../, removes /../ and that directory. If there is no directory before /../, the original URL is retained. back*slashes: replaces backslashes () in the request URL with a single slash (/). successive_slashes: replaces consecutive slashes (//) in the request URL with a single slash (/).
    ...
    @_builtins.property
    @pulumi.getter(name="normalizeObjects")
    def normalize_objects(self) -> Sequence[_builtins.str]:
        """
        This specifies the list of URL normalization options you need to enable. When Switch is true, this parameter is required. The list can include the following options: dot*segments: replaces the following in the request URL: /./: replaced with a single slash (/). /../: if there is a directory level before /../, removes /../ and that directory. If there is no directory before /../, the original URL is retained. back*slashes: replaces backslashes () in the request URL with a single slash (/). successive_slashes: replaces consecutive slashes (//) in the request URL with a single slash (/).
        """
        return pulumi.get(self, "normalize_objects")
