...
class GetBackupPolicyResult:
    ...
    def retention_num_max(self) -> _builtins.int:
        """
    ...
    def retention_num_min(self) -> _builtins.int:
        """
...
def get_backup_policy_output(id: pulumi.Input[Optional[_builtins.str]] = None,
