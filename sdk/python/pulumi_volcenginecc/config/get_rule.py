...
class GetRuleResult:
    ...
    """
    def __init__(__self__, created_time=None, description=None, id=None, input_parameters=None, risk_level=None, rule_id=None, rule_name=None, rule_status=None, rule_template_id=None, scope=None, start_rule_evaluation=None, triggers=None):
    ...
    @_builtins.property
    @pulumi.getter
    def scope(self) -> 'outputs.GetRuleScopeResult':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def triggers(self) -> Sequence['outputs.GetRuleTriggerResult']:
        """
...
def get_rule(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:config/getRule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:config/getRule:getRule', __args__, opts=opts, typ=GetRuleResult)
