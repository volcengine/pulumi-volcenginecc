...
class GetAccessKeyResult:
    ...
    def acl_config_json(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def actived(self) -> builtins.bool:
        """
    ...
    def all_authority(self) -> builtins.str:
        """
...
def get_access_key(id: Optional[builtins.str] = None,
...
def get_access_key_output(id: Optional[pulumi.Input[builtins.str]] = None,
