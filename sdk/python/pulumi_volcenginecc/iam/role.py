...
class RoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Role description, maximum length 128
        :param pulumi.Input[builtins.str] display_name: Role display name, maximum length 64
        :param pulumi.Input[builtins.int] is_service_linked_role: Service-linked role or not: 0 for No, 1 for Yes
        :param pulumi.Input[builtins.int] max_session_duration: Maximum session duration for the role. Maximum session duration for the role. Limits the maximum validity period of temporary security credentials generated by role assumption. Value range: 3600–43200, unit: seconds, default is 43200
        :param pulumi.Input[builtins.str] role_name: Role name, length 1–64, supports English letters, numbers, and .-_ characters
        :param pulumi.Input[builtins.str] service_name: Service associated with the service-linked role to be created.
        :param pulumi.Input[builtins.str] trust_policy_document: Role trust policy. The trust policy follows resource-based policy rules in IAM policy syntax.
        """
...
class _RoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_date: Role creation time
        :param pulumi.Input[builtins.str] description: Role description, maximum length 128
        :param pulumi.Input[builtins.str] display_name: Role display name, maximum length 64
        :param pulumi.Input[builtins.int] is_service_linked_role: Service-linked role or not: 0 for No, 1 for Yes
        :param pulumi.Input[builtins.int] max_session_duration: Maximum session duration for the role. Maximum session duration for the role. Limits the maximum validity period of temporary security credentials generated by role assumption. Value range: 3600–43200, unit: seconds, default is 43200
        ...
        :param pulumi.Input[builtins.str] role_name: Role name, length 1–64, supports English letters, numbers, and .-_ characters
        :param pulumi.Input[builtins.str] service_name: Service associated with the service-linked role to be created.
        :param pulumi.Input[builtins.str] trn: Role TRN
        :param pulumi.Input[builtins.str] trust_policy_document: Role trust policy. The trust policy follows resource-based policy rules in IAM policy syntax.
        :param pulumi.Input[builtins.str] update_date: Role update time
        """
