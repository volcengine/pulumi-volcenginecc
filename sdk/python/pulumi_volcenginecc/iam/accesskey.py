...
class _AccesskeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_time: Key creation time. The time format is ISO8601.
        :param pulumi.Input[_builtins.str] last_login_date: Last login time.
        :param pulumi.Input[_builtins.str] region: The last region accessed by the API key.
        :param pulumi.Input[_builtins.str] request_time: The last time the API key was used.
        :param pulumi.Input[_builtins.str] secret_access_key: Secret Access Key.
        :param pulumi.Input[_builtins.str] service: The English abbreviation of the last service accessed by the API key.
        :param pulumi.Input[_builtins.str] status: Key status. active means enabled, inactive means disabled.
        :param pulumi.Input[_builtins.str] updated_time: Key update time. The time format is ISO8601.
        :param pulumi.Input[_builtins.str] user_name: User name. Used to create a key for the specified IAM user. If no user name is specified, a key is created for the current request identity (that is, if the primary account makes the request, the key is created for the primary account itself; if an IAM user makes the request, the key is created for the IAM user. Note: Roles do not support creating keys for themselves). If the IAM user has the AccessKeySelfManageAccess permission and needs to create a key for themselves, they must include their own UserName in the request.
        """
...
class Accesskey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lastLoginDate")
    def last_login_date(self) -> pulumi.Output[_builtins.str]:
        """
        Last login time.
        """
        return pulumi.get(self, "last_login_date")
    ...
    @_builtins.property
    @pulumi.getter(name="requestTime")
    def request_time(self) -> pulumi.Output[_builtins.str]:
        """
        The last time the API key was used.
        """
        return pulumi.get(self, "request_time")
