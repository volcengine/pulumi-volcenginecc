...
class GetSamlProviderResult:
    ...
    def certificate_expire_time(self) -> _builtins.str:
    ...
    def encoded_saml_metadata_document(self) -> _builtins.str:
...
def get_saml_provider(id: Optional[_builtins.str] = None,
...
def get_saml_provider_output(id: pulumi.Input[Optional[_builtins.str]] = None,
