...
class GetRoleResult:
    ...
    def is_service_linked_role(self) -> _builtins.int:
        """
    ...
    def trust_policy_document(self) -> _builtins.str:
        """
...
def get_role_output(id: pulumi.Input[Optional[_builtins.str]] = None,
