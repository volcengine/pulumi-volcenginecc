...
class GetAllowListResult:
    ...
    """
    def __init__(__self__, allow_list=None, allow_list_category=None, allow_list_desc=None, allow_list_id=None, allow_list_ip_num=None, allow_list_name=None, allow_list_type=None, associated_instance_num=None, associated_instances=None, id=None, instance_id=None, project_name=None, user_allow_list=None):
...
def get_allow_list(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:rdsmssql/getAllowList:getAllowList', __args__, opts=opts, typ=GetAllowListResult).value
...
def get_allow_list_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:rdsmssql/getAllowList:getAllowList', __args__, opts=opts, typ=GetAllowListResult)
