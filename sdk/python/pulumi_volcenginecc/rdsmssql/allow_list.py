...
class AllowListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] allow_list: IP allowlist. Separate multiple IP addresses with commas (,). No duplicates allowed
        ...
        :param pulumi.Input[_builtins.int] associated_instance_num: Number of bound instances. Required when unbinding an instance from the allowlist
        ...
        :param pulumi.Input[_builtins.str] user_allow_list: IP addresses outside the security group that need to be added to the allowlist. Enter IP addresses or CIDR-formatted IP ranges. If both this field and AllowList are specified, AllowList takes precedence
        """
...
class _AllowListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] allow_list_ip_num: Allowlist IP count
        :param pulumi.Input[_builtins.str] allow_list_name: Allowlist name
        :param pulumi.Input[_builtins.str] allow_list_type: IP address type in the allowlist. Only IPv4 is supported
        :param pulumi.Input[_builtins.int] associated_instance_num: Number of bound instances. Required when unbinding an instance from the allowlist
        :param pulumi.Input[Sequence[pulumi.Input['AllowListAssociatedInstanceArgs']]] associated_instances: Bound instance list
...
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        r_dsms_sql_allowlist_demo = volcenginecc.rdsmssql.AllowList("RDSMsSQLAllowlistDemo",
