...
class ConnectionTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: Tag key. Cannot start with volc: or sys:. Length range: 1 ~ 128 characters
        :param _builtins.str value: Tag value. Length range: 0 ~ 256 characters. If not specified, defaults to empty
        """
        if key is not None:
...
class DirectConnectGatewayAssociateCen(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cen_id: ID of CEN.
        :param _builtins.str cen_owner_id: User ID of CEN.
        :param _builtins.str cen_status: Status of the instance in CEN. Attaching: attaching. Attached: attached.
        """
...
class DirectConnectGatewayAssociateEic(dict):
    ...
    def __init__(__self__, *,
                 eic_id: Optional[_builtins.str] = None,
                 eic_owner_id: Optional[_builtins.str] = None,
                 eic_status: Optional[_builtins.str] = None):
        """
        :param _builtins.str eic_id: ID of EIC.
        :param _builtins.str eic_owner_id: User ID of EIC.
        :param _builtins.str eic_status: Status of the instance in EIC.
        """
    ...
    def eic_id(self) -> Optional[_builtins.str]:
        """
        ID of EIC.
        """
    ...
    def eic_owner_id(self) -> Optional[_builtins.str]:
        """
        User ID of EIC.
        """
    ...
    def eic_status(self) -> Optional[_builtins.str]:
        """
...
class DirectConnectGatewayTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: User label tag key. Length must be between 1 and 128 characters.
        :param _builtins.str value: User label tag value. Length must be between 0 and 256 characters.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
@pulumi.output_type
class GetConnectionTagResult(dict):
    def __init__(__self__, *,
                 key: _builtins.str,
                 value: _builtins.str):
        """
...
class GetDirectConnectGatewayAssociateEicResult(dict):
    def __init__(__self__, *,
                 eic_id: _builtins.str,
                 eic_owner_id: _builtins.str,
                 eic_status: _builtins.str):
        """
        :param _builtins.str eic_id: ID of EIC.
        :param _builtins.str eic_owner_id: User ID of EIC.
        :param _builtins.str eic_status: Status of the instance in EIC.
    ...
    @_builtins.property
    @pulumi.getter(name="eicOwnerId")
    def eic_owner_id(self) -> _builtins.str:
        """
        User ID of EIC.
        """
        return pulumi.get(self, "eic_owner_id")
    ...
    @_builtins.property
    @pulumi.getter(name="eicStatus")
    def eic_status(self) -> _builtins.str:
        """
        Status of the instance in EIC.
        """
        return pulumi.get(self, "eic_status")
