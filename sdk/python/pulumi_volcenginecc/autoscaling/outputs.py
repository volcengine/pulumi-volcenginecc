...
class ScalingConfigurationEip(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int bandwidth: Peak bandwidth for the public IP. Default is 1, unit: Mbps. Value: When Eip.BillingType is set to PostPaidByBandwidth, the value is 1–500. When Eip.BillingType is set to PostPaidByTraffic, the value is 1–200.
        ...
        :param _builtins.str billing_type: Billing type for public IP. Options: PostPaidByBandwidth (default): Pay-as-you-go, billed by bandwidth cap. PostPaidByTraffic: Pay-as-you-go, billed by actual traffic.
        :param _builtins.str isp: Line type. Values: BGP (default): BGP line. If your account has applied for static single line, ISP can also be set to ChinaMobile (China Mobile), ChinaTelecom (China Telecom), or ChinaUnicom (China Unicom).
...
class ScalingConfigurationInstanceTypeOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str instance_type: Specify the specifications for preemptible instances. Parameter   - N: Indicates the sequence number of the instance specification, value range 1–10. Value   - InstanceType: Specifies the specification for the preemptible instance. Use & to separate multiple specifications.
        :param _builtins.float price_limit: Specify the maximum hourly price for preemptible instance types. Parameter   - N: Indicates the instance type sequence number. Value: 1–10. PriceLimit: Specifies the maximum hourly price for the preemptible instance type. Value: Greater than 0, up to three decimal places. Use & to separate multiple prices.
        """
...
class ScalingConfigurationVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool delete_with_instance: Whether the cloud disk is released with the instance: true (default): The cloud disk is released with the instance. false: The cloud disk is not released with the instance. When set to false, this does not apply to system disks. System disks are always released with the instance and cannot be retained.
        :param _builtins.int extra_performance_iops: You can use this parameter to configure the extra performance package IOPS size for cloud disks. Only ESSD FlexPL is supported. Parameter   - N: Indicates the disk sequence number. '1' represents the system disk; '2' or greater represents a data disk. Only data disks support extra performance packages. Value: 2–16. ExtraPerformanceIOPS specifies the extra performance package IOPS size for the Nth disk: IOPS: 1–50000. Balance: 1–50000.
        :param _builtins.int extra_performance_throughput_mb: You can use this parameter to configure the extra performance package throughput size for cloud disks, in MB/s. Only ESSD FlexPL is supported. Parameter   - N: Indicates the disk sequence number. '1' represents the system disk; '2' or greater represents a data disk. Only data disks support extra performance packages. Value: 2–16. ExtraPerformanceThroughputMB specifies the extra performance package throughput size for the Nth disk: Throughput: 1–650.
        :param _builtins.str extra_performance_type_id: This parameter allows you to purchase extra performance for cloud disks. Only ESSD FlexPL is supported. Parameter   - N: Indicates the disk sequence number. "1" is the system disk; "2" or greater indicates a data disk. Only data disks support extra performance packages. Value: 2–16. ExtraPerformanceTypeId specifies the extra performance package type for the Nth disk: IOPS: IOPS type, use the ExtraPerformanceIOPS parameter. Balance: Balanced type, use the ExtraPerformanceIOPS parameter. Throughput: Throughput type, use the ExtraPerformanceThroughputMB parameter.
        :param _builtins.int size: Cloud disk capacity, in GiB. System disk range: 10–500. Data disk range: 10–8192. If using ESSD_FlexPL with additional performance, size must be >= 500 GB
        :param _builtins.str volume_type: Cloud disk types: ESSD*FlexPL: Extreme SSD FlexPL. ESSD*PL0: Extreme SSD PL0.
        """
...
class ScalingGroupInstance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 entrusted: Optional[_builtins.bool] = None,
                 instance_id: Optional[_builtins.str] = None,
                 launch_template_id: Optional[_builtins.str] = None,
                 launch_template_version: Optional[_builtins.str] = None,
                 lifecycle_hook: Optional[_builtins.bool] = None,
                 scaling_configuration_id: Optional[_builtins.str] = None,
                 scaling_policy_id: Optional[_builtins.str] = None,
                 status: Optional[_builtins.str] = None,
                 zone_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str created_time: Time when the instance joined the scaling group
        :param _builtins.str creation_type: How the instance joined the scaling group (Attached / AutoCreated)
        :param _builtins.bool entrusted: Whether to enable managed mode for the instance when AttachInstances is performed
        :param _builtins.str instance_id: ECS instance ID, unique identifier of the subresource
        :param _builtins.str launch_template_id: Launch template ID used by the instance
        :param _builtins.str launch_template_version: Launch template version used by the instance
        :param _builtins.bool lifecycle_hook: Whether to trigger lifecycle hooks when the instance is attached, detached, or removed
        :param _builtins.str scaling_configuration_id: Scaling configuration ID associated with the instance
        :param _builtins.str scaling_policy_id: Scaling policy ID associated with the instance
        :param _builtins.str status: Current status of the instance in the scaling group
    ...
    @_builtins.property
    @pulumi.getter
    def entrusted(self) -> Optional[_builtins.bool]:
        """
    ...
    def lifecycle_hook(self) -> Optional[_builtins.bool]:
        """
...
class ScalingGroupInstanceRemovePolicy(dict):
    ...
    def __init__(__self__, *,
                 decrease_desired_capacity: Optional[_builtins.bool] = None,
                 detach_option: Optional[_builtins.str] = None,
                 force_delete: Optional[_builtins.bool] = None,
                 instance_id: Optional[_builtins.str] = None,
                 lifecycle_hook: Optional[_builtins.bool] = None,
                 mode: Optional[_builtins.str] = None,
                 remove_mode: Optional[_builtins.str] = None):
        """
        :param _builtins.bool decrease_desired_capacity: Whether to decrease the desired instance count synchronously when DetachInstances or RemoveInstances is performed
        :param _builtins.str detach_option: Instance removal policy for DetachInstances
        :param _builtins.bool force_delete: Whether to force delete the instance when RemoveInstances is performed
        :param _builtins.str instance_id: ECS instance ID, unique identifier of the subresource
        :param _builtins.bool lifecycle_hook: Whether to trigger lifecycle hooks when the instance is attached, detached, or removed
        :param _builtins.str mode: Mode: How to handle an instance when it is removed from the scaling group: Detach means only remove from the scaling group, Remove means remove and delete the instance
        :param _builtins.str remove_mode: Removal mode for RemoveInstances
        """
    ...
    def decrease_desired_capacity(self) -> Optional[_builtins.bool]:
        """
    ...
    def force_delete(self) -> Optional[_builtins.bool]:
        """
    ...
    def remove_mode(self) -> Optional[_builtins.str]:
        """
...
class ScalingGroupInstancesDistribution(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool compensate_with_on_demand: Whether pay-as-you-go instances are allowed to supplement spot capacity if spot instances cannot be created due to price or inventory constraints. true: allowed. false (default): not allowed.
        :param _builtins.int on_demand_base_capacity: Minimum number of pay-as-you-go instances in the scaling group. Value range: 0~2000. If the number of pay-as-you-go instances in the group is less than this value, pay-as-you-go instances will be prioritized for creation.
        :param _builtins.int on_demand_percentage_above_base_capacity: After the scaling group meets the minimum number of pay-as-you-go instances, the proportion of pay-as-you-go instances among the excess instances. Value range: 0–100.
        :param _builtins.bool spot_instance_remedy: Whether to allow preemptible instance replacement upon expiration. If enabled, the scaling group will proactively create a new preemptible instance to replace the current one about 5 minutes before the preemptible instance is reclaimed. true: allowed. false (default): not allowed.
        """
...
class ScalingGroupLaunchTemplateOverride(dict):
    ...
    def __init__(__self__, *,
                 ...
                 price_limit: Optional[_builtins.float] = None):
        """
        :param _builtins.str instance_type: Specify the instance type. This parameter is valid only when the LaunchTemplateId parameter is set.
        :param _builtins.float price_limit: Specify the maximum hourly price for spot instance types. This parameter is valid only when the LaunchTemplateId parameter is set and the launch template's billing mode is SpotWithPriceLimit.
        """
        if instance_type is not None:
            pulumi.set(__self__, "instance_type", instance_type)
        if price_limit is not None:
...
class ScalingGroupServerGroupAttribute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int port: Port number of the server in the backend server group for load balancing. Range: 1–65535.
        :param _builtins.str server_group_id: Backend server group ID for load balancing.
        :param _builtins.str type: Load balancing server group type. A single CLB/ALB supports up to 20 backend server groups, and the total number of backend servers supported by all CLB/ALB is 100. ALB: Application Load Balancer. CLB: Classic Load Balancer (default).
        :param _builtins.int weight: Weight of servers in the backend server group of the load balancer
        """
        if port is not None:
...
class ScalingGroupTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: User label tag key
        :param _builtins.str value: The value of the user tag.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ScalingPolicyAlarmPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str condition_operator: Determination conditions for multi-metric alarms. &&: Alarm is triggered only when all metrics meet the conditions. || (default): Alarm is triggered when any metric meets the condition.
        :param Sequence['ScalingPolicyAlarmPolicyConditionArgs'] conditions: Detailed information about monitoring metrics for multi-metric monitoring. Valid only when ScalingPolicyType is set to Alarm. You must configure either AlarmPolicy.Condition.x or AlarmPolicy.Conditions.x parameters. If both are configured, only AlarmPolicy.Conditions.x takes effect.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str effective: The effective period for the alarm task.
        :param _builtins.int evaluation_count: Scaling actions are triggered when monitoring metric data reaches the threshold for several consecutive times. Valid only when ScalingPolicyType is set to Alarm and required.
        :param _builtins.str rule_type: Type of alarm task. Options: Static: static monitoring collected by agent. Valid only when ScalingPolicyType is set to Alarm and required.
        """
...
class ScalingPolicyScheduledPolicy(dict):
    ...
    def __init__(__self__, *,
                 launch_time: Optional[_builtins.str] = None,
                 launch_time_read: Optional[_builtins.str] = None,
                 recurrence_end_time: Optional[_builtins.str] = None,
                 recurrence_end_time_read: Optional[_builtins.str] = None,
                 recurrence_start_time: Optional[_builtins.str] = None,
                 recurrence_type: Optional[_builtins.str] = None,
                 recurrence_value: Optional[_builtins.str] = None):
        """
        :param _builtins.str launch_time: Indicates the trigger time for the task. The default is the current time. When ScalingPolicyType is set to Scheduled, this specifies the trigger time for the scheduled task. When ScalingPolicyType is set to Recurrence: If ScheduledPolicy.RecurrenceType is empty, the task is executed only once at the specified date and time. If ScheduledPolicy.RecurrenceType is not empty, this specifies the start time for the recurring task.
        :param _builtins.str launch_time_read: Indicates the task trigger time. This is a read-only field; use LaunchTime to modify or create.
        :param _builtins.str recurrence_end_time: Indicates the end time for the recurring task. Only supports selecting a time within 365 days from the creation date. If not configured, defaults to one day/week/month after the current time based on the recurrence cycle (ScheduledPolicy.RecurrenceType). If set to empty, the task never stops. Valid only when ScalingPolicyType is set to Recurrence and required.
        :param _builtins.str recurrence_end_time_read: Indicates the end time for the recurring task. Read-only field; use RecurrenceEndTime for modification or creation.
        :param _builtins.str recurrence_start_time: Indicates the start time for the recurring task. Valid only when ScalingPolicyType is set to Recurrence.
        :param _builtins.str recurrence_type: Indicates the recurrence cycle for scheduled tasks. Values: Daily: Executes once every XX days. Weekly: Select specific days of the week, executes once per day. Monthly: Select XX to XX days of the month, executes once per day. Cron: Executes according to the specified Cron expression. Required and valid only when ScalingPolicyType is set to Recurrence.
        :param _builtins.str recurrence_value: Specifies the value for recurring tasks. When the ScheduledPolicy.RecurrenceType parameter is set to Daily, only one value can be entered: 1–31. When the ScheduledPolicy.RecurrenceType parameter is set to Weekly, multiple values can be entered, separated by commas (,). Values for Monday to Sunday are: 1 (Monday), 2 (Tuesday), 3 (Wednesday), 4 (Thursday), 5 (Friday), 6 (Saturday), 7 (Sunday). When the ScheduledPolicy.RecurrenceType parameter is set to Monthly, the format is A-B. Both A and B range from 1–31, and B must be greater than or equal to A. When the ScheduledPolicy.RecurrenceType parameter is set to Cron, it uses UTC+8 time and supports a five-field expression for minute, hour, day, month, and week. Wildcards supported include comma (,), question mark (?), hyphen (-), asterisk (*), hash (#), slash (/), L, and W. This field is valid and required when ScalingPolicyType is set to Recurrence.
        """
    ...
    def launch_time(self) -> Optional[_builtins.str]:
        """
    ...
    def launch_time_read(self) -> Optional[_builtins.str]:
        """
    ...
    def recurrence_end_time(self) -> Optional[_builtins.str]:
        """
    ...
    def recurrence_end_time_read(self) -> Optional[_builtins.str]:
        """
    ...
    def recurrence_start_time(self) -> Optional[_builtins.str]:
        """
...
class GetScalingGroupInstanceResult(dict):
    ...
    @_builtins.property
    @pulumi.getter
    def entrusted(self) -> _builtins.bool:
        """
        Whether to enable managed mode for the instance when AttachInstances is performed
        """
        return pulumi.get(self, "entrusted")
    ...
    @_builtins.property
    @pulumi.getter(name="lifecycleHook")
    def lifecycle_hook(self) -> _builtins.bool:
        """
        Whether to trigger lifecycle hooks when the instance is attached, detached, or removed
        """
        return pulumi.get(self, "lifecycle_hook")
...
class GetScalingGroupInstanceRemovePolicyResult(dict):
    def __init__(__self__, *,
                 decrease_desired_capacity: _builtins.bool,
                 detach_option: _builtins.str,
                 force_delete: _builtins.bool,
                 instance_id: _builtins.str,
                 lifecycle_hook: _builtins.bool,
                 mode: _builtins.str,
                 remove_mode: _builtins.str):
        """
        :param _builtins.bool decrease_desired_capacity: Whether to decrease the desired instance count synchronously when DetachInstances or RemoveInstances is performed
        :param _builtins.str detach_option: Instance removal policy for DetachInstances
        :param _builtins.bool force_delete: Whether to force delete the instance when RemoveInstances is performed
    ...
    @_builtins.property
    @pulumi.getter(name="decreaseDesiredCapacity")
    def decrease_desired_capacity(self) -> _builtins.bool:
        """
        Whether to decrease the desired instance count synchronously when DetachInstances or RemoveInstances is performed
        """
        return pulumi.get(self, "decrease_desired_capacity")
    ...
    @_builtins.property
    @pulumi.getter(name="detachOption")
    def detach_option(self) -> _builtins.str:
        """
        Instance removal policy for DetachInstances
        """
        return pulumi.get(self, "detach_option")
    ...
    @_builtins.property
    @pulumi.getter(name="removeMode")
    def remove_mode(self) -> _builtins.str:
        """
        Removal mode for RemoveInstances
        """
        return pulumi.get(self, "remove_mode")
...
class GetScalingGroupLaunchTemplateOverrideResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str instance_type: Specify the instance type. This parameter is valid only when the LaunchTemplateId parameter is set.
        :param _builtins.float price_limit: Specify the maximum hourly price for spot instance types. This parameter is valid only when the LaunchTemplateId parameter is set and the launch template's billing mode is SpotWithPriceLimit.
        :param _builtins.int weighted_capacity: Instance type weight
        """
        pulumi.set(__self__, "instance_type", instance_type)
        pulumi.set(__self__, "price_limit", price_limit)
...
class GetScalingGroupServerGroupAttributeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str load_balancer_id: ID of the load balancer instance.
        :param _builtins.int port: Port number of the server in the backend server group for load balancing. Range: 1–65535.
        :param _builtins.str server_group_id: Backend server group ID for load balancing.
        :param _builtins.str type: Load balancing server group type. A single CLB/ALB supports up to 20 backend server groups, and the total number of backend servers supported by all CLB/ALB is 100. ALB: Application Load Balancer. CLB: Classic Load Balancer (default).
        :param _builtins.int weight: Weight of servers in the backend server group of the load balancer
...
class GetScalingPolicyScheduledPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 launch_time_read: _builtins.str,
                 recurrence_end_time: _builtins.str,
                 recurrence_end_time_read: _builtins.str,
                 recurrence_start_time: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="launchTimeRead")
    def launch_time_read(self) -> _builtins.str:
        """
        Indicates the task trigger time. This is a read-only field; use LaunchTime to modify or create.
        """
        return pulumi.get(self, "launch_time_read")
    ...
    @_builtins.property
    @pulumi.getter(name="recurrenceEndTimeRead")
    def recurrence_end_time_read(self) -> _builtins.str:
        """
        Indicates the end time for the recurring task. Read-only field; use RecurrenceEndTime for modification or creation.
        """
        return pulumi.get(self, "recurrence_end_time_read")
    ...
    @_builtins.property
    @pulumi.getter(name="recurrenceStartTime")
    def recurrence_start_time(self) -> _builtins.str:
        """
        Indicates the start time for the recurring task. Valid only when ScalingPolicyType is set to Recurrence.
        """
        return pulumi.get(self, "recurrence_start_time")
