...
class SnapshotPolicyArgs:
    def __init__(__self__, *,
                 auto_snapshot_policy_name: pulumi.Input[_builtins.str],
                 retention_days: pulumi.Input[_builtins.int],
                 time_points: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 add_volume_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 remove_volume_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 repeat_days: pulumi.Input[Optional[_builtins.int]] = None,
                 repeat_weekdays: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotPolicyTagArgs']]]] = None):
        """
        The set of arguments for constructing a SnapshotPolicy resource.

        :param pulumi.Input[_builtins.str] auto_snapshot_policy_name: Automatic snapshot policy name. Naming rules: The first character must be Chinese, a letter, or an underscore (*). It can include Chinese, letters, numbers, underscores (*), hyphens (-), or periods (.). Length must be between 1 and 128 characters.
        :param pulumi.Input[_builtins.int] retention_days: Retention period for automatic snapshots, in days. -1: Save permanently; 1–65536: Specify number of days to retain.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] time_points: Snapshot creation time points, using UTC +8 time. Unit: hour. Value range: 0–23.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] add_volume_ids: List of cloud disk IDs to associate with the automatic snapshot policy.
        :param pulumi.Input[_builtins.str] project_name: Project associated with the automatic snapshot policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] remove_volume_ids: List of cloud disk IDs to disassociate from the automatic snapshot policy.
        :param pulumi.Input[_builtins.int] repeat_days: Create snapshots on a daily basis, with a specified interval in days. The value range is [1, 30]. When repeating snapshot creation daily, the day you create the automatic snapshot policy is considered Day 1. Snapshots will not be created for past time points. If all scheduled snapshot times for the day have passed, the day is still counted as Day 1.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] repeat_weekdays: Create snapshots on a weekly basis by selecting one or more days from Monday to Sunday. The value range is 1–7. When creating an automatic snapshot policy, you must set either the RepeatWeekdays.N or RepeatDays parameter. Setting both parameters at the same time is not supported.
        :param pulumi.Input[Sequence[pulumi.Input['SnapshotPolicyTagArgs']]] tags: Tag.
    ...
    def auto_snapshot_policy_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def auto_snapshot_policy_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def add_volume_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def add_volume_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def remove_volume_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def remove_volume_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "remove_volume_ids", value)

    @_builtins.property
    @pulumi.getter(name="repeatDays")
    def repeat_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @repeat_days.setter
    def repeat_days(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotPolicyTagArgs']]]]:
        """
        Tag.
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotPolicyTagArgs']]]]):
...
class _SnapshotPolicyState:
    def __init__(__self__, *,
                 ...
                 volume_nums: pulumi.Input[Optional[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] auto_snapshot_policy_name: Automatic snapshot policy name. Naming rules: The first character must be Chinese, a letter, or an underscore (*). It can include Chinese, letters, numbers, underscores (*), hyphens (-), or periods (.). Length must be between 1 and 128 characters.
        :param pulumi.Input[_builtins.str] created_at: Creation time of the automatic snapshot policy.
        :param pulumi.Input[_builtins.str] project_name: Project associated with the automatic snapshot policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] remove_volume_ids: List of cloud disk IDs to disassociate from the automatic snapshot policy.
        :param pulumi.Input[_builtins.int] repeat_days: Create snapshots on a daily basis, with a specified interval in days. The value range is [1, 30]. When repeating snapshot creation daily, the day you create the automatic snapshot policy is considered Day 1. Snapshots will not be created for past time points. If all scheduled snapshot times for the day have passed, the day is still counted as Day 1.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] repeat_weekdays: Create snapshots on a weekly basis by selecting one or more days from Monday to Sunday. The value range is 1–7. When creating an automatic snapshot policy, you must set either the RepeatWeekdays.N or RepeatDays parameter. Setting both parameters at the same time is not supported.
        :param pulumi.Input[_builtins.int] retention_days: Retention period for automatic snapshots, in days. -1: Save permanently; 1–65536: Specify number of days to retain.
        :param pulumi.Input[_builtins.str] status: Reserved parameter.
        :param pulumi.Input[Sequence[pulumi.Input['SnapshotPolicyTagArgs']]] tags: Tag.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] time_points: Snapshot creation time points, using UTC +8 time. Unit: hour. Value range: 0–23.
        :param pulumi.Input[_builtins.str] updated_at: Update time of the automatic snapshot policy.
        :param pulumi.Input[_builtins.int] volume_nums: Total number of cloud disks.
        """
        if add_volume_ids is not None:
            pulumi.set(__self__, "add_volume_ids", add_volume_ids)
    ...
    def volume_nums(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @volume_nums.setter
    def volume_nums(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 repeat_weekdays: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 retention_days: pulumi.Input[Optional[_builtins.int]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SnapshotPolicyTagArgs', 'SnapshotPolicyTagArgsDict']]]]] = None,
                 time_points: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        Automatic snapshot policy
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] repeat_weekdays: Create snapshots on a weekly basis by selecting one or more days from Monday to Sunday. The value range is 1–7. When creating an automatic snapshot policy, you must set either the RepeatWeekdays.N or RepeatDays parameter. Setting both parameters at the same time is not supported.
        :param pulumi.Input[_builtins.int] retention_days: Retention period for automatic snapshots, in days. -1: Save permanently; 1–65536: Specify number of days to retain.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SnapshotPolicyTagArgs', 'SnapshotPolicyTagArgsDict']]]] tags: Tag.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] time_points: Snapshot creation time points, using UTC +8 time. Unit: hour. Value range: 0–23.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            time_points: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            updated_at: pulumi.Input[Optional[_builtins.str]] = None,
            volume_nums: pulumi.Input[Optional[_builtins.int]] = None) -> 'SnapshotPolicy':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="addVolumeIds")
    def add_volume_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of cloud disk IDs to associate with the automatic snapshot policy.
        """
        return pulumi.get(self, "add_volume_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="removeVolumeIds")
    def remove_volume_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of cloud disk IDs to disassociate from the automatic snapshot policy.
        """
        return pulumi.get(self, "remove_volume_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="repeatDays")
    def repeat_days(self) -> pulumi.Output[_builtins.int]:
        """
        Create snapshots on a daily basis, with a specified interval in days. The value range is [1, 30]. When repeating snapshot creation daily, the day you create the automatic snapshot policy is considered Day 1. Snapshots will not be created for past time points. If all scheduled snapshot times for the day have passed, the day is still counted as Day 1.
        """
        return pulumi.get(self, "repeat_days")
    ...
    @_builtins.property
    @pulumi.getter(name="volumeNums")
    def volume_nums(self) -> pulumi.Output[_builtins.int]:
        """
        Total number of cloud disks.
        """
        return pulumi.get(self, "volume_nums")
