...
class SnapshotGroupArgs:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupTagArgs']]]] = None):
        """
        The set of arguments for constructing a SnapshotGroup resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] volume_ids: Cloud disk ID. Note: The cloud disk must be in 'attached' status. If multiple cloud disks are set, they must be attached to the same ECS instance
        :param pulumi.Input[_builtins.str] description: Snapshot consistency group description
        :param pulumi.Input[_builtins.str] instance_id: ECS instance ID of the snapshot consistency group
        :param pulumi.Input[_builtins.str] name: Snapshot consistency group name
        :param pulumi.Input[_builtins.str] project_name: Project name
        :param pulumi.Input[Sequence[pulumi.Input['SnapshotGroupTagArgs']]] tags: Tags of the snapshot consistency group
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupTagArgs']]]]):
...
class _SnapshotGroupState:
    def __init__(__self__, *,
                 ...
                 snapshots: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupSnapshotArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] creation_time: Snapshot consistency group creation time
        :param pulumi.Input[_builtins.str] description: Snapshot consistency group description
        :param pulumi.Input[_builtins.str] image_id: Image ID of the snapshot consistency group
        :param pulumi.Input[_builtins.str] instance_id: ECS instance ID of the snapshot consistency group
        :param pulumi.Input[_builtins.str] name: Snapshot consistency group name
        :param pulumi.Input[_builtins.str] project_name: Project name
        :param pulumi.Input[_builtins.str] snapshot_group_id: Snapshot consistency group ID
        :param pulumi.Input[Sequence[pulumi.Input['SnapshotGroupSnapshotArgs']]] snapshots: Snapshot details
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] status: Snapshot consistency group status
        :param pulumi.Input[Sequence[pulumi.Input['SnapshotGroupTagArgs']]] tags: Tags of the snapshot consistency group
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] volume_ids: Cloud disk ID. Note: The cloud disk must be in 'attached' status. If multiple cloud disks are set, they must be attached to the same ECS instance
        """
    ...
    @_builtins.property
    @pulumi.getter
    def snapshots(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupSnapshotArgs']]]]:
        """
        Snapshot details
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @snapshots.setter
    def snapshots(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SnapshotGroupSnapshotArgs']]]]):
...
class SnapshotGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SnapshotGroupTagArgs', 'SnapshotGroupTagArgsDict']]]]] = None,
                 volume_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: Snapshot consistency group name
        :param pulumi.Input[_builtins.str] project_name: Project name
        :param pulumi.Input[Sequence[pulumi.Input[Union['SnapshotGroupTagArgs', 'SnapshotGroupTagArgsDict']]]] tags: Tags of the snapshot consistency group
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] volume_ids: Cloud disk ID. Note: The cloud disk must be in 'attached' status. If multiple cloud disks are set, they must be attached to the same ECS instance
        """
        ...
    ...
    def get(resource_name: str,
            ...
            project_name: pulumi.Input[Optional[_builtins.str]] = None,
            snapshot_group_id: pulumi.Input[Optional[_builtins.str]] = None,
            snapshots: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SnapshotGroupSnapshotArgs', 'SnapshotGroupSnapshotArgsDict']]]]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['SnapshotGroupTagArgs', 'SnapshotGroupTagArgsDict']]]]] = None,
            volume_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'SnapshotGroup':
        """
        ...
        :param pulumi.Input[_builtins.str] project_name: Project name
        :param pulumi.Input[_builtins.str] snapshot_group_id: Snapshot consistency group ID
        :param pulumi.Input[Sequence[pulumi.Input[Union['SnapshotGroupSnapshotArgs', 'SnapshotGroupSnapshotArgsDict']]]] snapshots: Snapshot details
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] status: Snapshot consistency group status
        :param pulumi.Input[Sequence[pulumi.Input[Union['SnapshotGroupTagArgs', 'SnapshotGroupTagArgsDict']]]] tags: Tags of the snapshot consistency group
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
