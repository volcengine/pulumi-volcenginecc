...
class AclListenerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] acl_type: Control mode of the listener for this access control policy group. white: Allowlist mode; black: Denylist mode
        ...
        :param pulumi.Input[_builtins.str] protocol: Listener protocol
        """
...
class AclTagArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: User tag key. Length limit: 1–128 characters. Case sensitive. Cannot start with any combination of volc: or sys: (case insensitive). Cannot start or end with a space. Supports characters from all languages, numbers, spaces (), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @. Tag keys for the same resource must be unique
        :param pulumi.Input[_builtins.str] value: User tag value. Length limit: 0–256 characters. Case sensitive. Cannot start or end with a space. Supports characters from all languages, numbers, spaces (), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @
        """
        if key is not None:
...
class HealthCheckTemplateTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: Tag value for the user tag. If you specify this parameter, you must first specify Tags.N.Key. Rules: Length must be between 0 and 256 characters. Case-sensitive. Cannot start or end with a space. Supports characters from all languages, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), minus signs (-), and @.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ListenerDomainExtensionArgsDict(TypedDict):
    ...
    """
    pca_leaf_certificate_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ListenerServerGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] server_group_id: Server group ID.
        :param pulumi.Input[_builtins.str] server_group_name: Server group name.
        """
...
class ListenerTagArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: Tag key for user tags. Rules are as follows: Length must be between 1 and 128 characters. Case sensitive. Cannot start with any case combination of volc:. Cannot start or end with a space. Can include characters from any language, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), minus signs (-), and @. Tag keys for the same resource must be unique.
        :param pulumi.Input[_builtins.str] value: The value of the user tag. Rules: Length must be between 0 and 256 characters. Case sensitive. Cannot start or end with a space. May include characters from any language, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class LoadBalancerEipBillingConfigArgsDict(TypedDict):
    ...
    """
    security_protection_types: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class LoadBalancerEipBillingConfigArgs:
    def __init__(__self__, *,
                 ...
                 security_protection_types: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.int] bandwidth: Peak bandwidth of EIP, in Mbps.
        :param pulumi.Input[_builtins.int] billing_type: EIP billing method: 2 for bandwidth-based, 3 for traffic-based.
        :param pulumi.Input[_builtins.str] isp: Line type of the public IP, BGP indicates multi-line.
        :param pulumi.Input[_builtins.int] security_protection_instance_id: When creating an ALB public instance, if IP protection resources are used, you must specify a DDoS native protection instance ID.
        :param pulumi.Input[_builtins.str] security_protection_types: When creating a public ALB instance, ALB allows you to purchase multiple public IP protection resources. The rules for public IP protection resources are as follows: separate multiple protection resources with a comma (,). The values for protection resources are: AntiDDoS_Enhanced: You are requesting an enhanced protection type public IP, which can be added to a native DDoS protection instance. If not specified: You are requesting a basic protection type public IP.
        """
    ...
    def security_protection_types(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        When creating a public ALB instance, ALB allows you to purchase multiple public IP protection resources. The rules for public IP protection resources are as follows: separate multiple protection resources with a comma (,). The values for protection resources are: AntiDDoS_Enhanced: You are requesting an enhanced protection type public IP, which can be added to a native DDoS protection instance. If not specified: You are requesting a basic protection type public IP.
        """
    ...
    def security_protection_types(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "security_protection_types", value)


class LoadBalancerGlobalAcceleratorArgsDict(TypedDict):
    accelerator_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ID of the bound Global Accelerator instance.
    """
    accelerator_listener_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ID of the bound Global Accelerator listener.
    """
    endpoint_group_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class LoadBalancerGlobalAcceleratorArgs:
    def __init__(__self__, *,
                 ...
                 accelerator_listener_id: pulumi.Input[Optional[_builtins.str]] = None,
                 endpoint_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 weight: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.str] accelerator_id: ID of the bound Global Accelerator instance.
        :param pulumi.Input[_builtins.str] accelerator_listener_id: ID of the bound Global Accelerator listener.
        :param pulumi.Input[_builtins.str] endpoint_group_id: ID of the bound endpoint group.
        :param pulumi.Input[_builtins.int] weight: Weight of the backend server, determines traffic distribution ratio.
        """
    ...
    def accelerator_listener_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ID of the bound Global Accelerator listener.
        """
    ...
    def accelerator_listener_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class LoadBalancerHealthLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable access log
        :param pulumi.Input[_builtins.str] project_id: TLS project ID bound to access log
        :param pulumi.Input[_builtins.str] topic_id: TLS subject ID bound to access log
        """
...
class LoadBalancerIpv6EipBillingConfigArgs:
    def __init__(__self__, *,
                 ...
                 isp: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.int] bandwidth: Peak bandwidth of IPv6 EIP, in Mbps.
        :param pulumi.Input[_builtins.int] billing_type: Billing method for IPv6 EIP: 2 for bandwidth-based, 3 for traffic-based.
        :param pulumi.Input[_builtins.str] isp: Line type of IPv6 public IP; BGP indicates multi-line.
        """
        if bandwidth is not None:
            pulumi.set(__self__, "bandwidth", bandwidth)
        if billing_type is not None:
...
class LoadBalancerTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] key: Tag key, used to identify the tag category.
        :param pulumi.Input[_builtins.str] value: Tag value used to identify the specific tag content.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class LoadBalancerZoneMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] subnet_id: Subnet ID providing services within the availability zone.
        :param pulumi.Input[_builtins.str] zone_id: Unique identifier of the availability zone.
        """
...
class RuleForwardGroupConfigArgsDict(TypedDict):
    server_group_tuples: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['RuleForwardGroupConfigServerGroupTupleArgsDict']]]]]
    """
    Destination server group list.
    Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
    """
    sticky_session_enabled: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Whether to enable inter-group session persistence. on: enabled. off: disabled.
    """
    sticky_session_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class RuleForwardGroupConfigArgs:
    def __init__(__self__, *,
                 server_group_tuples: pulumi.Input[Optional[Sequence[pulumi.Input['RuleForwardGroupConfigServerGroupTupleArgs']]]] = None,
                 sticky_session_enabled: pulumi.Input[Optional[_builtins.str]] = None,
                 sticky_session_timeout: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['RuleForwardGroupConfigServerGroupTupleArgs']]] server_group_tuples: Destination server group list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] sticky_session_enabled: Whether to enable inter-group session persistence. on: enabled. off: disabled.
        :param pulumi.Input[_builtins.int] sticky_session_timeout: Component session stickiness timeout. Unit: seconds.
        """
    ...
    def server_group_tuples(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RuleForwardGroupConfigServerGroupTupleArgs']]]]:
        """
        Destination server group list.
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    def server_group_tuples(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RuleForwardGroupConfigServerGroupTupleArgs']]]]):
        pulumi.set(self, "server_group_tuples", value)

    @_builtins.property
    @pulumi.getter(name="stickySessionEnabled")
    def sticky_session_enabled(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether to enable inter-group session persistence. on: enabled. off: disabled.
        """
    ...
    def sticky_session_enabled(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sticky_session_enabled", value)

    @_builtins.property
    @pulumi.getter(name="stickySessionTimeout")
    def sticky_session_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Component session stickiness timeout. Unit: seconds.
        """
    ...
    def sticky_session_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class RuleForwardGroupConfigServerGroupTupleArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.str] server_group_id: Destination server group ID.
        :param pulumi.Input[_builtins.int] weight: Server group weight.
        """
        if server_group_id is not None:
            pulumi.set(__self__, "server_group_id", server_group_id)
        if weight is not None:
...
class RuleRedirectConfigArgsDict(TypedDict):
    redirect_domain: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    redirect_http_code: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Redirect status codes: 301, 302, 307, 308.
    """
    redirect_port: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RuleRedirectConfigArgs:
    ...
    def redirect_domain(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Redirect domain name. If the redirect domain name is left empty when creating or modifying a redirect forwarding rule, the API returns ${host}, which means the redirect domain matches the request domain. However, setting the redirect domain to ${host} is not supported when creating or modifying rules.
        """
    ...
    def redirect_domain(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "redirect_domain", value)

    @_builtins.property
    @pulumi.getter(name="redirectHttpCode")
    def redirect_http_code(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Redirect status codes: 301, 302, 307, 308.
        """
    ...
    def redirect_http_code(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "redirect_http_code", value)

    @_builtins.property
    @pulumi.getter(name="redirectPort")
    def redirect_port(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Redirect port. If the redirect port is left empty when creating or modifying a redirect forwarding rule, the API returns ${port}, which means the redirect port matches the request port (listener port). However, setting the redirect port to ${port} is not supported when creating or modifying rules.
        """
    ...
    def redirect_port(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class RuleRewriteConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] rewrite_path: Rewrite path.
        """
...
class RuleRuleActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Forwarding rule action types. ForwardGroup: forward to multiple virtual server groups. Redirect: redirect. Rewrite: rewrite. TrafficLimit: traffic limiting.
        """
...
class RuleRuleActionFixedResponseConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] content: Fixed response content.
        :param pulumi.Input[_builtins.str] content_type: Format of fixed response content. text/plain, text/css, text/html, application/javascript, application/json
        :param pulumi.Input[_builtins.str] http_code: Returned HTTP status code.
        """
...
class RuleRuleActionForwardGroupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RuleRuleActionForwardGroupConfigServerGroupTupleArgs']]] server_group_tuples: ServerGroupTuples
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class RuleRuleActionForwardGroupConfigServerGroupStickySessionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] enabled: Whether to enable inter-group session persistence. on: enabled. off: disabled.
        :param pulumi.Input[_builtins.int] timeout: Component session stickiness timeout. Unit: seconds.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class RuleRuleActionRedirectConfigArgs:
    def __init__(__self__, *,
                 ...
                 protocol: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] host: Redirect domain. Only exact domains are supported.
        :param pulumi.Input[_builtins.str] http_code: Redirect status codes supported: 301, 302, 307, 308.
        :param pulumi.Input[_builtins.str] path: Redirect URI..
        :param pulumi.Input[_builtins.str] port: Redirect port.
        :param pulumi.Input[_builtins.str] protocol: Protocol used for redirect. Supports HTTP and HTTPS.
        """
        if host is not None:
...
class RuleRuleActionRewriteConfigArgs:
    def __init__(__self__, *,
                 path: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] path: Rewrite path.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
...
class RuleRuleActionTrafficLimitConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] qps: Requests per second.
        """
        if qps is not None:
...
class RuleRuleConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Standard forwarding rule condition types. Host: domain name. Path: path. Header: HTTP header field. Method: request method. QueryString: query parameter.
        """
...
class RuleRuleConditionHeaderConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: Header field key.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: Header field value.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class RuleRuleConditionHostConfigArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: Domain name of the forwarding rule. Supports wildcard and exact domains.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionMethodConfigArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: Request method. Supports HEAD, GET, POST, OPTIONS, PUT, PATCH, DELETE.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionPathConfigArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: Forwarding rule URL. Only absolute paths are supported.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionQueryStringConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['RuleRuleConditionQueryStringConfigValueArgs']]] values: Values。
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionQueryStringConfigValueArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] key: Query string key.
        :param pulumi.Input[_builtins.str] value: Query string value.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ServerGroupHealthCheckArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] domain: Domain name for health check. Configure this as the actual service address provided by the backend server. This parameter takes effect only when HealthCheck.Protocol is set to HTTP. The domain name must contain at least one '.', and cannot start or end with '.'. Each level of the domain name can contain letters, digits, '-', and '.' characters, and '-' cannot appear at the beginning or end of any level. Length: 1–128 characters. If this parameter is not specified or no value is provided, the default is empty, meaning the load balancer uses the private IP address of each backend server for health checks.
        :param pulumi.Input[_builtins.str] enabled: Whether the listener enables health check. Values: on: enabled (default), off: disabled.
        :param pulumi.Input[_builtins.int] healthy_threshold: Health check threshold. Indicates the number of consecutive successful health checks required for a backend server to be considered healthy. Unit: times. Value range: 2–10. Default: 3.
        :param pulumi.Input[_builtins.str] http_code: HTTP status codes for a successful health check. Separate multiple codes with commas. This parameter is available only when HealthCheck.Protocol is HTTP. Valid values: http*2xx (default), http*3xx (default), http*4xx, http*5xx.
        :param pulumi.Input[_builtins.str] http_version: Health check HTTP protocol version. This parameter is available only when HealthCheck.Protocol is set to HTTP. Values: HTTP1.0 (default for API usage), HTTP1.1.
        :param pulumi.Input[_builtins.int] interval: After health checks are enabled, the interval for performing health checks. Unit: seconds. Value range: 1–300s. Default: 2.
        :param pulumi.Input[_builtins.str] method: Health check method after health checks are enabled. This parameter is valid only when HealthCheck.Protocol is set to HTTP. Values: GET: The server must support the GET method. HEAD (default): The server returns only the HEAD header, which reduces backend resource consumption, but the server must support the HEAD method.
        :param pulumi.Input[_builtins.int] port: Health check port. Supported values: 0 (default): Use the backend server port for health checks. 1–65535: Use the specified port for health checks.
        :param pulumi.Input[_builtins.str] protocol: Health check protocol. Currently supports HTTP and TCP. Default: HTTP.
        :param pulumi.Input[_builtins.int] timeout: Health check response timeout. If the backend server does not respond correctly within the specified time, the health check is considered abnormal. Unit: seconds. Value range: 1–60. Default: 2.
        :param pulumi.Input[_builtins.int] unhealthy_threshold: Unhealthy threshold for health checks. Indicates that a backend server is considered unhealthy if it fails the specified number of consecutive health checks. Unit: times. Range: 2–10. Default: 3.
        :param pulumi.Input[_builtins.str] uri: Health check path. Must be configured as the actual path provided by the backend server. This parameter is only effective when HealthCheck.Protocol is set to HTTP. Must start with '/'. Only letters, numbers, '-', '_', '/', '.', '%', '?', '#', '&', '=' are allowed. Length: 1–128 characters. If this parameter is not specified or specified without a value, the default is '/'.
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
        if enabled is not None:
...
class ServerGroupServerArgsDict(TypedDict):
    ...
    """
    remote_enabled: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ServerGroupServerArgs:
    def __init__(__self__, *,
                 ...
                 port: pulumi.Input[Optional[_builtins.int]] = None,
                 remote_enabled: pulumi.Input[Optional[_builtins.str]] = None,
                 server_id: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 weight: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.str] description: Description of the backend server.
        :param pulumi.Input[_builtins.str] instance_id: ID of the cloud server instance or network interface card.
        :param pulumi.Input[_builtins.str] ip: Private IP address of the backend server.
        :param pulumi.Input[_builtins.int] port: Port number on which the backend server receives requests.
        :param pulumi.Input[_builtins.str] remote_enabled: Enable remote IP feature. This field is valid only when the backend server instance type is IP address, that is, when Type is set to ip. Parameter values: on: Enable. off (default): Disable.
        :param pulumi.Input[_builtins.str] server_id: Backend server ID.
        :param pulumi.Input[_builtins.str] type: Backend server instance type. ecs: ECS instance. eni: auxiliary ENI. ip: IP address (valid only for IP-type server groups).
        :param pulumi.Input[_builtins.int] weight: Weight of the backend server.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def remote_enabled(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Enable remote IP feature. This field is valid only when the backend server instance type is IP address, that is, when Type is set to ip. Parameter values: on: Enable. off (default): Disable.
        """
    ...
    def remote_enabled(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ServerGroupStickySessionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] cookie: Name of the session persistence Cookie for service configuration. This is only valid when session persistence is enabled and Cookie overwrite is selected. The specific rules are as follows: The Cookie name must be 1–200 characters long. The name can only contain ASCII letters and digits, cannot contain commas (,), semicolons (;), or spaces, and cannot start with a dollar sign ($). This parameter is required when tickySessionConfig.StickySessionEnabled is set to on and StickySessionConfig.StickySessionType is server. This parameter is invalid when StickySessionConfig.StickySessionEnabled is on and StickySessionConfig.StickySessionType is insert.
        :param pulumi.Input[_builtins.int] cookie_timeout: Session persistence cookie timeout. Only valid when session persistence is enabled and the insert cookie option is selected. Unit: seconds. Rules: Timeout range: 1–86400. Default: 1000. This parameter is required when StickySessionConfig.StickySessionEnabled is on and StickySessionConfig.StickySessionType is insert. This parameter is invalid when StickySessionConfig.StickySessionEnabled is on and StickySessionType is server.
        :param pulumi.Input[_builtins.str] sticky_session_enabled: Enable session persistence. on: Enable; off (default): Disable.
...
class ServerGroupTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] key: Tag key. Tag keys for the same resource must be unique.
        :param pulumi.Input[_builtins.str] value: Tag value of the tag.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
