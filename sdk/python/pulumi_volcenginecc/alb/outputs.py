...
class AclListener(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str acl_type: Control mode of the listener for this access control policy group. white: Allowlist mode; black: Denylist mode
...
class AclTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: User tag key. Length limit: 1–128 characters. Case sensitive. Cannot start with any combination of volc: or sys: (case insensitive). Cannot start or end with a space. Supports characters from all languages, numbers, spaces (), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @. Tag keys for the same resource must be unique
        :param _builtins.str value: User tag value. Length limit: 0–256 characters. Case sensitive. Cannot start or end with a space. Supports characters from all languages, numbers, spaces (), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @
        """
        if key is not None:
...
class HealthCheckTemplateTag(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str value: Tag value for the user tag. If you specify this parameter, you must first specify Tags.N.Key. Rules: Length must be between 0 and 256 characters. Case-sensitive. Cannot start or end with a space. Supports characters from all languages, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), minus signs (-), and @.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ListenerDomainExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pca_leaf_certificate_id: Optional[_builtins.str] = None,
                 san: Optional[_builtins.str] = None):
        """
        :param _builtins.str cert_center_certificate_id: Server certificate ID used by the domain. Effective when the certificate source is cert_center.
        :param _builtins.str certificate_id: Server certificate ID used by the domain. Effective when the certificate source is alb.
        :param _builtins.str certificate_source: Source of the server certificate used by the domain. Values: alb: certificate uploaded via ALB. cert_center: SSL certificate purchased or uploaded through Volcano Engine Certificate Center.
        ...
        :param _builtins.str pca_leaf_certificate_id: Private leaf certificate ID associated with the HTTPS listener. Required when creating an HTTPS listener and the certificate source is pca_leaf.
        :param _builtins.str san: If the instance supports automatic selection of extended certificates (SniAutoMatch is on), Domain is an empty string. San refers to the extended domain names of the certificate, separated by commas.
        """
    ...
    def pca_leaf_certificate_id(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def san(self) -> Optional[_builtins.str]:
        """
...
class ListenerServerGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str server_group_id: Server group ID.
        :param _builtins.str server_group_name: Server group name.
        """
...
class ListenerTag(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str value: The value of the user tag. Rules: Length must be between 0 and 256 characters. Case sensitive. Cannot start or end with a space. May include characters from any language, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class LoadBalancerEipBillingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 security_protection_types: Optional[_builtins.str] = None):
        """
        :param _builtins.int bandwidth: Peak bandwidth of EIP, in Mbps.
        :param _builtins.int billing_type: EIP billing method: 2 for bandwidth-based, 3 for traffic-based.
        :param _builtins.str isp: Line type of the public IP, BGP indicates multi-line.
        :param _builtins.int security_protection_instance_id: When creating an ALB public instance, if IP protection resources are used, you must specify a DDoS native protection instance ID.
        :param _builtins.str security_protection_types: When creating a public ALB instance, ALB allows you to purchase multiple public IP protection resources. The rules for public IP protection resources are as follows: separate multiple protection resources with a comma (,). The values for protection resources are: AntiDDoS_Enhanced: You are requesting an enhanced protection type public IP, which can be added to a native DDoS protection instance. If not specified: You are requesting a basic protection type public IP.
        """
    ...
    def security_protection_types(self) -> Optional[_builtins.str]:
        """
...
class LoadBalancerGlobalAccelerator(dict):
    ...
    def __init__(__self__, *,
                 accelerator_id: Optional[_builtins.str] = None,
                 accelerator_listener_id: Optional[_builtins.str] = None,
                 endpoint_group_id: Optional[_builtins.str] = None,
                 weight: Optional[_builtins.int] = None):
        """
        :param _builtins.str accelerator_id: ID of the bound Global Accelerator instance.
        :param _builtins.str accelerator_listener_id: ID of the bound Global Accelerator listener.
        :param _builtins.str endpoint_group_id: ID of the bound endpoint group.
        :param _builtins.int weight: Weight of the backend server, determines traffic distribution ratio.
        """
    ...
    def accelerator_listener_id(self) -> Optional[_builtins.str]:
        """
...
class LoadBalancerHealthLog(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether to enable access log
        :param _builtins.str project_id: TLS project ID bound to access log
        :param _builtins.str topic_id: TLS subject ID bound to access log
        """
...
class LoadBalancerIpv6EipBillingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 isp: Optional[_builtins.str] = None):
        """
        :param _builtins.int bandwidth: Peak bandwidth of IPv6 EIP, in Mbps.
        :param _builtins.int billing_type: Billing method for IPv6 EIP: 2 for bandwidth-based, 3 for traffic-based.
        :param _builtins.str isp: Line type of IPv6 public IP; BGP indicates multi-line.
        """
        if bandwidth is not None:
            pulumi.set(__self__, "bandwidth", bandwidth)
        if billing_type is not None:
...
class LoadBalancerTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Tag key, used to identify the tag category.
        :param _builtins.str value: Tag value used to identify the specific tag content.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class LoadBalancerZoneMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str subnet_id: Subnet ID providing services within the availability zone.
        :param _builtins.str zone_id: Unique identifier of the availability zone.
        """
...
class RuleForwardGroupConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sticky_session_enabled: Optional[_builtins.str] = None,
                 sticky_session_timeout: Optional[_builtins.int] = None):
        """
        :param Sequence['RuleForwardGroupConfigServerGroupTupleArgs'] server_group_tuples: Destination server group list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param _builtins.str sticky_session_enabled: Whether to enable inter-group session persistence. on: enabled. off: disabled.
        :param _builtins.int sticky_session_timeout: Component session stickiness timeout. Unit: seconds.
        """
    ...
    def sticky_session_enabled(self) -> Optional[_builtins.str]:
        """
    ...
    def sticky_session_timeout(self) -> Optional[_builtins.int]:
        """
...
class RuleForwardGroupConfigServerGroupTuple(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: Optional[_builtins.int] = None):
        """
        :param _builtins.str server_group_id: Destination server group ID.
        :param _builtins.int weight: Server group weight.
        """
        if server_group_id is not None:
            pulumi.set(__self__, "server_group_id", server_group_id)
        if weight is not None:
...
class RuleRedirectConfig(dict):
    ...
    def redirect_domain(self) -> Optional[_builtins.str]:
        """
    ...
    def redirect_http_code(self) -> Optional[_builtins.str]:
        """
    ...
    def redirect_port(self) -> Optional[_builtins.str]:
        """
...
class RuleRewriteConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str rewrite_path: Rewrite path.
        """
...
class RuleRuleAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: Forwarding rule action types. ForwardGroup: forward to multiple virtual server groups. Redirect: redirect. Rewrite: rewrite. TrafficLimit: traffic limiting.
        """
...
class RuleRuleActionFixedResponseConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str content: Fixed response content.
        :param _builtins.str content_type: Format of fixed response content. text/plain, text/css, text/html, application/javascript, application/json
        :param _builtins.str http_code: Returned HTTP status code.
        """
...
class RuleRuleActionForwardGroupConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['RuleRuleActionForwardGroupConfigServerGroupTupleArgs'] server_group_tuples: ServerGroupTuples
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
...
class RuleRuleActionForwardGroupConfigServerGroupStickySession(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str enabled: Whether to enable inter-group session persistence. on: enabled. off: disabled.
        :param _builtins.int timeout: Component session stickiness timeout. Unit: seconds.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class RuleRuleActionRedirectConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 protocol: Optional[_builtins.str] = None):
        """
        :param _builtins.str host: Redirect domain. Only exact domains are supported.
        :param _builtins.str http_code: Redirect status codes supported: 301, 302, 307, 308.
        :param _builtins.str path: Redirect URI..
        :param _builtins.str port: Redirect port.
        :param _builtins.str protocol: Protocol used for redirect. Supports HTTP and HTTPS.
        """
        if host is not None:
...
class RuleRuleActionRewriteConfig(dict):
    def __init__(__self__, *,
                 path: Optional[_builtins.str] = None):
        """
        :param _builtins.str path: Rewrite path.
        """
        if path is not None:
            pulumi.set(__self__, "path", path)
...
class RuleRuleActionTrafficLimitConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int qps: Requests per second.
        """
        if qps is not None:
...
class RuleRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: Standard forwarding rule condition types. Host: domain name. Path: path. Header: HTTP header field. Method: request method. QueryString: query parameter.
        """
...
class RuleRuleConditionHeaderConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: Header field key.
        :param Sequence[_builtins.str] values: Header field value.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class RuleRuleConditionHostConfig(dict):
    def __init__(__self__, *,
                 values: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] values: Domain name of the forwarding rule. Supports wildcard and exact domains.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionMethodConfig(dict):
    def __init__(__self__, *,
                 values: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] values: Request method. Supports HEAD, GET, POST, OPTIONS, PUT, PATCH, DELETE.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionPathConfig(dict):
    def __init__(__self__, *,
                 values: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] values: Forwarding rule URL. Only absolute paths are supported.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionQueryStringConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence['RuleRuleConditionQueryStringConfigValueArgs'] values: Values。
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        if values is not None:
            pulumi.set(__self__, "values", values)
...
class RuleRuleConditionQueryStringConfigValue(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Query string key.
        :param _builtins.str value: Query string value.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ServerGroupHealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str enabled: Whether the listener enables health check. Values: on: enabled (default), off: disabled.
        :param _builtins.int healthy_threshold: Health check threshold. Indicates the number of consecutive successful health checks required for a backend server to be considered healthy. Unit: times. Value range: 2–10. Default: 3.
        :param _builtins.str http_code: HTTP status codes for a successful health check. Separate multiple codes with commas. This parameter is available only when HealthCheck.Protocol is HTTP. Valid values: http*2xx (default), http*3xx (default), http*4xx, http*5xx.
        :param _builtins.str http_version: Health check HTTP protocol version. This parameter is available only when HealthCheck.Protocol is set to HTTP. Values: HTTP1.0 (default for API usage), HTTP1.1.
        :param _builtins.int interval: After health checks are enabled, the interval for performing health checks. Unit: seconds. Value range: 1–300s. Default: 2.
        :param _builtins.str method: Health check method after health checks are enabled. This parameter is valid only when HealthCheck.Protocol is set to HTTP. Values: GET: The server must support the GET method. HEAD (default): The server returns only the HEAD header, which reduces backend resource consumption, but the server must support the HEAD method.
        :param _builtins.int port: Health check port. Supported values: 0 (default): Use the backend server port for health checks. 1–65535: Use the specified port for health checks.
        :param _builtins.str protocol: Health check protocol. Currently supports HTTP and TCP. Default: HTTP.
        :param _builtins.int timeout: Health check response timeout. If the backend server does not respond correctly within the specified time, the health check is considered abnormal. Unit: seconds. Value range: 1–60. Default: 2.
        :param _builtins.int unhealthy_threshold: Unhealthy threshold for health checks. Indicates that a backend server is considered unhealthy if it fails the specified number of consecutive health checks. Unit: times. Range: 2–10. Default: 3.
        :param _builtins.str uri: Health check path. Must be configured as the actual path provided by the backend server. This parameter is only effective when HealthCheck.Protocol is set to HTTP. Must start with '/'. Only letters, numbers, '-', '_', '/', '.', '%', '?', '#', '&', '=' are allowed. Length: 1–128 characters. If this parameter is not specified or specified without a value, the default is '/'.
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
        if enabled is not None:
...
class ServerGroupServer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port: Optional[_builtins.int] = None,
                 remote_enabled: Optional[_builtins.str] = None,
                 server_id: Optional[_builtins.str] = None,
                 type: Optional[_builtins.str] = None,
                 weight: Optional[_builtins.int] = None):
        """
        :param _builtins.str description: Description of the backend server.
        :param _builtins.str instance_id: ID of the cloud server instance or network interface card.
        :param _builtins.str ip: Private IP address of the backend server.
        :param _builtins.int port: Port number on which the backend server receives requests.
        :param _builtins.str remote_enabled: Enable remote IP feature. This field is valid only when the backend server instance type is IP address, that is, when Type is set to ip. Parameter values: on: Enable. off (default): Disable.
        :param _builtins.str server_id: Backend server ID.
        :param _builtins.str type: Backend server instance type. ecs: ECS instance. eni: auxiliary ENI. ip: IP address (valid only for IP-type server groups).
        :param _builtins.int weight: Weight of the backend server.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def remote_enabled(self) -> Optional[_builtins.str]:
        """
...
class ServerGroupTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Tag key. Tag keys for the same resource must be unique.
        :param _builtins.str value: Tag value of the tag.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class GetListenerDomainExtensionResult(dict):
    def __init__(__self__, *,
                 ...
                 listener_id: _builtins.str,
                 pca_leaf_certificate_id: _builtins.str,
                 san: _builtins.str):
        """
        :param _builtins.str cert_center_certificate_id: Server certificate ID used by the domain. Effective when the certificate source is cert_center.
        :param _builtins.str certificate_id: Server certificate ID used by the domain. Effective when the certificate source is alb.
        ...
        :param _builtins.str listener_id: Listener ID to which the extended domain name belongs.
        :param _builtins.str pca_leaf_certificate_id: Private leaf certificate ID associated with the HTTPS listener. Required when creating an HTTPS listener and the certificate source is pca_leaf.
        :param _builtins.str san: If the instance supports automatic selection of extended certificates (SniAutoMatch is on), Domain is an empty string. San refers to the extended domain names of the certificate, separated by commas.
        """
        pulumi.set(__self__, "cert_center_certificate_id", cert_center_certificate_id)
    ...
    @_builtins.property
    @pulumi.getter(name="pcaLeafCertificateId")
    def pca_leaf_certificate_id(self) -> _builtins.str:
        """
        Private leaf certificate ID associated with the HTTPS listener. Required when creating an HTTPS listener and the certificate source is pca_leaf.
        """
        return pulumi.get(self, "pca_leaf_certificate_id")
...
class GetLoadBalancerEipBillingConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 security_protection_types: _builtins.str):
        """
        :param _builtins.int bandwidth: Peak bandwidth of EIP, in Mbps.
        :param _builtins.int billing_type: EIP billing method: 2 for bandwidth-based, 3 for traffic-based.
        :param _builtins.str isp: Line type of the public IP, BGP indicates multi-line.
    ...
    @_builtins.property
    @pulumi.getter(name="securityProtectionTypes")
    def security_protection_types(self) -> _builtins.str:
        """
        When creating a public ALB instance, ALB allows you to purchase multiple public IP protection resources. The rules for public IP protection resources are as follows: separate multiple protection resources with a comma (,). The values for protection resources are: AntiDDoS_Enhanced: You are requesting an enhanced protection type public IP, which can be added to a native DDoS protection instance. If not specified: You are requesting a basic protection type public IP.
        """
        return pulumi.get(self, "security_protection_types")
...
class GetLoadBalancerGlobalAcceleratorResult(dict):
    def __init__(__self__, *,
                 ...
                 accelerator_listener_id: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="acceleratorListenerId")
    def accelerator_listener_id(self) -> _builtins.str:
        """
        ID of the bound Global Accelerator listener.
        """
        return pulumi.get(self, "accelerator_listener_id")
...
class GetLoadBalancerZoneMappingLoadBalancerAddressResult(dict):
    def __init__(__self__, *,
                 ...
                 eni_ipv6_address: _builtins.str,
        ...
        :param _builtins.str eip_address: Address of the bound Elastic Public IP (EIP).
        :param _builtins.str eip_id: ID of the bound Elastic IP (EIP).
        :param _builtins.str eni_address: Private IP address on the Elastic Network Interface (ENI).
        :param _builtins.str eni_id: ID of the Elastic Network Interface (ENI) to which the IP address belongs.
        :param _builtins.str eni_ipv6_address: IPv6 private address on the Elastic Network Interface (ENI).
        ...
        :param _builtins.str ipv6_eip_id: ID of the bound IPv6 EIP.
        """
    ...
    def eni_ipv6_address(self) -> _builtins.str:
        """
...
class GetLoadBalancerZoneMappingLoadBalancerAddressEipResult(dict):
    def __init__(__self__, *,
                 association_mode: _builtins.str,
                 bandwidth: _builtins.int,
                 eip_address: _builtins.str,
                 eip_billing_type: _builtins.int,
                 eip_type: _builtins.str,
                 isp: _builtins.str,
                 pop_locations: Sequence['outputs.GetLoadBalancerZoneMappingLoadBalancerAddressEipPopLocationResult']):
        """
        :param _builtins.str association_mode: EIP binding mode, such as Default or Normal.
        :param _builtins.int bandwidth: Peak bandwidth of EIP, in Mbps.
        :param _builtins.str eip_address: Address of the Elastic IP (EIP).
        :param _builtins.int eip_billing_type: EIP billing method: 2 for bandwidth-based, 3 for traffic-based.
        :param _builtins.str eip_type: EIP type, such as static BGP.
        :param _builtins.str isp: Line type of the public IP, BGP indicates multi-line.
    ...
    def association_mode(self) -> _builtins.str:
        """
    ...
    def eip_billing_type(self) -> _builtins.int:
        """
        EIP billing method: 2 for bandwidth-based, 3 for traffic-based.
        """
...
class GetLoadBalancerZoneMappingLoadBalancerAddressEipPopLocationResult(dict):
    def __init__(__self__, *,
                 pop_id: _builtins.str,
                 pop_name: _builtins.str):
        """
        :param _builtins.str pop_id: Unique ID of the access point (PoP).
        :param _builtins.str pop_name: Name of the access point (PoP).
        """
    ...
    def pop_name(self) -> _builtins.str:
        """
...
class GetRuleForwardGroupConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 sticky_session_enabled: _builtins.str,
                 sticky_session_timeout: _builtins.int):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="stickySessionEnabled")
    def sticky_session_enabled(self) -> _builtins.str:
        """
        Whether to enable inter-group session persistence. on: enabled. off: disabled.
        """
        return pulumi.get(self, "sticky_session_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="stickySessionTimeout")
    def sticky_session_timeout(self) -> _builtins.int:
        """
        Component session stickiness timeout. Unit: seconds.
        """
        return pulumi.get(self, "sticky_session_timeout")
...
class GetRuleRedirectConfigResult(dict):
    def __init__(__self__, *,
                 redirect_domain: _builtins.str,
                 redirect_http_code: _builtins.str,
                 redirect_port: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="redirectDomain")
    def redirect_domain(self) -> _builtins.str:
        """
        Redirect domain name. If the redirect domain name is left empty when creating or modifying a redirect forwarding rule, the API returns ${host}, which means the redirect domain matches the request domain. However, setting the redirect domain to ${host} is not supported when creating or modifying rules.
        """
        return pulumi.get(self, "redirect_domain")
    ...
    @_builtins.property
    @pulumi.getter(name="redirectHttpCode")
    def redirect_http_code(self) -> _builtins.str:
        """
        Redirect status codes: 301, 302, 307, 308.
        """
        return pulumi.get(self, "redirect_http_code")
    ...
    @_builtins.property
    @pulumi.getter(name="redirectPort")
    def redirect_port(self) -> _builtins.str:
        """
        Redirect port. If the redirect port is left empty when creating or modifying a redirect forwarding rule, the API returns ${port}, which means the redirect port matches the request port (listener port). However, setting the redirect port to ${port} is not supported when creating or modifying rules.
        """
        return pulumi.get(self, "redirect_port")
...
class GetRuleRewriteConfigResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="rewritePath")
    def rewrite_path(self) -> _builtins.str:
        """
        Rewrite path.
        """
        return pulumi.get(self, "rewrite_path")
...
class GetServerGroupServerResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="remoteEnabled")
    def remote_enabled(self) -> _builtins.str:
        """
        Enable remote IP feature. This field is valid only when the backend server instance type is IP address, that is, when Type is set to ip. Parameter values: on: Enable. off (default): Disable.
        """
        return pulumi.get(self, "remote_enabled")
