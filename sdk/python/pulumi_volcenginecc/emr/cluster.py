...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 application_extras: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterApplicationExtraArgs']]]] = None,
                 application_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 bootstrap_scripts: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterBootstrapScriptArgs']]]] = None,
                 charge_pre_config: pulumi.Input[Optional['ClusterChargePreConfigArgs']] = None,
                 deploy_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 history_server_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 node_group_attributes: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] charge_type: Payment type. PRE means monthly subscription, POST means pay-as-you-go.
        ...
        :param pulumi.Input[_builtins.str] release_version: Cluster version.
        :param pulumi.Input[_builtins.str] security_group_id: Cluster global security group ID. All ECS in node groups will join this security group.
        :param pulumi.Input[_builtins.str] vpc_id: Vpc ID。
        :param pulumi.Input[Sequence[pulumi.Input['ClusterApplicationExtraArgs']]] application_extras: Cluster service extension information list, including custom configuration items for services, custom deployment topology settings for service components, and metadata connection configuration information for services.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] application_names: List of service names installed in the cluster. Creation-related field.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterBootstrapScriptArgs']]] bootstrap_scripts: Cluster bootstrap script list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        ...
        :param pulumi.Input[_builtins.str] deploy_mode: Deployment mode. SIMPLE means simple mode, HIGH_AVAILABLE means high availability mode.
        :param pulumi.Input[_builtins.str] history_server_mode: HistoryServer mode: LOCAL stores active data within the cluster, PHS stores active data outside the cluster.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]] node_group_attributes: Node group property list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] project_name: Project to which the resource belongs. Default is 'default'. Each resource can belong to only one project. Only letters, numbers, underscores '_', dots '.', and hyphens '-' are allowed. Maximum length is 64 characters.
        :param pulumi.Input[_builtins.str] security_mode: Security mode.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterTagArgs']]] tags: Tag list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    def application_extras(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ClusterApplicationExtraArgs']]]]:
        """
    ...
    def application_extras(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterApplicationExtraArgs']]]]):
        pulumi.set(self, "application_extras", value)

    @_builtins.property
    @pulumi.getter(name="applicationNames")
    def application_names(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def application_names(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def charge_pre_config(self) -> pulumi.Input[Optional['ClusterChargePreConfigArgs']]:
        """
    ...
    def charge_pre_config(self, value: pulumi.Input[Optional['ClusterChargePreConfigArgs']]):
    ...
    def history_server_mode(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def history_server_mode(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "history_server_mode", value)

    @_builtins.property
    @pulumi.getter(name="nodeGroupAttributes")
    def node_group_attributes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]]]:
        """
    ...
    def node_group_attributes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 cluster_domain_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 ...
                 creator_id: pulumi.Input[Optional[_builtins.int]] = None,
                 creator_name: pulumi.Input[Optional[_builtins.str]] = None,
                 deploy_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 ecs_image_id: pulumi.Input[Optional[_builtins.str]] = None,
                 expire_time: pulumi.Input[Optional[_builtins.int]] = None,
                 history_server_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 node_attribute: pulumi.Input[Optional['ClusterNodeAttributeArgs']] = None,
                 node_group_attributes: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 security_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 state_change_reason: pulumi.Input[Optional['ClusterStateChangeReasonArgs']] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['ClusterTagArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterApplicationExtraArgs']]] application_extras: Cluster service extension information list, including custom configuration items for services, custom deployment topology settings for service components, and metadata connection configuration information for services.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] application_names: List of service names installed in the cluster. Creation-related field.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterApplicationArgs']]] applications: Installed service list for cluster. Read-only field.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterBootstrapScriptArgs']]] bootstrap_scripts: Cluster bootstrap script list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input['ClusterChargePreConfigArgs'] charge_pre_config: Monthly subscription configuration parameters. Required when chargeType=PRE.
        :param pulumi.Input[_builtins.str] charge_type: Payment type. PRE means monthly subscription, POST means pay-as-you-go.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cluster_domain_names: Cluster DNS domain suffix list.
        :param pulumi.Input[_builtins.str] cluster_id: Cluster ID.
        :param pulumi.Input[_builtins.str] cluster_name: Cluster name.
        :param pulumi.Input[_builtins.str] cluster_state: Cluster status.
        :param pulumi.Input[_builtins.str] cluster_type: Cluster type.
        :param pulumi.Input[_builtins.int] created_time: Cluster creation time.
        :param pulumi.Input[_builtins.int] creator_id: Creator ID.
        :param pulumi.Input[_builtins.str] creator_name: Creator name.
        :param pulumi.Input[_builtins.str] deploy_mode: Deployment mode. SIMPLE means simple mode, HIGH_AVAILABLE means high availability mode.
        :param pulumi.Input[_builtins.str] ecs_image_id: ECS image ID.
        :param pulumi.Input[_builtins.int] expire_time: Cluster expiration time.
        :param pulumi.Input[_builtins.str] history_server_mode: HistoryServer mode: LOCAL stores active data within the cluster, PHS stores active data outside the cluster.
        :param pulumi.Input['ClusterNodeAttributeArgs'] node_attribute: Cluster global node information.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterNodeGroupAttributeArgs']]] node_group_attributes: Node group property list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] project_name: Project to which the resource belongs. Default is 'default'. Each resource can belong to only one project. Only letters, numbers, underscores '_', dots '.', and hyphens '-' are allowed. Maximum length is 64 characters.
        :param pulumi.Input[_builtins.int] ready_time: Cluster creation completion time.
        :param pulumi.Input[_builtins.str] release_version: Cluster version.
        :param pulumi.Input[_builtins.str] security_group_id: Cluster global security group ID. All ECS in node groups will join this security group.
        :param pulumi.Input[_builtins.str] security_mode: Security mode.
    ...
    def cluster_domain_names(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def cluster_domain_names(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def cluster_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Cluster status.
        """
    ...
    def cluster_state(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def creator_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Creator ID.
        """
    ...
    @creator_id.setter
    def creator_id(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def ecs_image_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ECS image ID.
        """
    ...
    @ecs_image_id.setter
    def ecs_image_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter(name="nodeAttribute")
    def node_attribute(self) -> pulumi.Input[Optional['ClusterNodeAttributeArgs']]:
        """
        Cluster global node information.
        """
        return pulumi.get(self, "node_attribute")
    ...
    @node_attribute.setter
    def node_attribute(self, value: pulumi.Input[Optional['ClusterNodeAttributeArgs']]):
        pulumi.set(self, "node_attribute", value)
    ...
    def state_change_reason(self) -> pulumi.Input[Optional['ClusterStateChangeReasonArgs']]:
        """
    ...
    def state_change_reason(self, value: pulumi.Input[Optional['ClusterStateChangeReasonArgs']]):
...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 application_extras: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterApplicationExtraArgs', 'ClusterApplicationExtraArgsDict']]]]] = None,
                 application_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 ...
                 charge_pre_config: pulumi.Input[Optional[Union['ClusterChargePreConfigArgs', 'ClusterChargePreConfigArgsDict']]] = None,
                 charge_type: pulumi.Input[Optional[_builtins.str]] = None,
                 cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                 cluster_type: pulumi.Input[Optional[_builtins.str]] = None,
                 deploy_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 history_server_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 node_attribute: pulumi.Input[Optional[Union['ClusterNodeAttributeArgs', 'ClusterNodeAttributeArgsDict']]] = None,
                 node_group_attributes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterNodeGroupAttributeArgs', 'ClusterNodeGroupAttributeArgsDict']]]]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 release_version: pulumi.Input[Optional[_builtins.str]] = None,
                 security_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 security_mode: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        e_mr_cluster_demo = volcenginecc.emr.Cluster("EMRClusterDemo",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterApplicationExtraArgs', 'ClusterApplicationExtraArgsDict']]]] application_extras: Cluster service extension information list, including custom configuration items for services, custom deployment topology settings for service components, and metadata connection configuration information for services.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] application_names: List of service names installed in the cluster. Creation-related field.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterBootstrapScriptArgs', 'ClusterBootstrapScriptArgsDict']]]] bootstrap_scripts: Cluster bootstrap script list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterNodeGroupAttributeArgs', 'ClusterNodeGroupAttributeArgsDict']]]] node_group_attributes: Node group property list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] project_name: Project to which the resource belongs. Default is 'default'. Each resource can belong to only one project. Only letters, numbers, underscores '_', dots '.', and hyphens '-' are allowed. Maximum length is 64 characters.
        :param pulumi.Input[_builtins.str] release_version: Cluster version.
        :param pulumi.Input[_builtins.str] security_group_id: Cluster global security group ID. All ECS in node groups will join this security group.
        :param pulumi.Input[_builtins.str] security_mode: Security mode.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterTagArgs', 'ClusterTagArgsDict']]]] tags: Tag list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] vpc_id: Vpc ID。
        """
        ...
    ...
    def get(resource_name: str,
            ...
            security_group_id: pulumi.Input[Optional[_builtins.str]] = None,
            security_mode: pulumi.Input[Optional[_builtins.str]] = None,
            state_change_reason: pulumi.Input[Optional[Union['ClusterStateChangeReasonArgs', 'ClusterStateChangeReasonArgsDict']]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterTagArgs', 'ClusterTagArgsDict']]]]] = None,
            terminate_time: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterApplicationExtraArgs', 'ClusterApplicationExtraArgsDict']]]] application_extras: Cluster service extension information list, including custom configuration items for services, custom deployment topology settings for service components, and metadata connection configuration information for services.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] application_names: List of service names installed in the cluster. Creation-related field.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterApplicationArgs', 'ClusterApplicationArgsDict']]]] applications: Installed service list for cluster. Read-only field.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterBootstrapScriptArgs', 'ClusterBootstrapScriptArgsDict']]]] bootstrap_scripts: Cluster bootstrap script list.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[Union['ClusterChargePreConfigArgs', 'ClusterChargePreConfigArgsDict']] charge_pre_config: Monthly subscription configuration parameters. Required when chargeType=PRE.
    ...
    @_builtins.property
    @pulumi.getter(name="applicationNames")
    def application_names(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of service names installed in the cluster. Creation-related field.
        """
        return pulumi.get(self, "application_names")
    ...
    @_builtins.property
    @pulumi.getter(name="clusterDomainNames")
    def cluster_domain_names(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Cluster DNS domain suffix list.
        """
        return pulumi.get(self, "cluster_domain_names")
    ...
    @_builtins.property
    @pulumi.getter(name="creatorId")
    def creator_id(self) -> pulumi.Output[_builtins.int]:
        """
        Creator ID.
        """
        return pulumi.get(self, "creator_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ecsImageId")
    def ecs_image_id(self) -> pulumi.Output[_builtins.str]:
        """
        ECS image ID.
        """
        return pulumi.get(self, "ecs_image_id")
    ...
    @_builtins.property
    @pulumi.getter(name="historyServerMode")
    def history_server_mode(self) -> pulumi.Output[_builtins.str]:
        """
        HistoryServer mode: LOCAL stores active data within the cluster, PHS stores active data outside the cluster.
        """
        return pulumi.get(self, "history_server_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="readyTime")
    def ready_time(self) -> pulumi.Output[_builtins.int]:
        """
        Cluster creation completion time.
        """
        return pulumi.get(self, "ready_time")
    ...
    @_builtins.property
    @pulumi.getter(name="terminateTime")
    def terminate_time(self) -> pulumi.Output[_builtins.int]:
        """
        Cluster termination time.
        """
        return pulumi.get(self, "terminate_time")
