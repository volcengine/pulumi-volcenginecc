...
class VpcEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] private_dns_enabled: Enable private DNS name. false (default): disabled. true: enabled.
        :param pulumi.Input[_builtins.str] project_name: Name of the project to which the endpoint node belongs.
        ...
        :param pulumi.Input[_builtins.str] service_id: ID of the endpoint service to be associated. You can call the DescribeVpcEndpointServices API to obtain the endpoint service ID.
        :param pulumi.Input[_builtins.bool] service_managed: Whether the endpoint is managed. false: Unmanaged endpoint. true: Managed endpoint.
        :param pulumi.Input[_builtins.str] service_name: Name of the endpoint service to be associated.
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointTagArgs']]] tags: Endpoint user tag.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] vpc_id: ID of the VPC to which the endpoint belongs. You can call the DescribeVpcs API to obtain the VPC ID.
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointZoneArgs']]] zones: Availability zone of the endpoint node.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointTagArgs']]]]:
        """
        Endpoint user tag.
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointTagArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def zones(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointZoneArgs']]]]:
        """
    ...
    @zones.setter
    def zones(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointZoneArgs']]]]):
...
class _VpcEndpointState:
    def __init__(__self__, *,
                 ...
                 endpoint_index: pulumi.Input[Optional[_builtins.int]] = None,
                 endpoint_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] bps: Maximum bandwidth limit for the endpoint node connection, in Mbps.
        :param pulumi.Input[_builtins.str] business_status: Whether the endpoint is locked. Normal: Normal. FinancialLocked: Locked. If this parameter is empty, the endpoint is not locked.
        :param pulumi.Input[_builtins.str] connection_status: Status of the endpoint node connection. PendingAcceptance: waiting for connection. Connecting: connecting. Connected: connected. Disconnecting: disconnecting. Rejected: connection rejected. Failed: connection failed. PartialFailed: partial connection failure. ServiceDeleted: service deleted.
        :param pulumi.Input[_builtins.str] creation_time: Creation time of the endpoint.
        :param pulumi.Input[_builtins.str] deleted_time: Deletion time of the endpoint.
        :param pulumi.Input[_builtins.str] description: Description of the endpoint node. The default value is an empty string. It must start with a letter, number, or Chinese character, and can include letters, numbers, Chinese characters, and the following special characters: comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length limit: 0–255 characters.
        :param pulumi.Input[_builtins.str] endpoint_domain: Domain name of the endpoint.
        :param pulumi.Input[_builtins.str] endpoint_id: ID of the endpoint node.
        :param pulumi.Input[_builtins.int] endpoint_index: Endpoint index
        :param pulumi.Input[_builtins.str] endpoint_name: Endpoint name. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: period (.), underscore (_), and hyphen (-). Length must be between 1 and 128 characters. If not specified, defaults to the endpoint ID.
        :param pulumi.Input[_builtins.str] endpoint_type: Type of the endpoint node. Interface: interface endpoint node.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_address_versions: IP protocol type for the interface endpoint. Options are ipv4 and ipv6. The default for interface endpoints is ipv4. If only ipv4 is used, do not provide this parameter. If the interface endpoint is dual stack (ipv4 & ipv6), you must provide this parameter. Before providing it, ensure the following: your account has enabled IPv6 for private network connections; the subnet associated with the interface endpoint has enabled the IPv6 segment; the endpoint service associated with the interface endpoint is dual stack. Parameter -N: indicates the sequence number of the IP protocol type for the interface endpoint, with a range of 1–2. Use & to separate the sequence numbers of the two IP protocol types. Currently, only providing IPv6 is not supported.
        ...
        :param pulumi.Input[_builtins.bool] private_dns_enabled: Enable private DNS name. false (default): disabled. true: enabled.
        :param pulumi.Input[_builtins.str] private_dns_name: The private DNS name of the endpoint node. If the parameter PrivateDNSEnabled returns false, this parameter is empty.
        :param pulumi.Input[_builtins.str] project_name: Name of the project to which the endpoint node belongs.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: ID of the security group to be bound to the endpoint. You can call the DescribeSecurityGroups API to obtain the security group ID. Parameter -N: Indicates the sequence number of the security group ID, value range: 1–5. Separate multiple security group IDs with &.
        :param pulumi.Input[_builtins.str] service_id: ID of the endpoint service to be associated. You can call the DescribeVpcEndpointServices API to obtain the endpoint service ID.
        :param pulumi.Input[_builtins.bool] service_managed: Whether the endpoint is managed. false: Unmanaged endpoint. true: Managed endpoint.
        :param pulumi.Input[_builtins.str] service_name: Name of the endpoint service to be associated.
        :param pulumi.Input[_builtins.str] status: Status of the endpoint. Creating: Creating. Pending: Modifying configuration. Available: Available. Deleting: Deleting.
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointTagArgs']]] tags: Endpoint user tag.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] update_time: Most recent operation time of the endpoint.
        :param pulumi.Input[_builtins.str] vpc_id: ID of the VPC to which the endpoint belongs. You can call the DescribeVpcs API to obtain the VPC ID.
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointZoneArgs']]] zones: Availability zone of the endpoint node.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    def endpoint_index(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Endpoint index
        """
    ...
    def endpoint_index(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class VpcEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_managed: pulumi.Input[Optional[_builtins.bool]] = None,
                 service_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcEndpointTagArgs', 'VpcEndpointTagArgsDict']]]]] = None,
                 vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
                 zones: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcEndpointZoneArgs', 'VpcEndpointZoneArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        private_link_vpc_endpoint_demo = volcenginecc.privatelink.VpcEndpoint("PrivateLinkVpcEndpointDemo",
        ...
        :param pulumi.Input[_builtins.bool] service_managed: Whether the endpoint is managed. false: Unmanaged endpoint. true: Managed endpoint.
        :param pulumi.Input[_builtins.str] service_name: Name of the endpoint service to be associated.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcEndpointTagArgs', 'VpcEndpointTagArgsDict']]]] tags: Endpoint user tag.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] vpc_id: ID of the VPC to which the endpoint belongs. You can call the DescribeVpcs API to obtain the VPC ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcEndpointZoneArgs', 'VpcEndpointZoneArgsDict']]]] zones: Availability zone of the endpoint node.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
            zones: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcEndpointZoneArgs', 'VpcEndpointZoneArgsDict']]]]] = None) -> 'VpcEndpoint':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="endpointIndex")
    def endpoint_index(self) -> pulumi.Output[_builtins.int]:
        """
        Endpoint index
        """
        return pulumi.get(self, "endpoint_index")
