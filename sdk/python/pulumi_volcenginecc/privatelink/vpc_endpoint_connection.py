...
class VpcEndpointConnectionArgs:
    def __init__(__self__, *,
                 ...
                 resources_allocates: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.int] bps: Maximum bandwidth for the endpoint connection, range 100–20000 Mbps
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]] resources_allocates: Specified service resource
    ...
    def resources_allocates(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]]]:
        """
    ...
    def resources_allocates(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]]]):
...
class _VpcEndpointConnectionState:
    def __init__(__self__, *,
                 ...
                 endpoint_owner_account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 endpoint_vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
                 replace_resource_id: pulumi.Input[Optional[_builtins.str]] = None,
                 replacing_resource: pulumi.Input[Optional[_builtins.str]] = None,
                 resources_allocates: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]]] = None,
                 service_id: pulumi.Input[Optional[_builtins.str]] = None,
                 update_time: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 zones: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionZoneArgs']]]] = None):
        """
        Input properties used for looking up and filtering VpcEndpointConnection resources.

        :param pulumi.Input[_builtins.int] bps: Maximum bandwidth for the endpoint connection, range 100–20000 Mbps
        :param pulumi.Input[_builtins.str] connection_status: Status of the endpoint connection. PendingAcceptance: waiting for connection. Connecting: connecting. Connected: connected. Disconnecting: disconnecting. Rejected: connection rejected. Failed: connection failed. PartialFailed: partial connection failure. ServiceDeleted: service deleted
        :param pulumi.Input[_builtins.str] creation_time: Creation time of the endpoint connection
        :param pulumi.Input[_builtins.str] endpoint_id: Endpoint ID
        :param pulumi.Input[_builtins.str] endpoint_owner_account_id: Account ID to which the endpoint belongs
        :param pulumi.Input[_builtins.str] endpoint_vpc_id: ID of the VPC to which the endpoint network interface belongs
        :param pulumi.Input[_builtins.str] replace_resource_id: New service resource ID
        :param pulumi.Input[_builtins.str] replacing_resource: Whether to operate the endpoint connection for seamless service resource replacement. true: yes, disconnect the old service resource for the seamless replacement endpoint connection. false: no, reject the specified endpoint connection. If this parameter is empty, the specified endpoint connection is rejected
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointConnectionResourcesAllocateArgs']]] resources_allocates: Specified service resource
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] service_id: Endpoint service ID
        :param pulumi.Input[_builtins.str] update_time: Most recent operation time of the endpoint connection
        :param pulumi.Input[_builtins.str] zone_id: Endpoint zone ID
        :param pulumi.Input[Sequence[pulumi.Input['VpcEndpointConnectionZoneArgs']]] zones: Details of the endpoint zone
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
        if bps is not None:
            pulumi.set(__self__, "bps", bps)
    ...
    def endpoint_owner_account_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def endpoint_owner_account_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "endpoint_owner_account_id", value)

    @_builtins.property
    @pulumi.getter(name="endpointVpcId")
    def endpoint_vpc_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def endpoint_vpc_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "endpoint_vpc_id", value)

    @_builtins.property
    @pulumi.getter(name="replaceResourceId")
    def replace_resource_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def replace_resource_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "replace_resource_id", value)

    @_builtins.property
    @pulumi.getter(name="replacingResource")
    def replacing_resource(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether to operate the endpoint connection for seamless service resource replacement. true: yes, disconnect the old service resource for the seamless replacement endpoint connection. false: no, reject the specified endpoint connection. If this parameter is empty, the specified endpoint connection is rejected
        """
    ...
    def replacing_resource(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def zones(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionZoneArgs']]]]:
        """
    ...
    @zones.setter
    def zones(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VpcEndpointConnectionZoneArgs']]]]):
...
class VpcEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bps: pulumi.Input[Optional[_builtins.int]] = None,
                 endpoint_id: pulumi.Input[Optional[_builtins.str]] = None,
                 resources_allocates: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcEndpointConnectionResourcesAllocateArgs', 'VpcEndpointConnectionResourcesAllocateArgsDict']]]]] = None,
                 service_id: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        private_link_vpc_endpoint_connection_demo = volcenginecc.privatelink.VpcEndpointConnection("PrivateLinkVpcEndpointConnectionDemo",
        ...
        :param pulumi.Input[_builtins.int] bps: Maximum bandwidth for the endpoint connection, range 100–20000 Mbps
        :param pulumi.Input[_builtins.str] endpoint_id: Endpoint ID
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcEndpointConnectionResourcesAllocateArgs', 'VpcEndpointConnectionResourcesAllocateArgsDict']]]] resources_allocates: Specified service resource
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] service_id: Endpoint service ID
        :param pulumi.Input[_builtins.str] zone_id: Endpoint zone ID
        """
    ...
    def get(resource_name: str,
            ...
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None,
            zones: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VpcEndpointConnectionZoneArgs', 'VpcEndpointConnectionZoneArgsDict']]]]] = None) -> 'VpcEndpointConnection':
        """
        ...
        :param pulumi.Input[_builtins.str] update_time: Most recent operation time of the endpoint connection
        :param pulumi.Input[_builtins.str] zone_id: Endpoint zone ID
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcEndpointConnectionZoneArgs', 'VpcEndpointConnectionZoneArgsDict']]]] zones: Details of the endpoint zone
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="endpointOwnerAccountId")
    def endpoint_owner_account_id(self) -> pulumi.Output[_builtins.str]:
        """
        Account ID to which the endpoint belongs
        """
        return pulumi.get(self, "endpoint_owner_account_id")
    ...
    @_builtins.property
    @pulumi.getter(name="endpointVpcId")
    def endpoint_vpc_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the VPC to which the endpoint network interface belongs
        """
        return pulumi.get(self, "endpoint_vpc_id")
    ...
    @_builtins.property
    @pulumi.getter(name="replaceResourceId")
    def replace_resource_id(self) -> pulumi.Output[_builtins.str]:
        """
        New service resource ID
        """
        return pulumi.get(self, "replace_resource_id")
    ...
    @_builtins.property
    @pulumi.getter(name="replacingResource")
    def replacing_resource(self) -> pulumi.Output[_builtins.str]:
        """
        Whether to operate the endpoint connection for seamless service resource replacement. true: yes, disconnect the old service resource for the seamless replacement endpoint connection. false: no, reject the specified endpoint connection. If this parameter is empty, the specified endpoint connection is rejected
        """
        return pulumi.get(self, "replacing_resource")
