...
def get_traffic_mirror_filter_rule(id: Optional[_builtins.str] = None,
...
def get_traffic_mirror_filter_rule_output(id: pulumi.Input[Optional[_builtins.str]] = None,
