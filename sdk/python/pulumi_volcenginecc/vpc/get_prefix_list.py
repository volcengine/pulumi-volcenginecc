...
class GetPrefixListResult:
    ...
    def association_count(self) -> _builtins.int:
        """
...
def get_prefix_list(id: Optional[_builtins.str] = None,
...
def get_prefix_list_output(id: pulumi.Input[Optional[_builtins.str]] = None,
