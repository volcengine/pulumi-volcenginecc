...
class Ipv6GatewayArgs:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6GatewayTagArgs']]]] = None):
        """
        The set of arguments for constructing a Ipv6Gateway resource.

        :param pulumi.Input[_builtins.str] vpc_id: VPC ID to be associated with the IPv6 gateway instance. Each VPC can only be associated with one IPv6 gateway instance. Ensure the VPC to be associated is not linked to another IPv6 gateway instance
        :param pulumi.Input[_builtins.str] description: Description of the IPv6 gateway instance. Length limit: 0–255 characters. If not specified, defaults to an empty string. Must start with a letter, Chinese character, or number. Can include English comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。)
        :param pulumi.Input[_builtins.str] name: Name of the IPv6 gateway instance. Length limit: 1–128 characters. Must start with a letter, Chinese character, or number. Can include period (.), underscore (_), and hyphen (-). If not specified, defaults to the IPv6 gateway ID
        :param pulumi.Input[_builtins.str] project_name: Name of the project to which the IPv6 gateway belongs
        :param pulumi.Input[Sequence[pulumi.Input['Ipv6GatewayTagArgs']]] tags: Tag information
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6GatewayTagArgs']]]]:
        """
        Tag information
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['Ipv6GatewayTagArgs']]]]):
...
class _Ipv6GatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_time: Creation time of the IPv6 gateway instance
        :param pulumi.Input[_builtins.str] description: Description of the IPv6 gateway instance. Length limit: 0–255 characters. If not specified, defaults to an empty string. Must start with a letter, Chinese character, or number. Can include English comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。)
        :param pulumi.Input[_builtins.str] ipv6_gateway_id: IPv6 gateway instance ID
        :param pulumi.Input[_builtins.str] name: Name of the IPv6 gateway instance. Length limit: 1–128 characters. Must start with a letter, Chinese character, or number. Can include period (.), underscore (_), and hyphen (-). If not specified, defaults to the IPv6 gateway ID
        :param pulumi.Input[_builtins.str] project_name: Name of the project to which the IPv6 gateway belongs
        :param pulumi.Input[_builtins.str] route_table_id: Route table ID associated with the IPv6 gateway instance
        :param pulumi.Input[_builtins.str] status: Operating status of the IPv6 gateway instance. Possible values: Creating: Creating. Deleting: Deleting. Available: Available
        :param pulumi.Input[Sequence[pulumi.Input['Ipv6GatewayTagArgs']]] tags: Tag information
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] updated_time: Modification time of the IPv6 gateway instance
        :param pulumi.Input[_builtins.str] vpc_id: VPC ID to be associated with the IPv6 gateway instance. Each VPC can only be associated with one IPv6 gateway instance. Ensure the VPC to be associated is not linked to another IPv6 gateway instance
        """
...
class Ipv6Gateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['Ipv6GatewayTagArgs', 'Ipv6GatewayTagArgsDict']]]]] = None,
                 vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: Name of the IPv6 gateway instance. Length limit: 1–128 characters. Must start with a letter, Chinese character, or number. Can include period (.), underscore (_), and hyphen (-). If not specified, defaults to the IPv6 gateway ID
        :param pulumi.Input[_builtins.str] project_name: Name of the project to which the IPv6 gateway belongs
        :param pulumi.Input[Sequence[pulumi.Input[Union['Ipv6GatewayTagArgs', 'Ipv6GatewayTagArgsDict']]]] tags: Tag information
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] vpc_id: VPC ID to be associated with the IPv6 gateway instance. Each VPC can only be associated with one IPv6 gateway instance. Ensure the VPC to be associated is not linked to another IPv6 gateway instance
        """
        ...
