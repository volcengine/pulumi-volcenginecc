...
class TrafficMirrorFilterRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] destination_cidr_block: Destination network segment.
        :param pulumi.Input[_builtins.str] policy: Traffic capture policy. accept: allow. When traffic from the mirror source matches this rule, the traffic is copied to the mirror target for monitoring and analysis. reject: reject. When traffic from the mirror source matches this rule, the traffic is not copied and monitoring and analysis are not performed.
        :param pulumi.Input[_builtins.str] protocol: Traffic protocol. Valid values: all: includes TCP, UDP, and ICMP protocols. tcp: TCP protocol. udp: UDP protocol. icmp: ICMP protocol.
        :param pulumi.Input[_builtins.str] source_cidr_block: Source network segment.
        :param pulumi.Input[_builtins.str] traffic_direction: Traffic direction. Valid values: ingress: inbound rule. egress: outbound rule.
        :param pulumi.Input[_builtins.str] traffic_mirror_filter_id: Filtering condition ID.
        :param pulumi.Input[_builtins.str] description: Description of the filtering rule.
        :param pulumi.Input[_builtins.str] destination_port_range: Destination port range for traffic. When Protocol is all or icmp, this parameter is not required. The default value is -1/-1, which means no port restriction. When Protocol is tcp or udp, this parameter is required. Valid range is 1–65535. Use a forward slash (/) to separate the start and end ports, such as 1/50, 80/80.
        :param pulumi.Input[_builtins.int] priority: Priority of the filtering rule, ranging from 1 to 1000. The smaller the value, the higher the priority. Default is 1, which is the highest priority. For the same filtering condition and direction, the priority must be unique.
        :param pulumi.Input[_builtins.str] source_port_range: Source port range for traffic. When Protocol is all or icmp, this parameter is not required. The default value is -1/-1, which means no port restriction. When Protocol is tcp or udp, this parameter is required. Valid range is 1–65535. Use a forward slash (/) to separate the start and end ports, such as 1/50, 80/80.
        """
...
class _TrafficMirrorFilterRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_cidr_block: Source network segment.
        :param pulumi.Input[_builtins.str] source_port_range: Source port range for traffic. When Protocol is all or icmp, this parameter is not required. The default value is -1/-1, which means no port restriction. When Protocol is tcp or udp, this parameter is required. Valid range is 1–65535. Use a forward slash (/) to separate the start and end ports, such as 1/50, 80/80.
        :param pulumi.Input[_builtins.str] status: Status of the filtering rule. Available: available. Deleting: deleting. Creating: creating. Pending: modifying.
        :param pulumi.Input[_builtins.str] traffic_direction: Traffic direction. Valid values: ingress: inbound rule. egress: outbound rule.
        :param pulumi.Input[_builtins.str] traffic_mirror_filter_id: Filtering condition ID.
        :param pulumi.Input[_builtins.str] traffic_mirror_filter_rule_id: Filtering rule ID.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class TrafficMirrorFilterRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            traffic_direction: pulumi.Input[Optional[_builtins.str]] = None,
            traffic_mirror_filter_id: pulumi.Input[Optional[_builtins.str]] = None,
            traffic_mirror_filter_rule_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'TrafficMirrorFilterRule':
        """
