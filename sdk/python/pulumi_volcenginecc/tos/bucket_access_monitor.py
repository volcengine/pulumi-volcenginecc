...
class _BucketAccessMonitorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] bucket: Bucket name.
        :param pulumi.Input[_builtins.str] status: Whether to enable access tracking. Value descriptions: Enabled: Access tracking is enabled. Disabled: Access tracking is disabled.
        """
