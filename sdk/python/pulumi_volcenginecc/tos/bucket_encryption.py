...
class BucketEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_master_key_id: The master key used for SSE-KMS encryption
        :param pulumi.Input[_builtins.str] sse_algorithm: Default server-side encryption method. The values are explained as follows: kms: uses SSE-KMS encryption. AES256: uses SSE-TOS encryption with the AES256 algorithm. SM4: uses SSE-TOS encryption with the SM4 algorithm
        """
...
class BucketEncryption(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            kms_master_key_id: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            sse_algorithm: pulumi.Input[Optional[_builtins.str]] = None) -> 'BucketEncryption':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="kmsMasterKeyId")
    def kms_master_key_id(self) -> pulumi.Output[_builtins.str]:
        """
        The master key used for SSE-KMS encryption
        """
        return pulumi.get(self, "kms_master_key_id")
