...
def get_buckets(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBucketsResult:
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:tos/getBuckets:getBuckets', __args__, opts=opts, typ=GetBucketsResult).value
...
def get_buckets_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBucketsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:tos/getBuckets:getBuckets', __args__, opts=opts, typ=GetBucketsResult)
