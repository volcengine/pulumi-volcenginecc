...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_name: Account name. The name must meet the following requirements: It must start with a lowercase letter. It must end with a lowercase letter or number. The length must be 2–16 characters. It can only contain lowercase letters, numbers, and underscores (_).
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] password: Account password. The password must meet the following requirements: Length of 8–32 characters. Must include at least two of the following: uppercase letters, lowercase letters, numbers, or special characters. Supported special characters: ()`~!@#$%^&*-+=_|{}[];<>,.?
        :param pulumi.Input[_builtins.str] role_name: Account role. The following default roles are supported: Administrator: Allows all Redis instance-supported commands on all Keys. ReadWrite: Allows all commands except admin class commands on all Keys. ReadOnly: Allows all read class commands on all Keys. NotDangerous: Allows all commands except dangerous class commands on all Keys. Note: For details on the specific commands supported by each role's ACL rules, see ACL syntax.
        :param pulumi.Input[_builtins.str] description: Account description, up to 256 characters. Note: If this parameter is empty, no account description is set.
        """
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_name: Account name. The name must meet the following requirements: It must start with a lowercase letter. It must end with a lowercase letter or number. The length must be 2–16 characters. It can only contain lowercase letters, numbers, and underscores (_).
        :param pulumi.Input[_builtins.str] account_status: Account status. The value range is as follows: Available: Available. Unavailable: Unavailable.
        :param pulumi.Input[_builtins.str] description: Account description, up to 256 characters. Note: If this parameter is empty, no account description is set.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] password: Account password. The password must meet the following requirements: Length of 8–32 characters. Must include at least two of the following: uppercase letters, lowercase letters, numbers, or special characters. Supported special characters: ()`~!@#$%^&*-+=_|{}[];<>,.?
        :param pulumi.Input[_builtins.str] role_name: Account role. The following default roles are supported: Administrator: Allows all Redis instance-supported commands on all Keys. ReadWrite: Allows all commands except admin class commands on all Keys. ReadOnly: Allows all read class commands on all Keys. NotDangerous: Allows all commands except dangerous class commands on all Keys. Note: For details on the specific commands supported by each role's ACL rules, see ACL syntax.
...
class Account(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            password: pulumi.Input[Optional[_builtins.str]] = None,
            role_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Account':
        """
