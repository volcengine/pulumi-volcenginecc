...
def get_inter_region_bandwidths(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInterRegionBandwidthsResult:
    """
    Plural Data Source schema for Volcengine::CEN::InterRegionBandwidth
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('volcenginecc:cen/getInterRegionBandwidths:getInterRegionBandwidths', __args__, opts=opts, typ=GetInterRegionBandwidthsResult).value

    return AwaitableGetInterRegionBandwidthsResult(
        id=pulumi.get(__ret__, 'id'),
        ids=pulumi.get(__ret__, 'ids'))
def get_inter_region_bandwidths_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInterRegionBandwidthsResult]:
    """
    Plural Data Source schema for Volcengine::CEN::InterRegionBandwidth
    """
    __args__ = dict()
    opts = pulumi.InvokeOutputOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:cen/getInterRegionBandwidths:getInterRegionBandwidths', __args__, opts=opts, typ=GetInterRegionBandwidthsResult)
