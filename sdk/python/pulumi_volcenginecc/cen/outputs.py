...
__all__ = [
    ...
    'GetCenTagResult',
    'GetServiceRouteEntryPublishToInstanceResult',
]
...
class CenInstance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_owner_id: Optional[_builtins.str] = None,
                 instance_region_id: Optional[_builtins.str] = None,
                 instance_type: Optional[_builtins.str] = None):
        """
        :param _builtins.str instance_id: Network instance ID
        :param _builtins.str instance_owner_id: Account ID for the network instance
        :param _builtins.str instance_region_id: Region where the network instance is located
        :param _builtins.str instance_type: Type of the network instance
        """
    ...
    def instance_owner_id(self) -> Optional[_builtins.str]:
        """
...
class CenTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Tag key for user labels. Length limit: 1–128 characters. Case sensitive. Cannot start or end with a space. Allowed characters: letters, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), minus signs (-), and @. Duplicate tag keys are not allowed for the same resource
        :param _builtins.str value: Tag value for user labels. Length limit: 0–256 characters. Case sensitive. Cannot start or end with a space. Allowed characters: letters, numbers, spaces, underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), minus signs (-), and @
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class ServiceRouteEntryPublishToInstance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_type: Optional[_builtins.str] = None):
        """
        :param _builtins.str instance_id: Network instance ID for published cloud service access route.
        :param _builtins.str instance_region_id: Region for published cloud service access route.
        :param _builtins.str instance_type: Network instance type for published cloud service access route.
        """
        if instance_id is not None:
            pulumi.set(__self__, "instance_id", instance_id)
        if instance_region_id is not None:
...
class GetCenInstanceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cen_id: CEN instance ID
        :param _builtins.str creation_time: Creation time of the network instance
        :param _builtins.str instance_id: Network instance ID
        :param _builtins.str instance_owner_id: Account ID for the network instance
        :param _builtins.str instance_region_id: Region where the network instance is located
        :param _builtins.str instance_type: Type of the network instance
        :param _builtins.str status: Loading status of the network instance. Attaching: Loading; Available: Available
        """
...
@pulumi.output_type
class GetServiceRouteEntryPublishToInstanceResult(dict):
    def __init__(__self__, *,
                 instance_id: _builtins.str,
                 instance_region_id: _builtins.str,
                 instance_type: _builtins.str):
