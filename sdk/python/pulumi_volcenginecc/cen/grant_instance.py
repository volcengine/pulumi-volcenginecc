...
class GrantInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cen_id: Cloud Enterprise Network instance ID of the other party's account
        :param pulumi.Input[_builtins.str] cen_owner_id: Other party's account
        :param pulumi.Input[_builtins.str] instance_id: ID of the network instance to be authorized
        :param pulumi.Input[_builtins.str] instance_region_id: Region where the network instance is located
        :param pulumi.Input[_builtins.str] instance_type: Network instance type. Options: VPC: Virtual Private Cloud. DCGW: Direct Connect Gateway
        """
...
class _GrantInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cen_id: Cloud Enterprise Network instance ID of the other party's account
        :param pulumi.Input[_builtins.str] cen_owner_id: Other party's account
        :param pulumi.Input[_builtins.str] creation_time: Network instance authorization time
        :param pulumi.Input[_builtins.str] instance_id: ID of the network instance to be authorized
        :param pulumi.Input[_builtins.str] instance_region_id: Region where the network instance is located
        :param pulumi.Input[_builtins.str] instance_type: Network instance type. Options: VPC: Virtual Private Cloud. DCGW: Direct Connect Gateway
        """
...
class GrantInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            instance_region_id: pulumi.Input[Optional[_builtins.str]] = None,
            instance_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'GrantInstance':
        """
