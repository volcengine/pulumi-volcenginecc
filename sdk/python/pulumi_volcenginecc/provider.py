...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 customer_headers: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def customer_headers(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def customer_headers(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional['ProviderEndpointsArgs']]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional['ProviderEndpointsArgs']]):
...
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="customerHeaders")
    def customer_headers(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        CUSTOMER HEADERS for Volcengine Provider. The customer_headers field uses commas (,) to separate multiple headers, and colons (:) to separate each header key from its corresponding value.
        """
        return pulumi.get(self, "customer_headers")
