...
def get_zones(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetZonesResult:
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:dns/getZones:getZones', __args__, opts=opts, typ=GetZonesResult).value
...
def get_zones_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetZonesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:dns/getZones:getZones', __args__, opts=opts, typ=GetZonesResult)
