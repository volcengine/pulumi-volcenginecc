...
class BackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] zid: The domain ID for which you need to manually create a backup. You can call the ListZones API to obtain the domain ID.
        """
...
class _BackupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backup_time: Backup creation time. Time zone is UTC+8.
        :param pulumi.Input[builtins.int] record_count: Number of DNS records in the backup.
        :param pulumi.Input[builtins.str] zid: The domain ID for which you need to manually create a backup. You can call the ListZones API to obtain the domain ID.
        """
...
class Backup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            backup_time: Optional[pulumi.Input[builtins.str]] = None,
            record_count: Optional[pulumi.Input[builtins.int]] = None,
            zid: Optional[pulumi.Input[builtins.str]] = None) -> 'Backup':
        """
