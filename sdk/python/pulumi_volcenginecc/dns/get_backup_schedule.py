...
class GetBackupScheduleResult:
    ...
    def count_limit(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def schedule(self) -> _builtins.int:
        """
...
def get_backup_schedule(id: Optional[_builtins.str] = None,
...
def get_backup_schedule_output(id: pulumi.Input[Optional[_builtins.str]] = None,
