...
class RecordArgs:
    def __init__(__self__, *,
                 ...
                 zid: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] host: Host record, the prefix of the subdomain; `@` represents the root domain itself.
        :param pulumi.Input[_builtins.str] type: Record type, such as `A`, `AAAA`, `CNAME`, `NS`, `MX`, `SRV`, `TXT`.
        :param pulumi.Input[_builtins.str] value: Record value of the DNS record.
        :param pulumi.Input[_builtins.str] zid: Domain name ID, can be obtained via interfaces such as `ListZones`.
        :param pulumi.Input[_builtins.bool] enable: Whether the DNS record is enabled; if disabled, the record is inactive.
        :param pulumi.Input[_builtins.str] line: Line code corresponding to the DNS record, such as `default`.
        :param pulumi.Input[_builtins.str] remark: Remarks for the DNS record, supports UTF-8 encoding and up to 16 characters.
        :param pulumi.Input[_builtins.int] ttl: Expiration time of the DNS record, in seconds.
        :param pulumi.Input[_builtins.int] weight: Weight of the DNS record, effective only when load balancing is enabled for the record set.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def zid(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @zid.setter
    def zid(self, value: pulumi.Input[_builtins.str]):
...
class _RecordState:
    def __init__(__self__, *,
                 ...
                 line: pulumi.Input[Optional[_builtins.str]] = None,
                 operators: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 pqdn: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.bool] enable: Whether the DNS record is enabled; if disabled, the record is inactive.
        :param pulumi.Input[_builtins.str] fqdn: Host name included in the DNS record, using FQDN (Fully Qualified Domain Name) format; this field is deprecated.
        :param pulumi.Input[_builtins.str] host: Host record, the prefix of the subdomain; `@` represents the root domain itself.
        :param pulumi.Input[_builtins.str] line: Line code corresponding to the DNS record, such as `default`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] operators: List of account IDs that recently operated on this DNS record.
        :param pulumi.Input[_builtins.str] pqdn: Host name included in the DNS record, using PQDN (Partially Qualified Domain Name) format.
        :param pulumi.Input[_builtins.str] record_id: Unique ID of the DNS record.
        :param pulumi.Input[_builtins.str] record_set_id: ID of the record set containing the DNS record; returned only for A, AAAA, and CNAME types.
        :param pulumi.Input[_builtins.str] remark: Remarks for the DNS record, supports UTF-8 encoding and up to 16 characters.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Tag information for the DNS record; if it contains `GTMLock`, the record is associated with a GTM instance.
        :param pulumi.Input[_builtins.int] ttl: Expiration time of the DNS record, in seconds.
        :param pulumi.Input[_builtins.str] type: Record type, such as `A`, `AAAA`, `CNAME`, `NS`, `MX`, `SRV`, `TXT`.
        :param pulumi.Input[_builtins.str] updated_at: Last updated time of the DNS record.
        :param pulumi.Input[_builtins.str] value: Record value of the DNS record.
        :param pulumi.Input[_builtins.int] weight: Weight of the DNS record, effective only when load balancing is enabled for the record set.
        :param pulumi.Input[_builtins.str] zid: Domain name ID, can be obtained via interfaces such as `ListZones`.
        """
    ...
    @operators.setter
    def operators(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "operators", value)

    @_builtins.property
    @pulumi.getter
    def pqdn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @pqdn.setter
    def pqdn(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Record(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            value: pulumi.Input[Optional[_builtins.str]] = None,
            weight: pulumi.Input[Optional[_builtins.int]] = None,
            zid: pulumi.Input[Optional[_builtins.str]] = None) -> 'Record':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def operators(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of account IDs that recently operated on this DNS record.
        """
        return pulumi.get(self, "operators")
    ...
    @_builtins.property
    @pulumi.getter
    def pqdn(self) -> pulumi.Output[_builtins.str]:
        """
        Host name included in the DNS record, using PQDN (Partially Qualified Domain Name) format.
        """
        return pulumi.get(self, "pqdn")
