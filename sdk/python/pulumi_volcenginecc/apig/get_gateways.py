...
def get_gateways(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGatewaysResult:
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:apig/getGateways:getGateways', __args__, opts=opts, typ=GetGatewaysResult).value

    return AwaitableGetGatewaysResult(
        id=pulumi.get(__ret__, 'id'),
        ids=pulumi.get(__ret__, 'ids'))
def get_gateways_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGatewaysResult]:
    """
    Plural Data Source schema for Volcengine::APIG::Gateway
    """
    __args__ = dict()
    opts = pulumi.InvokeOutputOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:apig/getGateways:getGateways', __args__, opts=opts, typ=GetGatewaysResult)
