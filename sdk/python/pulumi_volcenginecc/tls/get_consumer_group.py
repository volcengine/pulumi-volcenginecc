...
class GetConsumerGroupResult:
    ...
    def heartbeat_ttl(self) -> _builtins.int:
        """
    ...
    def ordered_consume(self) -> _builtins.bool:
        """
    ...
    def topic_id_lists(self) -> Sequence[_builtins.str]:
        """
...
def get_consumer_group(id: Optional[_builtins.str] = None,
...
def get_consumer_group_output(id: pulumi.Input[Optional[_builtins.str]] = None,
