...
class GetHostResult:
    ...
    def heartbeat_status(self) -> builtins.int:
        """
    ...
    def log_collector_version(self) -> builtins.str:
        """
...
def get_host(id: Optional[builtins.str] = None,
...
def get_host_output(id: Optional[pulumi.Input[builtins.str]] = None,
