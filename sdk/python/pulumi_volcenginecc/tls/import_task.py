...
class ImportTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_type: Data source type. Options: tos, kafka.
        :param pulumi.Input['ImportTaskTargetInfoArgs'] target_info: Output information for the data import task.
        :param pulumi.Input[_builtins.str] task_name: Import task name
        :param pulumi.Input[_builtins.str] topic_id: Log topic ID used to store data
        :param pulumi.Input[_builtins.str] description: Task description.
        :param pulumi.Input[_builtins.str] project_id: Log project ID for storing data.
        :param pulumi.Input[_builtins.int] status: Status of the data import task. 0: Importing. 1: Import completed. 2: Import error. 3: Stopping. 4: Stopped. 5: Restarting
        """
...
class _ImportTaskState:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 import_source_info: pulumi.Input[Optional['ImportTaskImportSourceInfoArgs']] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 source_type: pulumi.Input[Optional[_builtins.str]] = None,
                 status: pulumi.Input[Optional[_builtins.int]] = None,
                 target_info: pulumi.Input[Optional['ImportTaskTargetInfoArgs']] = None,
                 task_id: pulumi.Input[Optional[_builtins.str]] = None,
                 task_name: pulumi.Input[Optional[_builtins.str]] = None,
                 task_statistics: pulumi.Input[Optional['ImportTaskTaskStatisticsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.int] status: Status of the data import task. 0: Importing. 1: Import completed. 2: Import error. 3: Stopping. 4: Stopped. 5: Restarting
        :param pulumi.Input['ImportTaskTargetInfoArgs'] target_info: Output information for the data import task.
        :param pulumi.Input[_builtins.str] task_id: Import task ID.
        :param pulumi.Input[_builtins.str] task_name: Import task name
    ...
    @_builtins.property
    @pulumi.getter(name="importSourceInfo")
    def import_source_info(self) -> pulumi.Input[Optional['ImportTaskImportSourceInfoArgs']]:
        """
        Import data source information
        """
        return pulumi.get(self, "import_source_info")
    ...
    @import_source_info.setter
    def import_source_info(self, value: pulumi.Input[Optional['ImportTaskImportSourceInfoArgs']]):
        pulumi.set(self, "import_source_info", value)
    ...
    @_builtins.property
    @pulumi.getter(name="targetInfo")
    def target_info(self) -> pulumi.Input[Optional['ImportTaskTargetInfoArgs']]:
        """
        Output information for the data import task.
        """
        return pulumi.get(self, "target_info")
    ...
    @target_info.setter
    def target_info(self, value: pulumi.Input[Optional['ImportTaskTargetInfoArgs']]):
        pulumi.set(self, "target_info", value)
    ...
    def task_statistics(self) -> pulumi.Input[Optional['ImportTaskTaskStatisticsArgs']]:
        """
    ...
    def task_statistics(self, value: pulumi.Input[Optional['ImportTaskTaskStatisticsArgs']]):
...
class ImportTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 import_source_info: pulumi.Input[Optional[Union['ImportTaskImportSourceInfoArgs', 'ImportTaskImportSourceInfoArgsDict']]] = None,
                 project_id: pulumi.Input[Optional[_builtins.str]] = None,
                 source_type: pulumi.Input[Optional[_builtins.str]] = None,
                 status: pulumi.Input[Optional[_builtins.int]] = None,
                 target_info: pulumi.Input[Optional[Union['ImportTaskTargetInfoArgs', 'ImportTaskTargetInfoArgsDict']]] = None,
                 task_name: pulumi.Input[Optional[_builtins.str]] = None,
                 topic_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        t_ls_import_task_demo = volcenginecc.tls.ImportTask("TLSImportTaskDemo",
    ...
    def get(resource_name: str,
            ...
            task_id: pulumi.Input[Optional[_builtins.str]] = None,
            task_name: pulumi.Input[Optional[_builtins.str]] = None,
            task_statistics: pulumi.Input[Optional[Union['ImportTaskTaskStatisticsArgs', 'ImportTaskTaskStatisticsArgsDict']]] = None,
            topic_id: pulumi.Input[Optional[_builtins.str]] = None,
            topic_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ImportTask':
        """
