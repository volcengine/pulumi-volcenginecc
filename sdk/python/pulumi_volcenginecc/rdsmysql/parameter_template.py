...
class ParameterTemplateArgs:
    def __init__(__self__, *,
                 ...
                 template_desc: pulumi.Input[Optional[_builtins.str]] = None,
                 template_type: pulumi.Input[Optional[_builtins.str]] = None,
                 template_type_version: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a ParameterTemplate resource.

        :param pulumi.Input[_builtins.str] template_name: Parameter template name
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]] template_params: Parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] engine_type: Database engine type. Values: InnoDB (InnoDB engine), RocksDB (RocksDB engine). Default: InnoDB
        :param pulumi.Input[_builtins.str] project_name: Associated project
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Default: Mysql
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template. Value range: MySQL*5*7 (MySQL 5.7 version), MySQL*8*0 (MySQL 8.0 version)
        """
    ...
    def template_desc(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def template_desc(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def template_type_version(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def template_type_version(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ParameterTemplateState:
    def __init__(__self__, *,
                 ...
                 engine_type: pulumi.Input[Optional[_builtins.str]] = None,
                 need_restart: pulumi.Input[Optional[_builtins.bool]] = None,
                 parameter_num: pulumi.Input[Optional[_builtins.int]] = None,
                 project_name: pulumi.Input[Optional[_builtins.str]] = None,
                 template_category: pulumi.Input[Optional[_builtins.str]] = None,
                 template_desc: pulumi.Input[Optional[_builtins.str]] = None,
                 template_id: pulumi.Input[Optional[_builtins.str]] = None,
                 template_name: pulumi.Input[Optional[_builtins.str]] = None,
                 template_params: pulumi.Input[Optional[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]]] = None,
                 template_source: pulumi.Input[Optional[_builtins.str]] = None,
                 template_type: pulumi.Input[Optional[_builtins.str]] = None,
                 template_type_version: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] create_time: Creation time (UTC+8), format: yyyy-MM-dd HH:mm:ss
        :param pulumi.Input[_builtins.str] engine_type: Database engine type. Values: InnoDB (InnoDB engine), RocksDB (RocksDB engine). Default: InnoDB
        :param pulumi.Input[_builtins.bool] need_restart: Whether the template contains parameters that require a restart
        :param pulumi.Input[_builtins.int] parameter_num: Number of parameters included in the template
        :param pulumi.Input[_builtins.str] project_name: Associated project
        :param pulumi.Input[_builtins.str] template_category: Template category. Value: DBEngine (database engine parameter)
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description
        :param pulumi.Input[_builtins.str] template_id: Parameter template ID, automatically generated by the system
        :param pulumi.Input[_builtins.str] template_name: Parameter template name
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]] template_params: Parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] template_source: Parameter template type. Values: System (system template), User (user template)
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Default: Mysql
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template. Value range: MySQL*5*7 (MySQL 5.7 version), MySQL*8*0 (MySQL 8.0 version)
        :param pulumi.Input[_builtins.str] update_time: Template modification time
        """
    ...
    def need_restart(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    @need_restart.setter
    def need_restart(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "need_restart", value)

    @_builtins.property
    @pulumi.getter(name="parameterNum")
    def parameter_num(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def parameter_num(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def template_category(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def template_category(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter(name="templateParams")
    def template_params(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]]]:
        """
        Parameters included in the parameter template
        Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        """
    ...
    @template_params.setter
    def template_params(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]]]):
        pulumi.set(self, "template_params", value)

    @_builtins.property
    @pulumi.getter(name="templateSource")
    def template_source(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def template_source(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ParameterTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 template_desc: pulumi.Input[Optional[_builtins.str]] = None,
                 template_name: pulumi.Input[Optional[_builtins.str]] = None,
                 template_params: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ParameterTemplateTemplateParamArgs', 'ParameterTemplateTemplateParamArgsDict']]]]] = None,
                 template_type: pulumi.Input[Optional[_builtins.str]] = None,
                 template_type_version: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        r_ds_my_sql_parameter_template_demo = volcenginecc.rdsmysql.ParameterTemplate("RDSMySQLParameterTemplateDemo",
        ...
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description
        :param pulumi.Input[_builtins.str] template_name: Parameter template name
        :param pulumi.Input[Sequence[pulumi.Input[Union['ParameterTemplateTemplateParamArgs', 'ParameterTemplateTemplateParamArgsDict']]]] template_params: Parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Default: Mysql
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template. Value range: MySQL*5*7 (MySQL 5.7 version), MySQL*8*0 (MySQL 8.0 version)
        """
    ...
    def get(resource_name: str,
            ...
            template_type: pulumi.Input[Optional[_builtins.str]] = None,
            template_type_version: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ParameterTemplate':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="needRestart")
    def need_restart(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether the template contains parameters that require a restart
        """
        return pulumi.get(self, "need_restart")
    ...
    @_builtins.property
    @pulumi.getter(name="parameterNum")
    def parameter_num(self) -> pulumi.Output[_builtins.int]:
        """
        Number of parameters included in the template
        """
        return pulumi.get(self, "parameter_num")
    ...
    @_builtins.property
    @pulumi.getter(name="templateCategory")
    def template_category(self) -> pulumi.Output[_builtins.str]:
        """
        Template category. Value: DBEngine (database engine parameter)
        """
        return pulumi.get(self, "template_category")
    ...
    @_builtins.property
    @pulumi.getter(name="templateDesc")
    def template_desc(self) -> pulumi.Output[_builtins.str]:
        """
        Parameter template description
        """
        return pulumi.get(self, "template_desc")
    ...
    @_builtins.property
    @pulumi.getter(name="templateSource")
    def template_source(self) -> pulumi.Output[_builtins.str]:
        """
        Parameter template type. Values: System (system template), User (user template)
        """
        return pulumi.get(self, "template_source")
    ...
    @_builtins.property
    @pulumi.getter(name="templateTypeVersion")
    def template_type_version(self) -> pulumi.Output[_builtins.str]:
        """
        Database version of the parameter template. Value range: MySQL*5*7 (MySQL 5.7 version), MySQL*8*0 (MySQL 8.0 version)
        """
        return pulumi.get(self, "template_type_version")
