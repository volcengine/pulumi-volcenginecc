...
class GetResolverEndpointResult:
    ...
    def vpc_region(self) -> _builtins.str:
        """
...
def get_resolver_endpoint(id: Optional[_builtins.str] = None,
...
def get_resolver_endpoint_output(id: pulumi.Input[Optional[_builtins.str]] = None,
