...
class ParameterTemplateArgs:
    def __init__(__self__, *,
                 ...
                 template_type_version: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]] template_params: List of parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Value: PostgreSQL
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template, such as PostgreSQL*13, PostgreSQL*14, PostgreSQL_15, etc
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description information
        """
    ...
    def template_type_version(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def template_type_version(self, value: pulumi.Input[_builtins.str]):
...
class _ParameterTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] create_time: Parameter template creation time
        :param pulumi.Input[_builtins.bool] need_restart: Whether the template contains parameters that require a restart to take effect
        :param pulumi.Input[_builtins.int] parameter_num: Number of parameters included in the template
        :param pulumi.Input[_builtins.str] template_category: Template category
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description information
        :param pulumi.Input[_builtins.str] template_id: Parameter template ID, automatically generated by the system
        :param pulumi.Input[_builtins.str] template_name: Parameter template name
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateTemplateParamArgs']]] template_params: List of parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] template_source: Parameter template source type. Options: System (system template), User (user template)
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Value: PostgreSQL
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template, such as PostgreSQL*13, PostgreSQL*14, PostgreSQL_15, etc
        :param pulumi.Input[_builtins.str] update_time: Last modified time of the parameter template
        """
...
class ParameterTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] template_desc: Parameter template description information
        :param pulumi.Input[_builtins.str] template_name: Parameter template name
        :param pulumi.Input[Sequence[pulumi.Input[Union['ParameterTemplateTemplateParamArgs', 'ParameterTemplateTemplateParamArgsDict']]]] template_params: List of parameters included in the parameter template
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] template_type: Database type of the parameter template. Value: PostgreSQL
        :param pulumi.Input[_builtins.str] template_type_version: Database version of the parameter template, such as PostgreSQL*13, PostgreSQL*14, PostgreSQL_15, etc
        """
