...
class GetParameterTemplateResult:
    ...
    """
    def __init__(__self__, account_id=None, create_time=None, id=None, need_restart=None, parameter_num=None, template_category=None, template_desc=None, template_id=None, template_name=None, template_params=None, template_source=None, template_type=None, template_type_version=None, update_time=None):
...
def get_parameter_template(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('volcenginecc:rdspostgresql/getParameterTemplate:getParameterTemplate', __args__, opts=opts, typ=GetParameterTemplateResult).value
...
def get_parameter_template_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('volcenginecc:rdspostgresql/getParameterTemplate:getParameterTemplate', __args__, opts=opts, typ=GetParameterTemplateResult)
