...
class GetDbEndpointResult:
    ...
    def read_write_proxy_connection(self) -> _builtins.int:
        """
...
def get_db_endpoint(id: Optional[_builtins.str] = None,
...
def get_db_endpoint_output(id: pulumi.Input[Optional[_builtins.str]] = None,
