...
class SchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] owner: Schema owner. Note that instance read-only accounts, high-privilege accounts with DDL permissions disabled, or regular accounts with DDL permissions disabled cannot be set as the Schema owner.
        :param pulumi.Input[_builtins.str] schema_name: Schema name. Length: 2–63 characters. Can contain letters, numbers, underscores (*), or hyphens (-). Must start with a letter and end with a letter or number. Reserved keywords are not allowed; for all disabled keywords, see Disabled Keywords. Cannot start with pg*
        """
...
class Schema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            owner: pulumi.Input[Optional[_builtins.str]] = None,
            schema_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Schema':
        """
