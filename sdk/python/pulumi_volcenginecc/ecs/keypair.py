...
class KeypairArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['KeypairTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['KeypairTagArgs']]]]):
...
class _KeypairState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] created_time: Creation time of the key pair.
        :param pulumi.Input[_builtins.str] description: Description of the key pair. The default value is an empty string. Must start with a letter or Chinese character. Can only contain Chinese characters, letters, numbers, period ('.'), space, underscore ('_'), hyphen ('-'), equals sign ('='), English comma (','), Chinese comma ('，'), and Chinese period ('。'). Length must not exceed 255 characters.
        :param pulumi.Input[_builtins.str] finger_print: Fingerprint of the key pair. The public key fingerprint format is defined by RFC4716 and uses the MD5 hash algorithm.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] instance_ids: Instance ID for the operation.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KeypairTagArgs']]] tags: Tags of the key pair.
               Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        :param pulumi.Input[_builtins.str] updated_time: Update time of the key pair.
        """
...
class Keypair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_key: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['KeypairTagArgs', 'KeypairTagArgsDict']]]]] = None,
            updated_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'Keypair':
        """
