...
class AclAclEntry(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str description: Description of the IP entry. Default value is an empty string. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: English comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), and Chinese period (。). Length must be between 0 and 255 characters.
        :param _builtins.str entry: Address range of the IP entry. Only CIDR addresses are supported. Both IPv4 and IPv6 entries can be provided.
        """
...
class AclListener(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str acl_type: Listener control mode for this access control policy group. white: allowlist. When the listener monitors CLB traffic, CLB only forwards requests from IP addresses associated with the allowlist access control policy group. black: denylist. When the listener monitors CLB traffic, CLB rejects requests from IP addresses associated with the denylist access control policy group.
        :param _builtins.str listener_id: Listener ID
        :param _builtins.str listener_name: Listener name
        :param _builtins.int port: Listener port
        :param _builtins.str protocol: Listener protocol. Includes TCP, UDP, HTTP, HTTPS.
        """
...
class AclTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: User tag key. Length must be 1–128 characters. Supports input of characters in any language, numbers, spaces ( ), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @ (@). If the tag key starts or ends with a space, the system automatically removes it.
        :param _builtins.str value: User tag value. Supports input of characters in any language, numbers, spaces ( ), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @ (@). Case sensitive. If the tag value starts or ends with a space, the system automatically removes it.
        """
        if key is not None:
...
class ClbAccessLog(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket_name: Name of the object storage bucket for storing Layer 7 access logs
        :param _builtins.bool enabled: Enable access log TOS feature?
        :param _builtins.bool tls_enabled: Enable access log TLS feature?
        :param _builtins.str tls_project_id: Log project
        :param _builtins.str tls_topic_id: Log topic
        """
...
class ClbEip(dict):
    ...
    def __init__(__self__, *,
                 bandwidth: Optional[_builtins.float] = None,
                 bandwidth_package_id: Optional[_builtins.str] = None,
                 eip_billing_type: Optional[_builtins.float] = None,
                 isp: Optional[_builtins.str] = None,
                 security_protection_instance_id: Optional[_builtins.float] = None,
                 security_protection_types: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.float bandwidth: Peak bandwidth
        :param _builtins.str bandwidth_package_id: Shared bandwidth package ID
        :param _builtins.float eip_billing_type: Billing method
        :param _builtins.str isp: Line type
        :param _builtins.float security_protection_instance_id: Protection package ID
        :param Sequence[_builtins.str] security_protection_types: Security protection type
        """
    ...
    @_builtins.property
    @pulumi.getter
    def bandwidth(self) -> Optional[_builtins.float]:
        """
        Peak bandwidth
        """
    ...
    def eip_billing_type(self) -> Optional[_builtins.float]:
        """
        Billing method
        """
    ...
    def security_protection_instance_id(self) -> Optional[_builtins.float]:
        """
...
class ClbEni(dict):
    ...
    def __init__(__self__, *,
                 eni_address: Optional[_builtins.str] = None,
                 eni_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str eni_address: Private IP address of the load balancer instance
        :param _builtins.str eni_id: Network interface ID occupied by the load balancer instance
        """
...
class ClbIpv6AddressBandwidth(dict):
    ...
    def __init__(__self__, *,
                 bandwidth: Optional[_builtins.float] = None,
                 bandwidth_package_id: Optional[_builtins.str] = None,
                 billing_type: Optional[_builtins.float] = None,
                 isp: Optional[_builtins.str] = None,
                 network_type: Optional[_builtins.str] = None):
        """
        :param _builtins.float bandwidth: Peak bandwidth of IPv6 public bandwidth, in Mbps
        :param _builtins.str bandwidth_package_id: Shared bandwidth package ID associated with IPv6 public bandwidth
        :param _builtins.float billing_type: Billing type for IPv6 public bandwidth
        :param _builtins.str isp: Line type of IPv6 public bandwidth
        :param _builtins.str network_type: Network type of the load balancer instance's IPv6 address
        """
        if bandwidth is not None:
            pulumi.set(__self__, "bandwidth", bandwidth)
        if bandwidth_package_id is not None:
    ...
    def billing_type(self) -> Optional[_builtins.float]:
        """
...
class ClbServerGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str server_group_id: ID of the backend server group in the load balancer instance
        :param _builtins.str server_group_name: Name of the backend server group in the load balancer instance
        """
...
class ListenerDomainExtension(dict):
    ...
    def __init__(__self__, *,
                 cert_center_certificate_id: Optional[_builtins.str] = None,
                 certificate_source: Optional[_builtins.str] = None,
                 domain: Optional[_builtins.str] = None):
        """
        :param _builtins.str cert_center_certificate_id: Certificate ID of the extended domain name.
        :param _builtins.str certificate_source: Certificate source for the extended domain name to be added. Value: cert_center: SSL certificate from Volcano Engine Certificate Center. This parameter is required when adding an extended domain name.
    ...
    def cert_center_certificate_id(self) -> Optional[_builtins.str]:
        """
...
class ListenerHealthCheck(dict):
    ...
    def __init__(__self__, *,
                 ...
                 udp_expect: Optional[_builtins.str] = None,
                 udp_request: Optional[_builtins.str] = None,
        ...
        :param _builtins.str enabled: Whether health check is enabled for the listener. on (default): enabled. off: disabled.
        :param _builtins.int healthy_threshold: Health threshold, i.e., the number of consecutive successful health checks. Range: 2–10, default is 3, unit: times.
        :param _builtins.str http_code: HTTP status codes for healthy checks. This parameter is effective when Protocol is HTTP or HTTPS and HealthCheck.Enabled is on. Values: http*2xx (default), http*3xx, http*4xx, http*5xx. Separate multiple status codes with a comma (,).
        :param _builtins.int interval: Interval for performing health checks. Range: 1–300, default is 2, in seconds.
        :param _builtins.str method: Listener health check method. GET: server must support the GET method. HEAD: server returns only HEAD header information, which reduces backend overhead, but requires server support for the HEAD method.
        :param _builtins.int port: Health check port. Value range: 1–65535.
        :param _builtins.int timeout: Health check response timeout. If the backend server does not respond correctly within the specified time, the health check is considered 'abnormal'. Value range: 1 to 60. Default: 2. Unit: seconds.
        :param _builtins.str udp_expect: Expected response string for health check. Only letters and numbers are allowed, with a maximum length of 64 characters. This parameter takes effect when Protocol is set to UDP and HealthCheck.Enabled is set to on. HealthCheck.UdpRequest and HealthCheck.UdpExpect must either both be empty or both be non-empty.
        :param _builtins.str udp_request: Request string for performing health checks. Only letters and numbers are allowed, with a maximum length of 64 characters. This parameter takes effect when Protocol is set to UDP and HealthCheck.Enabled is set to on. The values of HealthCheck.UdpRequest and HealthCheck.UdpExpect must either both be empty or both be non-empty.
        :param _builtins.int unhealthy_threshold: Unhealthy threshold, which is the number of consecutive health check failures. Value range: 2–10. Default: 3. Unit: occurrences.
        :param _builtins.str uri: Health check path. Must be configured as the actual address provided by the backend server. This parameter takes effect when Protocol is set to HTTP or HTTPS and HealthCheck.Enabled is on. Must start with '/'. Only letters, digits, hyphens (-), underscores (_), slashes (/), periods (.), percent signs (%), question marks (?), #, &, and equals signs (=) are allowed. Length: 1–128 characters. If not specified or no value is provided, the default is '/'.
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
        if enabled is not None:
    ...
    def udp_expect(self) -> Optional[_builtins.str]:
        """
    ...
    def udp_request(self) -> Optional[_builtins.str]:
        """
        Request string for performing health checks. Only letters and numbers are allowed, with a maximum length of 64 characters. This parameter takes effect when Protocol is set to UDP and HealthCheck.Enabled is set to on. The values of HealthCheck.UdpRequest and HealthCheck.UdpExpect must either both be empty or both be non-empty.
        """
...
class ListenerTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Tag key for user tags. Length range: 1–128 characters. Supports input of characters from all languages, numbers, spaces ( ), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @ (@). If the tag key starts or ends with a space, the system automatically removes it.
        :param _builtins.str value: Tag value for user tags. Supports input of characters from any language, numbers, spaces ( ), underscores (_), periods (.), colons (:), slashes (/), equals signs (=), plus signs (+), hyphens (-), and @ (@). Case sensitive. If the tag value starts or ends with a space, the system will automatically remove it.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class NlbAccessLog(dict):
    ...
    def __init__(__self__, *,
                 access_log_enabled: Optional[_builtins.bool] = None,
                 project_id: Optional[_builtins.str] = None,
                 topic_id: Optional[_builtins.str] = None):
        """
        :param _builtins.bool access_log_enabled: Enable access logs. true: yes. false: no.
    ...
    def access_log_enabled(self) -> Optional[_builtins.bool]:
        """
...
class NlbListenerHealth(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str instance_id: Backend server instance ID or IP address
        :param _builtins.str ip: Backend server IP address
        :param _builtins.int port: Port on which the backend server provides services
        :param _builtins.str server_id: Backend server ID
        :param _builtins.str server_type: Backend server type: ecs (cloud server instance, i.e., primary network interface); eni (secondary network interface); ip (IP address)
        :param _builtins.str status: Backend server health status: Up (normal); Down (abnormal); Unused (not in use—NLB instance has disabled cross-zone forwarding and there is no traffic from this backend server's zone)
        :param _builtins.str updated_time: Last update time of health status
        :param _builtins.str zone_id: Zone ID where the backend server receives traffic
        """
...
class NlbServerGroupHealthCheck(dict):
    ...
    def __init__(__self__, *,
                 ...
                 uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str domain: Health check domain name
        :param _builtins.bool enabled: Enable health check
        :param _builtins.int healthy_threshold: Health check healthy threshold. Range: 2–10 times, default: 3 times. If the backend server passes the specified number of consecutive health checks with 'normal' results, it is considered health check 'normal'
        :param _builtins.str http_code: HTTP status codes indicating a healthy health check.
        :param _builtins.int interval: Health check interval, range: 1–300 seconds, default: 10 seconds.
        :param _builtins.str method: Health check request method
        :param _builtins.int port: Health check port. Range: 1–65535. If full port forwarding is not enabled for the server group, this parameter defaults to 0, meaning the backend server's port is used for health checks. If full port forwarding is enabled, this parameter must be specified
        :param _builtins.int timeout: Health check response timeout. Range: 1–60 seconds, default: 3 seconds. If the backend server does not respond correctly within the specified time, it is considered health check 'abnormal'
        :param _builtins.str type: Health check protocol type. Options: TCP (default), HTTP, UDP
        :param _builtins.str udp_expect: UDP health check request string. Only letters and numbers are allowed, with a maximum length of 64 characters.
        :param _builtins.str udp_request: Expected response string for UDP health check
        :param _builtins.int unhealthy_threshold: Health check unhealthy threshold. Range: 2–10 times, default: 3 times. If the backend server fails the specified number of consecutive health checks with 'abnormal' results, it is considered health check abnormal
        :param _builtins.str uri: Health check path
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
        if enabled is not None:
...
class NlbServerGroupServer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 zone_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str description: Description of the backend server, default is an empty string.
        :param _builtins.str instance_id: Server instance ID or IP address. If the server type is 'ecs', enter the cloud server instance ID. You can call the DescribeInstances API to obtain the cloud server instance ID. If the server type is 'eni', enter the network interface card ID bound to the cloud server instance. You can call the DescribeNetworkInterfaces API to obtain the network interface card ID. If the server type is 'ip', enter the backend server's IP address.
        :param _builtins.str ip: Private IP address of the backend server. You can call the DescribeInstances API to obtain the private IP address of an 'ecs' type backend server. You can call the DescribeNetworkInterfaces API to obtain the private IP address of an 'eni' type backend server.
        :param _builtins.int port: Port number on which the backend server receives requests, range: 1–65535. If AnyPortEnabled is 'false' (all-port forwarding is disabled), this parameter is required. If AnyPortEnabled is 'true' (all-port forwarding is enabled), the default value is 0.
        :param _builtins.str server_id: Backend server ID
        :param _builtins.str type: Backend server type. Available values: ecs: cloud server instance (primary network interface). eni: auxiliary network interface. ip: IP address.
        :param _builtins.int weight: Backend server weight, range: 0–100. Weight of 0 means requests will not be forwarded to this server. If not specified, the default is 0.
        :param _builtins.str zone_id: Specify the availability zone of the NLB instance associated with the backend server. This parameter is required when Servers.N.Type is ip. If the NLB instance enables cross-zone forwarding, the backend server can receive traffic from all availability zones of the NLB instance. If cross-zone forwarding is disabled, the backend server only receives traffic from the specified availability zone
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if instance_id is not None:
...
class NlbZoneMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ipv4_eip_address: Optional[_builtins.str] = None,
                 ipv4_eip_id: Optional[_builtins.str] = None,
                 ipv4_hc_status: Optional[_builtins.str] = None,
                 ipv4_local_addresses: Optional[Sequence[_builtins.str]] = None,
                 ipv6_address: Optional[_builtins.str] = None,
                 ipv6_eip_id: Optional[_builtins.str] = None,
                 ipv6_hc_status: Optional[_builtins.str] = None,
                 ipv6_local_addresses: Optional[Sequence[_builtins.str]] = None,
                 subnet_id: Optional[_builtins.str] = None,
                 zone_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str eni_id: Network interface card ID.
        :param _builtins.str ipv4_address: Private IPv4 VIP address of the NLB instance. If this parameter is not provided, the system automatically assigns an available IPv4 address from the subnet.
        :param _builtins.str ipv4_eip_address: Public IPv4 EIP address of the NLB instance.
        :param _builtins.str ipv4_eip_id: Public IPv4 EIP ID of the NLB instance.
        :param _builtins.str ipv4_hc_status: Health status of the NLB instance's private IPv4 address. Healthy: healthy. Unhealthy: abnormal.
        :param Sequence[_builtins.str] ipv4_local_addresses: Private IPv4 LIP address of the NLB instance.
        :param _builtins.str ipv6_address: Private IPv6 VIP address of the NLB instance.
        :param _builtins.str ipv6_eip_id: ID of the IPv6 public bandwidth associated with the NLB instance.
        :param _builtins.str ipv6_hc_status: Health status of the NLB instance's private IPv6 address. Healthy: healthy. Unhealthy: abnormal.
        :param Sequence[_builtins.str] ipv6_local_addresses: Private IPv6 LIP address of the NLB instance.
        :param _builtins.str subnet_id: Subnet ID to which the NLB instance belongs.
        :param _builtins.str zone_id: Availability zone ID to which the NLB instance belongs.
        """
        if eni_id is not None:
            pulumi.set(__self__, "eni_id", eni_id)
    ...
    def ipv4_eip_address(self) -> Optional[_builtins.str]:
        """
    ...
    def ipv4_eip_id(self) -> Optional[_builtins.str]:
        """
    ...
    def ipv4_hc_status(self) -> Optional[_builtins.str]:
        """
    ...
    def ipv6_eip_id(self) -> Optional[_builtins.str]:
        """
    ...
    def ipv6_hc_status(self) -> Optional[_builtins.str]:
        """
...
class RuleRedirectConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host: The domain name for forwarding rule redirection currently supports only exact domain names. Specifications: Must contain at least one '.', and cannot start or end with '.'. Only letters, numbers, '.', and '-' are allowed. Length must be between 1 and 128 characters. Example of a valid exact domain name: www.test.com.
        :param _builtins.str path: Path for forwarding rule redirection. Specifications: Must start with a forward slash '/'. Consecutive '/' characters are not allowed. Only letters, numbers, '-', '_', '/', '.', '%', '?', '#', '&', '=', and other specified characters are allowed. Length must be between 1 and 128 characters.
        :param _builtins.str port: Port for forwarding rule redirection. Value range: 1~65535.
        :param _builtins.str protocol: Protocol for forwarding rule redirection. Options: HTTP. HTTPS (default).
        :param _builtins.str status_code: Status code for forwarding rule redirection. Options: 301 (default): Indicates the requested resource has been permanently moved to a new URL. The client should use the new URL for subsequent requests. 302: Indicates the requested resource has been temporarily moved to a new URL and may change again in the future. The client should use the new URL for subsequent requests. 307: Similar to 302, but requires the client to keep the request method unchanged during redirection. For example, if the original request is GET, the redirected request remains GET. 308: Similar to 301, but requires the client to keep the request method unchanged during redirection.
        """
        if host is not None:
...
class ServerGroupServer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: Optional[_builtins.int] = None):
        """
        :param _builtins.str description: Backend server description. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), Chinese period (。). Length limit: 0–255 characters. If not specified, defaults to an empty string.
        :param _builtins.str instance_id: Backend server. Value options: When Type is ecs, provide the cloud server instance ID. When Type is eni, provide the ID of the auxiliary network card attached to the cloud server. When Type is ip, provide the IP address as the backend server.
        :param _builtins.str ip: Private IP address of the backend server. Use '&' to separate multiple backend server IP addresses.
        :param _builtins.int port: Port number on which the backend server receives requests. Value range: 1–65535. If the AnyPortEnabled parameter is 'off' and you need to add backend servers at the same time, this parameter must be provided. If AnyPortEnabled is 'on', this parameter defaults to 0.
        :param _builtins.str type: Backend server instance type. When the Type parameter is instance, value options are: ecs: cloud server instance. eni: auxiliary network card. When the Type parameter is ip, this parameter value is ip.
        :param _builtins.int weight: Backend server weight, range: 0–100. If not specified, defaults to 0. 0 means requests will not be forwarded to this backend server.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if instance_id is not None:
...
class ServerGroupTag(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str key: Information about bound tag keys.
        :param _builtins.str value: Bound tag value information.
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
        if value is not None:
...
class GetClbEipResult(dict):
    def __init__(__self__, *,
                 ...
                 eip_billing_type: _builtins.float,
                 isp: _builtins.str,
                 security_protection_instance_id: _builtins.float,
    ...
    @_builtins.property
    @pulumi.getter(name="eipBillingType")
    def eip_billing_type(self) -> _builtins.float:
        """
        Billing method
        """
        return pulumi.get(self, "eip_billing_type")
    ...
    @_builtins.property
    @pulumi.getter(name="securityProtectionInstanceId")
    def security_protection_instance_id(self) -> _builtins.float:
        """
        Protection package ID
        """
        return pulumi.get(self, "security_protection_instance_id")
...
class GetClbEniResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="eniAddress")
    def eni_address(self) -> _builtins.str:
        """
        Private IP address of the load balancer instance
        """
        return pulumi.get(self, "eni_address")
...
class GetClbIpv6AddressBandwidthResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="billingType")
    def billing_type(self) -> _builtins.float:
        """
        Billing type for IPv6 public bandwidth
        """
        return pulumi.get(self, "billing_type")
...
class GetListenerDomainExtensionResult(dict):
    def __init__(__self__, *,
                 cert_center_certificate_id: _builtins.str,
                 certificate_source: _builtins.str,
                 domain: _builtins.str,
                 domain_extension_id: _builtins.str):
        """
        :param _builtins.str cert_center_certificate_id: Certificate ID of the extended domain name.
        :param _builtins.str certificate_source: Certificate source for the extended domain name to be added. Value: cert_center: SSL certificate from Volcano Engine Certificate Center. This parameter is required when adding an extended domain name.
        :param _builtins.str domain: Domain name. Supports both wildcard and exact domain names. Specifications: 1. Must contain at least one '.', and cannot start or end with '.'. 2. Only letters, numbers, '.', '-', and '*' are allowed. 3. Length must be between 1 and 128 characters. 4. Wildcard domain: Use '*' to replace one or more characters. 5. Exact domain: A domain name that strictly follows domain name specifications.
        :param _builtins.str domain_extension_id: Extended domain name ID.
        """
        pulumi.set(__self__, "cert_center_certificate_id", cert_center_certificate_id)
        pulumi.set(__self__, "certificate_source", certificate_source)
        pulumi.set(__self__, "domain", domain)
    ...
    @_builtins.property
    @pulumi.getter(name="certCenterCertificateId")
    def cert_center_certificate_id(self) -> _builtins.str:
        """
        Certificate ID of the extended domain name.
        """
        return pulumi.get(self, "cert_center_certificate_id")
    ...
    def domain_extension_id(self) -> _builtins.str:
        """
...
class GetListenerHealthCheckResult(dict):
    def __init__(__self__, *,
                 ...
                 udp_expect: _builtins.str,
                 udp_request: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="udpExpect")
    def udp_expect(self) -> _builtins.str:
        """
        Expected response string for health check. Only letters and numbers are allowed, with a maximum length of 64 characters. This parameter takes effect when Protocol is set to UDP and HealthCheck.Enabled is set to on. HealthCheck.UdpRequest and HealthCheck.UdpExpect must either both be empty or both be non-empty.
        """
        return pulumi.get(self, "udp_expect")
    ...
    @_builtins.property
    @pulumi.getter(name="udpRequest")
    def udp_request(self) -> _builtins.str:
        """
        Request string for performing health checks. Only letters and numbers are allowed, with a maximum length of 64 characters. This parameter takes effect when Protocol is set to UDP and HealthCheck.Enabled is set to on. The values of HealthCheck.UdpRequest and HealthCheck.UdpExpect must either both be empty or both be non-empty.
        """
        return pulumi.get(self, "udp_request")
...
class GetNlbAccessLogResult(dict):
    def __init__(__self__, *,
                 access_log_enabled: _builtins.bool,
    ...
    @_builtins.property
    @pulumi.getter(name="accessLogEnabled")
    def access_log_enabled(self) -> _builtins.bool:
        """
        Enable access logs. true: yes. false: no.
        """
        return pulumi.get(self, "access_log_enabled")
...
class GetNlbZoneMappingResult(dict):
    def __init__(__self__, *,
                 ...
                 ipv4_eip_address: _builtins.str,
                 ipv4_eip_id: _builtins.str,
                 ipv4_hc_status: _builtins.str,
                 ipv4_local_addresses: Sequence[_builtins.str],
                 ipv6_address: _builtins.str,
                 ipv6_eip_id: _builtins.str,
                 ipv6_hc_status: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="ipv4EipAddress")
    def ipv4_eip_address(self) -> _builtins.str:
        """
        Public IPv4 EIP address of the NLB instance.
        """
        return pulumi.get(self, "ipv4_eip_address")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv4EipId")
    def ipv4_eip_id(self) -> _builtins.str:
        """
        Public IPv4 EIP ID of the NLB instance.
        """
        return pulumi.get(self, "ipv4_eip_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv4HcStatus")
    def ipv4_hc_status(self) -> _builtins.str:
        """
        Health status of the NLB instance's private IPv4 address. Healthy: healthy. Unhealthy: abnormal.
        """
        return pulumi.get(self, "ipv4_hc_status")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6EipId")
    def ipv6_eip_id(self) -> _builtins.str:
        """
        ID of the IPv6 public bandwidth associated with the NLB instance.
        """
        return pulumi.get(self, "ipv6_eip_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ipv6HcStatus")
    def ipv6_hc_status(self) -> _builtins.str:
        """
        Health status of the NLB instance's private IPv6 address. Healthy: healthy. Unhealthy: abnormal.
        """
        return pulumi.get(self, "ipv6_hc_status")
...
class GetServerGroupServerResult(dict):
    def __init__(__self__, *,
                 any_port_enabled: _builtins.str,
                 description: _builtins.str,
                 instance_id: _builtins.str,
                 ip: _builtins.str,
                 port: _builtins.int,
                 ...
                 weight: _builtins.int):
        """
        :param _builtins.str any_port_enabled: Enable all-port forwarding. on: enabled. off (default): disabled.
        :param _builtins.str description: Backend server description. Must start with a letter, number, or Chinese character. Can include letters, numbers, Chinese characters, and the following special characters: comma (,), period (.), underscore (_), space ( ), equals sign (=), hyphen (-), Chinese comma (，), Chinese period (。). Length limit: 0–255 characters. If not specified, defaults to an empty string.
        :param _builtins.str instance_id: Backend server. Value options: When Type is ecs, provide the cloud server instance ID. When Type is eni, provide the ID of the auxiliary network card attached to the cloud server. When Type is ip, provide the IP address as the backend server.
        :param _builtins.str ip: Private IP address of the backend server. Use '&' to separate multiple backend server IP addresses.
        :param _builtins.int port: Port number on which the backend server receives requests. Value range: 1–65535. If the AnyPortEnabled parameter is 'off' and you need to add backend servers at the same time, this parameter must be provided. If AnyPortEnabled is 'on', this parameter defaults to 0.
    ...
    def any_port_enabled(self) -> _builtins.str:
        """
