...
class CheckLogTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] load_balancer_id: CLB ID information that meets the criteria.
        :param pulumi.Input[_builtins.str] log_topic_id: ID of the created log topic. You can call the DescribeTopics API to query the log topic ID.
        """
...
class CheckLogTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            load_balancer_id: pulumi.Input[Optional[_builtins.str]] = None,
            log_topic_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'CheckLogTopic':
        """
