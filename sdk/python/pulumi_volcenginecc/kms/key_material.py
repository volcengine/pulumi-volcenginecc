...
class KeyMaterialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] encrypted_key_material: The key material obtained after the user encrypts using the import public key, encoded in Base64; this value is passed directly to the ImportKeyMaterial interface.
        :param pulumi.Input[_builtins.str] import_token: The import token obtained after the user calls the interface to retrieve import parameters; this value is passed directly to the ImportKeyMaterial interface.
        :param pulumi.Input[_builtins.str] key_id: Unique identifier of the target master key in UUID format; the Origin of this key must be External.
        :param pulumi.Input[_builtins.str] expiration_model: Key material expiration type. Values: KEY*MATERIAL*DOES*NOT*EXPIRE (default), KEY*MATERIAL*EXPIRES.
        :param pulumi.Input[_builtins.int] valid_to: Key material expiration time, Unix timestamp in seconds; required when the ExpirationModel parameter is set to KEY*MATERIAL*EXPIRES. Must be a time after the current moment, based on server time.
        """
...
class _KeyMaterialState:
    def __init__(__self__, *,
                 ...
                 expiration_model: pulumi.Input[Optional[_builtins.str]] = None,
                 import_token: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] import_token: The import token obtained after the user calls the interface to retrieve import parameters; this value is passed directly to the ImportKeyMaterial interface.
        :param pulumi.Input[_builtins.str] key_id: Unique identifier of the target master key in UUID format; the Origin of this key must be External.
        :param pulumi.Input[_builtins.str] key_material_expire_time: The expiration time of the key material recorded by the server after import; if the material does not expire, this field is an empty string.
        :param pulumi.Input[_builtins.str] key_state: Current status of the target master key. Values: Enable, Disable, PendingDelete, Archived, PendingImport, PendingReplicaDelete.
        :param pulumi.Input[_builtins.str] origin: Source of the target master key. Values: CloudKMS, External, ExternalKeyStore. The KeyMaterial resource is only valid for keys with External origin.
        :param pulumi.Input[_builtins.int] valid_to: Key material expiration time, Unix timestamp in seconds; required when the ExpirationModel parameter is set to KEY*MATERIAL*EXPIRES. Must be a time after the current moment, based on server time.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="importToken")
    def import_token(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The import token obtained after the user calls the interface to retrieve import parameters; this value is passed directly to the ImportKeyMaterial interface.
        """
        return pulumi.get(self, "import_token")
    ...
    @import_token.setter
    def import_token(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "import_token", value)
...
class KeyMaterial(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_state: pulumi.Input[Optional[_builtins.str]] = None,
            origin: pulumi.Input[Optional[_builtins.str]] = None,
            valid_to: pulumi.Input[Optional[_builtins.int]] = None) -> 'KeyMaterial':
        """
