...
namespace Volcengine.Pulumi.Volcenginecc.Vke.Inputs
{
    ...
    public sealed class DefaultNodePoolNodeConfigGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("dataVolumes")]
        private InputList<Inputs.DefaultNodePoolNodeConfigDataVolumeGetArgs>? _dataVolumes;
        public InputList<Inputs.DefaultNodePoolNodeConfigDataVolumeGetArgs> DataVolumes
        {
            get => _dataVolumes ?? (_dataVolumes = new InputList<Inputs.DefaultNodePoolNodeConfigDataVolumeGetArgs>());
        ...
        [Input("tags")]
        private InputList<Inputs.DefaultNodePoolNodeConfigTagGetArgs>? _tags;
        public InputList<Inputs.DefaultNodePoolNodeConfigTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.DefaultNodePoolNodeConfigTagGetArgs>());
            set => _tags = value;
        }
