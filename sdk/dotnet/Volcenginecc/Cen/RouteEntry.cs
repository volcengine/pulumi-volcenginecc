...
namespace Volcengine.Pulumi.Volcenginecc.Cen
{
    ...
    /// ```
    /// </summary>
    [VolcengineccResourceType("volcenginecc:cen/routeEntry:RouteEntry")]
    public partial class RouteEntry : global::Pulumi.CustomResource
    {
        ...
        public RouteEntry(string name, RouteEntryArgs args, CustomResourceOptions? options = null)
            : base("volcenginecc:cen/routeEntry:RouteEntry", name, args ?? new RouteEntryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteEntry(string name, Input<string> id, RouteEntryState? state = null, CustomResourceOptions? options = null)
            : base("volcenginecc:cen/routeEntry:RouteEntry", name, state, MakeResourceOptions(options, id))
        {
        }
