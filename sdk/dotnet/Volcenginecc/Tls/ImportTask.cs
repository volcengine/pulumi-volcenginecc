...
namespace Volcengine.Pulumi.Volcenginecc.Tls
{
    ...
    /// {
    ///     var tLSImportTaskDemo = new Volcenginecc.Tls.ImportTask("TLSImportTaskDemo", new()
    ///     {
    ///         Description = "ccapi-test-kafka",
    ///         ImportSourceInfo = new Volcenginecc.Tls.Inputs.ImportTaskImportSourceInfoArgs
    ///         {
    ///             Kafka_source_info = 
    ///             {
    ...
    ///         SourceType = "kafka",
    ///         TargetInfo = new Volcenginecc.Tls.Inputs.ImportTaskTargetInfoArgs
    ///         {
    ///             Region = "cn-beijing",
    ///             Log_type = "json_log",
    ///             Log_sample = "",
