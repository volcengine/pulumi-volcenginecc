...
namespace Volcengine.Pulumi.Volcenginecc.Tls
{
    ...
    /// ```
    /// </summary>
    [VolcengineccResourceType("volcenginecc:tls/host:Host")]
    public partial class Host : global::Pulumi.CustomResource
    {
        ...
        public Output<int> HeartbeatStatus { get; private set; } = null!;
        ...
        /// </summary>
        [Output("logCollectorVersion")]
        public Output<string> LogCollectorVersion { get; private set; } = null!;
        ...
        public Host(string name, HostArgs args, CustomResourceOptions? options = null)
            : base("volcenginecc:tls/host:Host", name, args ?? new HostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Host(string name, Input<string> id, HostState? state = null, CustomResourceOptions? options = null)
            : base("volcenginecc:tls/host:Host", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class HostState : global::Pulumi.ResourceArgs
    {
        ...
        /// Log collector version
        /// </summary>
        [Input("logCollectorVersion")]
        public Input<string>? LogCollectorVersion { get; set; }
