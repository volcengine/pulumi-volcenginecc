...
namespace Volcengine.Pulumi.Volcenginecc.Tls.Outputs
{
    ...
    [OutputType]
    public sealed class IndexUserInnerKeyValueValueJsonKey
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.IndexUserInnerKeyValueValueJsonKeyValue? Value;

        [OutputConstructor]
        private IndexUserInnerKeyValueValueJsonKey(
            string? key,

            Outputs.IndexUserInnerKeyValueValueJsonKeyValue? value)
        {
            Key = key;
            Value = value;
        }
