...
namespace Volcengine.Pulumi.Volcenginecc.Tls.Outputs
{
    ...
    [OutputType]
    public sealed class GetIndexKeyValueResult
    {
        /// <summary>
        ...
        /// 需要配置键值索引的字段描述信息。
        /// </summary>
        public readonly Outputs.GetIndexKeyValueValueResult Value;

        [OutputConstructor]
        private GetIndexKeyValueResult(
            string key,

            Outputs.GetIndexKeyValueValueResult value)
        {
            Key = key;
            Value = value;
        }
