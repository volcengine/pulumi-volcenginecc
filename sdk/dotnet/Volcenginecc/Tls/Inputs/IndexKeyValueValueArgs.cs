...
namespace Volcengine.Pulumi.Volcenginecc.Tls.Inputs
{
    ...
    public sealed class IndexKeyValueValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("jsonKeys")]
        private InputList<Inputs.IndexKeyValueValueJsonKeyArgs>? _jsonKeys;
        public InputList<Inputs.IndexKeyValueValueJsonKeyArgs> JsonKeys
        {
            get => _jsonKeys ?? (_jsonKeys = new InputList<Inputs.IndexKeyValueValueJsonKeyArgs>());
            set => _jsonKeys = value;
        }
        ...
        public IndexKeyValueValueArgs()
        {
        }
        public static new IndexKeyValueValueArgs Empty => new IndexKeyValueValueArgs();
    }
}
