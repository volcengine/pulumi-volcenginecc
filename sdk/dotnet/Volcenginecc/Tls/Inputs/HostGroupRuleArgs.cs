...
namespace Volcengine.Pulumi.Volcenginecc.Tls.Inputs
{
    ...
    public sealed class HostGroupRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Container collection rules
        /// </summary>
        [Input("containerRule")]
        public Input<Inputs.HostGroupRuleContainerRuleArgs>? ContainerRule { get; set; }
        ...
        [Input("excludePaths")]
        private InputList<Inputs.HostGroupRuleExcludePathArgs>? _excludePaths;
        public InputList<Inputs.HostGroupRuleExcludePathArgs> ExcludePaths
        {
            get => _excludePaths ?? (_excludePaths = new InputList<Inputs.HostGroupRuleExcludePathArgs>());
        ...
        /// </summary>
        [Input("extractRule")]
        public Input<Inputs.HostGroupRuleExtractRuleArgs>? ExtractRule { get; set; }
        ...
        public Input<Inputs.HostGroupRuleUserDefineRuleArgs>? UserDefineRule { get; set; }

        public HostGroupRuleArgs()
        {
        }
        public static new HostGroupRuleArgs Empty => new HostGroupRuleArgs();
    }
}
