...
namespace Volcengine.Pulumi.Volcenginecc.Tls.Inputs
{
    ...
    public sealed class RuleUserDefineRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("fields")]
        private InputList<Inputs.RuleUserDefineRuleFieldArgs>? _fields;
        public InputList<Inputs.RuleUserDefineRuleFieldArgs> Fields
        {
            get => _fields ?? (_fields = new InputList<Inputs.RuleUserDefineRuleFieldArgs>());
            set => _fields = value;
        }
