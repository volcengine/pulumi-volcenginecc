...
namespace Volcengine.Pulumi.Volcenginecc.Tls
{
    public static class GetProjects
    {
        ...
        public static Task<GetProjectsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectsResult>("volcenginecc:tls/getProjects:getProjects", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::TLS::Project
        /// </summary>
        public static Output<GetProjectsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectsResult>("volcenginecc:tls/getProjects:getProjects", InvokeArgs.Empty, options.WithDefaults());
