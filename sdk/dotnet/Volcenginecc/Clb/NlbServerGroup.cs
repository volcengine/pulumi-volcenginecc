...
namespace Volcengine.Pulumi.Volcenginecc.Clb
{
    ...
    /// {
    ///     var nLBServerGroupDemo = new Volcenginecc.Clb.NlbServerGroup("NLBServerGroupDemo", new()
    ///     {
    ///         BypassSecurityGroupEnabled = false,
    ///         HealthCheck = new Volcenginecc.Clb.Inputs.NlbServerGroupHealthCheckArgs
    ///         {
    ///             Enabled = false,
    ///         },
    ...
    ///         Servers = new[]
    ///         {
    ///             new Volcenginecc.Clb.Inputs.NlbServerGroupServerArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Volcenginecc.Clb.Inputs.NlbServerGroupTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
