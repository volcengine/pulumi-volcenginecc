...
namespace Volcengine.Pulumi.Volcenginecc.Autoscaling
{
    ...
    ///         HealthCheckType = "ECS",
    ///         ScalingMode = "release",
    ///         InstancesDistribution = new Volcenginecc.Autoscaling.Inputs.ScalingGroupInstancesDistributionArgs
    ///         {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Volcenginecc.Autoscaling.Inputs.ScalingGroupTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    ///         {
    ///             new Volcenginecc.Autoscaling.Inputs.ScalingGroupLaunchTemplateOverrideArgs
    ///             {
    ...
    ///         {
    ///             new Volcenginecc.Autoscaling.Inputs.ScalingGroupServerGroupAttributeArgs
    ///             {
    ///                 Port = 8080,
