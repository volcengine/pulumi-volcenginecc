...
namespace Volcengine.Pulumi.Volcenginecc.Organization
{
    public static class GetAccounts
    {
        ...
        public static Task<GetAccountsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountsResult>("volcenginecc:organization/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::Organization::Account
        /// </summary>
        public static Output<GetAccountsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountsResult>("volcenginecc:organization/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());
