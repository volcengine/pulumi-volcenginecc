...
namespace Volcengine.Pulumi.Volcenginecc.Organization
{
    ...
    /// {
    ///     var organizationAccountDemo = new Volcenginecc.Organization.Account("OrganizationAccountDemo", new()
    ///     {
    ...
    ///         AllowConsole = 1,
    ///         SecureContactInfo = new Volcenginecc.Organization.Inputs.AccountSecureContactInfoArgs
    ///         {
    ///             New_email = "",
    ///             New_phone = "*********",
    ///         },
    ///         Tags = new[]
    ///         {
    ///             new Volcenginecc.Organization.Inputs.AccountTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
