...
namespace Volcengine.Pulumi.Volcenginecc.Kafka
{
    ...
    /// {
    ///     var kafkaAllowListDemo = new Volcenginecc.Kafka.AllowList("KafkaAllowListDemo", new()
    ///     {
    ///         AllowListValue = "127.0.0.2",
    ///         AllowListDesc = "test",
    ///         AllowListName = "ccapi-text",
    ///         AssociatedInstances = new[]
    ///         {
    ///             new Volcenginecc.Kafka.Inputs.AllowListAssociatedInstanceArgs
    ///             {
