...
namespace Volcengine.Pulumi.Volcenginecc.Rabbitmq
{
    ...
    /// {
    ///     var rabbitMQAllowListDemo = new Volcenginecc.Rabbitmq.AllowList("RabbitMQAllowListDemo", new()
    ///     {
    ///         AllowListType = "IPv4",
    ///         AllowListValue = "192.x.0.0/24",
    ///         AllowListName = "ccapi-test",
    ///         AllowListDesc = "test-desc",
    ///         AssociatedInstances = new[]
    ///         {
    ///             new Volcenginecc.Rabbitmq.Inputs.AllowListAssociatedInstanceArgs
    ///             {
