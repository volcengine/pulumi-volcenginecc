...
namespace Volcengine.Pulumi.Volcenginecc.Rabbitmq
{
    public static class GetInstances
    {
        ...
        public static Task<GetInstancesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstancesResult>("volcenginecc:rabbitmq/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::RabbitMQ::Instance
        /// </summary>
        public static Output<GetInstancesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstancesResult>("volcenginecc:rabbitmq/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());
