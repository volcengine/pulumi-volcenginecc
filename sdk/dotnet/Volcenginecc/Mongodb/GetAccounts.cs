...
namespace Volcengine.Pulumi.Volcenginecc.Mongodb
{
    public static class GetAccounts
    {
        ...
        public static Task<GetAccountsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountsResult>("volcenginecc:mongodb/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::MongoDB::Account
        /// </summary>
        public static Output<GetAccountsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountsResult>("volcenginecc:mongodb/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());
