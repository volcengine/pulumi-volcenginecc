...
namespace Volcengine.Pulumi.Volcenginecc.Vefaas
{
    public static class GetFunctions
    {
        ...
        public static Task<GetFunctionsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFunctionsResult>("volcenginecc:vefaas/getFunctions:getFunctions", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::VEFAAS::Function
        /// </summary>
        public static Output<GetFunctionsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFunctionsResult>("volcenginecc:vefaas/getFunctions:getFunctions", InvokeArgs.Empty, options.WithDefaults());
