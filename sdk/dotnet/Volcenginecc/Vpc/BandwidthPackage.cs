...
namespace Volcengine.Pulumi.Volcenginecc.Vpc
{
    ...
    /// {
    ///     var bandwidthPackageDemo = new Volcenginecc.Vpc.BandwidthPackage("BandwidthPackageDemo", new()
    ///     {
    ///         Period = 1,
    ///         PeriodUnit = 1,
    ///         Protocol = "Dual-stack",
    ///         Tags = new[]
    ///         {
    ///             new Volcenginecc.Vpc.Inputs.BandwidthPackageTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    ///         EipAddresses = new[]
    ///         {
    ///             new Volcenginecc.Vpc.Inputs.BandwidthPackageEipAddressArgs
    ///             {
