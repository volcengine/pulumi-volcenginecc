...
namespace Volcengine.Pulumi.Volcenginecc.Redis
{
    public static class GetInstances
    {
        ...
        public static Task<GetInstancesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstancesResult>("volcenginecc:redis/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::Redis::Instance
        /// </summary>
        public static Output<GetInstancesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstancesResult>("volcenginecc:redis/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());
