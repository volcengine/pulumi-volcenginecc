...
namespace Volcengine.Pulumi.Volcenginecc.Redis
{
    public static class GetAllowLists
    {
        ...
        public static Task<GetAllowListsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListsResult>("volcenginecc:redis/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::Redis::AllowList
        /// </summary>
        public static Output<GetAllowListsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListsResult>("volcenginecc:redis/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());
