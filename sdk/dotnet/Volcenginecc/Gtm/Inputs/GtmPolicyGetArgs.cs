...
namespace Volcengine.Pulumi.Volcenginecc.Gtm.Inputs
{
    ...
    public sealed class GtmPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("statistics")]
        public Input<Inputs.GtmPolicyStatisticsGetArgs>? Statistics { get; set; }

        [Input("targets")]
        private InputList<Inputs.GtmPolicyTargetGetArgs>? _targets;
        public InputList<Inputs.GtmPolicyTargetGetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.GtmPolicyTargetGetArgs>());
            set => _targets = value;
        }

        public GtmPolicyGetArgs()
        {
        }
        public static new GtmPolicyGetArgs Empty => new GtmPolicyGetArgs();
    }
}
