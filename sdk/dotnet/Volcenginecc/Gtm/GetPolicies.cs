...
namespace Volcengine.Pulumi.Volcenginecc.Gtm
{
    public static class GetPolicies
    {
        ...
        public static Task<GetPoliciesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoliciesResult>("volcenginecc:gtm/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::GTM::Policy
        /// </summary>
        public static Output<GetPoliciesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoliciesResult>("volcenginecc:gtm/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());
