...
namespace Volcengine.Pulumi.Volcenginecc.Cloudidentity
{
    public static class GetGroups
    {
        ...
        public static Task<GetGroupsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupsResult>("volcenginecc:cloudidentity/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::CloudIdentity::Group
        /// </summary>
        public static Output<GetGroupsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupsResult>("volcenginecc:cloudidentity/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());
