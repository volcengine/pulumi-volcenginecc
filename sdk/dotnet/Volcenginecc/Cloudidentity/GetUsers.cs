...
namespace Volcengine.Pulumi.Volcenginecc.Cloudidentity
{
    public static class GetUsers
    {
        ...
        public static Task<GetUsersResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUsersResult>("volcenginecc:cloudidentity/getUsers:getUsers", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::CloudIdentity::User
        /// </summary>
        public static Output<GetUsersResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUsersResult>("volcenginecc:cloudidentity/getUsers:getUsers", InvokeArgs.Empty, options.WithDefaults());
