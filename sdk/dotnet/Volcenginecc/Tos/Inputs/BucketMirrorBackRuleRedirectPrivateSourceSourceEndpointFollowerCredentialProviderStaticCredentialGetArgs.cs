...
namespace Volcengine.Pulumi.Volcenginecc.Tos.Inputs
{
    ...
    public sealed class BucketMirrorBackRuleRedirectPrivateSourceSourceEndpointFollowerCredentialProviderStaticCredentialGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// AccessKey ID of the origin bucket. Required when using AK/SK authentication.
        /// </summary>
        [Input("ak")]
        public Input<string>? Ak { get; set; }

        /// <summary>
        /// SecretKey for the back-to-origin bucket. Required when using AK/SK authentication.
        /// </summary>
        [Input("sk")]
        public Input<string>? Sk { get; set; }
        ...
        /// </summary>
        [Input("skEncryptType")]
        public Input<string>? SkEncryptType { get; set; }

        /// <summary>
        /// Origin service provider. Values: BOS: Baidu Cloud. S3: Other cloud providers using the S3 storage protocol.
        /// </summary>
        [Input("storageVendor")]
        public Input<string>? StorageVendor { get; set; }

        public BucketMirrorBackRuleRedirectPrivateSourceSourceEndpointFollowerCredentialProviderStaticCredentialGetArgs()
        {
        }
        public static new BucketMirrorBackRuleRedirectPrivateSourceSourceEndpointFollowerCredentialProviderStaticCredentialGetArgs Empty => new BucketMirrorBackRuleRedirectPrivateSourceSourceEndpointFollowerCredentialProviderStaticCredentialGetArgs();
    }
}
