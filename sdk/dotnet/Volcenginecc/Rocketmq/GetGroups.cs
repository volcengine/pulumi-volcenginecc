...
namespace Volcengine.Pulumi.Volcenginecc.Rocketmq
{
    public static class GetGroups
    {
        ...
        public static Task<GetGroupsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupsResult>("volcenginecc:rocketmq/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::RocketMQ::Group
        /// </summary>
        public static Output<GetGroupsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupsResult>("volcenginecc:rocketmq/getGroups:getGroups", InvokeArgs.Empty, options.WithDefaults());
