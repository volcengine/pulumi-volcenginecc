...
namespace Volcengine.Pulumi.Volcenginecc.Cdn
{
    ...
    ///                     { "ttl", 2 },
    ///                 },
    ///                 Condition = new Volcenginecc.Cdn.Inputs.DomainCacheConditionArgs
    ///                 {
    ///                     ConditionRule = new[]
    ///                     {
    ///
    ...
    ///             Switch = false,
    ///         },
    ///         DomainValue = "ccapi-test-web.com",
    ...
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.DomainBrowserCache>> BrowserCaches { get; private set; } = null!;
        ...
        /// </summary>
        [Output("caches")]
        public Output<ImmutableArray<Outputs.DomainCache>> Caches { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.DomainNegativeCache>> NegativeCaches { get; private set; } = null!;
    ...
    public sealed class DomainArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("browserCaches")]
        private InputList<Inputs.DomainBrowserCacheArgs>? _browserCaches;

        /// <summary>
        /// Indicates the configuration module for the 'browser cache' feature. This feature is disabled by default. The parameter value is a list of rules, described as follows: Each list element is a cache rule configuration. You can create up to 50 rules. The order of elements in the list determines the priority of the corresponding rules. The rule at the top of the list has the highest priority. If you create multiple rules, pay attention to whether there are containment relationships between rules. If containment exists, rules with a broader scope should appear after those with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainBrowserCacheArgs> BrowserCaches
        {
            get => _browserCaches ?? (_browserCaches = new InputList<Inputs.DomainBrowserCacheArgs>());
        ...
        [Input("caches")]
        private InputList<Inputs.DomainCacheArgs>? _caches;

        /// <summary>
        /// Represents the configuration module for the 'Cache Rule' feature. This feature is disabled by default, meaning no custom rules are created. The list can contain up to 50 rules. The order of rules in the list defines their priority, with the first rule having the highest priority. The filter in each rule specifies the scope of the rule. If you create multiple rules, rules with a broader scope should appear after those with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainCacheArgs> Caches
        {
            get => _caches ?? (_caches = new InputList<Inputs.DomainCacheArgs>());
            set => _caches = value;
        }
        ...
        private InputList<Inputs.DomainNegativeCacheArgs>? _negativeCaches;

        /// <summary>
        /// Indicates the configuration module for the 'status code cache' feature. This feature is disabled by default. The parameter value is a list, as explained below: Each list element is a cache rule configuration. You can create up to 50 rules. The order of elements in the list determines the priority of the corresponding rules. The first rule in the list has the highest priority. If you create multiple rules, pay attention to whether there is containment between rules. If containment exists, rules with a broader scope should appear after rules with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainNegativeCacheArgs> NegativeCaches
        {
            get => _negativeCaches ?? (_negativeCaches = new InputList<Inputs.DomainNegativeCacheArgs>());
    ...
    public sealed class DomainState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("browserCaches")]
        private InputList<Inputs.DomainBrowserCacheGetArgs>? _browserCaches;

        /// <summary>
        /// Indicates the configuration module for the 'browser cache' feature. This feature is disabled by default. The parameter value is a list of rules, described as follows: Each list element is a cache rule configuration. You can create up to 50 rules. The order of elements in the list determines the priority of the corresponding rules. The rule at the top of the list has the highest priority. If you create multiple rules, pay attention to whether there are containment relationships between rules. If containment exists, rules with a broader scope should appear after those with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainBrowserCacheGetArgs> BrowserCaches
        {
            get => _browserCaches ?? (_browserCaches = new InputList<Inputs.DomainBrowserCacheGetArgs>());
            set => _browserCaches = value;
        }
        ...
        [Input("caches")]
        private InputList<Inputs.DomainCacheGetArgs>? _caches;

        /// <summary>
        /// Represents the configuration module for the 'Cache Rule' feature. This feature is disabled by default, meaning no custom rules are created. The list can contain up to 50 rules. The order of rules in the list defines their priority, with the first rule having the highest priority. The filter in each rule specifies the scope of the rule. If you create multiple rules, rules with a broader scope should appear after those with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainCacheGetArgs> Caches
        {
            get => _caches ?? (_caches = new InputList<Inputs.DomainCacheGetArgs>());
            set => _caches = value;
        }
        ...
        [Input("negativeCaches")]
        private InputList<Inputs.DomainNegativeCacheGetArgs>? _negativeCaches;

        /// <summary>
        /// Indicates the configuration module for the 'status code cache' feature. This feature is disabled by default. The parameter value is a list, as explained below: Each list element is a cache rule configuration. You can create up to 50 rules. The order of elements in the list determines the priority of the corresponding rules. The first rule in the list has the highest priority. If you create multiple rules, pay attention to whether there is containment between rules. If containment exists, rules with a broader scope should appear after rules with a narrower scope.
        /// Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
        /// </summary>
        public InputList<Inputs.DomainNegativeCacheGetArgs> NegativeCaches
        {
            get => _negativeCaches ?? (_negativeCaches = new InputList<Inputs.DomainNegativeCacheGetArgs>());
            set => _negativeCaches = value;
        }
