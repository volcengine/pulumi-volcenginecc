...
namespace Volcengine.Pulumi.Volcenginecc.Cdn.Inputs
{
    ...
    public sealed class DomainIpAccessRuleGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("ips")]
        ...
        /// </summary>
        [Input("sharedConfig")]
        public Input<Inputs.DomainIpAccessRuleSharedConfigGetArgs>? SharedConfig { get; set; }
        ...
        public DomainIpAccessRuleGetArgs()
        {
        }
        public static new DomainIpAccessRuleGetArgs Empty => new DomainIpAccessRuleGetArgs();
    }
}
