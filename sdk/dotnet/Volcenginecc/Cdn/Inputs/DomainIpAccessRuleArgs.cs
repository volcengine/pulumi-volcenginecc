...
namespace Volcengine.Pulumi.Volcenginecc.Cdn.Inputs
{
    ...
    public sealed class DomainIpAccessRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("ips")]
        ...
        /// </summary>
        [Input("sharedConfig")]
        public Input<Inputs.DomainIpAccessRuleSharedConfigArgs>? SharedConfig { get; set; }
        ...
        public DomainIpAccessRuleArgs()
        {
        }
        public static new DomainIpAccessRuleArgs Empty => new DomainIpAccessRuleArgs();
    }
}
