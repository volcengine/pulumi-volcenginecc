...
namespace Volcengine.Pulumi.Volcenginecc.Cdn.Outputs
{
    ...
    [OutputType]
    public sealed class GetDomainCompressionCompressionRuleCompressionActionResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string CompressionTarget;
        /// <summary>
        /// 压缩算法，gzip,br 指定类型压缩，default：默认所有文件压缩，次数Target为*；customize：自定义文件类型压缩. choices: [default, customize]
        /// </summary>
        public readonly ImmutableArray<string> CompressionTypes;
        /// <summary>
        ...
        /// </summary>
        public readonly int MaxFileSizeKb;
        /// <summary>
        /// 表示文件大小范围的最大值，取值范围是 0   - 2,147,483,647，单位是 KB，使用的进制是 1,024。如果不指定该参数，表示您不限制文件大小的上限。
        /// </summary>
        public readonly int MinFileSizeKb;

        [OutputConstructor]
        private GetDomainCompressionCompressionRuleCompressionActionResult(
            string compressionFormat,

            string compressionTarget,

            ImmutableArray<string> compressionTypes,
