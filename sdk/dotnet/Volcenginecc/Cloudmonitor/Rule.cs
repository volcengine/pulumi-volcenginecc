...
namespace Volcengine.Pulumi.Volcenginecc.Cloudmonitor
{
    ...
    ///         OriginalDimensions = new Volcenginecc.Cloudmonitor.Inputs.RuleOriginalDimensionsArgs
    ///         {
    ///             Key = "ResourceID",
    ///             Values = new[]
    ///             {
    ...
    ///         NoData = new Volcenginecc.Cloudmonitor.Inputs.RuleNoDataArgs
    ///         {
    ///             Enable = false,
    ///             Evaluation_count = 4,
    ///         },
    ///         LevelConditions = new[]
    ///         {
    ///             new Volcenginecc.Cloudmonitor.Inputs.RuleLevelConditionArgs
    ///             {
    ///                 Level = "warning",
    ///                 Conditions = new[]
    ///                 {
    ///                     new Volcenginecc.Cloudmonitor.Inputs.RuleLevelConditionConditionArgs
    ///                     {
    ...
    ///         Conditions = new[]
    ///         {
    ///             new Volcenginecc.Cloudmonitor.Inputs.RuleConditionArgs
    ///             {
    ...
    ///         ConditionOperator = "&amp;&amp;",
    ///         SilenceTime = 5,
    ///         RecoveryNotify = new Volcenginecc.Cloudmonitor.Inputs.RuleRecoveryNotifyArgs
    ///         {
    ///             Enable = true,
    ///         },
    ///         ProjectName = "default",
    ///         Tags = new[]
    ///         {
    ///             new Volcenginecc.Cloudmonitor.Inputs.RuleTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
