...
namespace Volcengine.Pulumi.Volcenginecc.Iam
{
    public static class GetPolicies
    {
        ...
        public static Task<GetPoliciesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoliciesResult>("volcenginecc:iam/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::IAM::Policy
        /// </summary>
        public static Output<GetPoliciesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoliciesResult>("volcenginecc:iam/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());
