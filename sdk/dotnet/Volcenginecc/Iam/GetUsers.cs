...
namespace Volcengine.Pulumi.Volcenginecc.Iam
{
    public static class GetUsers
    {
        ...
        public static Task<GetUsersResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUsersResult>("volcenginecc:iam/getUsers:getUsers", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Volcengine::IAM::User
        /// </summary>
        public static Output<GetUsersResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUsersResult>("volcenginecc:iam/getUsers:getUsers", InvokeArgs.Empty, options.WithDefaults());
