 ...
 *
 * const cDNShareConfigDemo = new volcenginecc.cdn.ShareConfig("CDNShareConfigDemo", {
...
export class ShareConfig extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowIpAccessRule: pulumi.Output<outputs.cdn.ShareConfigAllowIpAccessRule>;
    /**
     * Indicates a configuration for a Referer allowlist. The corresponding ConfigType is allow*referer*access*rule.
     */
    declare public readonly allowRefererAccessRule: pulumi.Output<outputs.cdn.ShareConfigAllowRefererAccessRule>;
    /**
     * Specifies the configuration for a common list, where ConfigType is common*match*list.
     */
    declare public readonly commonMatchList: pulumi.Output<outputs.cdn.ShareConfigCommonMatchList>;
    /**
     ...
     */
    declare public readonly denyIpAccessRule: pulumi.Output<outputs.cdn.ShareConfigDenyIpAccessRule>;
    /**
     * Indicates a configuration for a Referer denylist. The corresponding ConfigType is deny*referer*access*rule.
     */
    declare public readonly denyRefererAccessRule: pulumi.Output<outputs.cdn.ShareConfigDenyRefererAccessRule>;
    /**
    ...
    constructor(name: string, argsOrState?: ShareConfigArgs | ShareConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["allowIpAccessRule"] = state?.allowIpAccessRule;
            resourceInputs["allowRefererAccessRule"] = state?.allowRefererAccessRule;
            resourceInputs["commonMatchList"] = state?.commonMatchList;
            resourceInputs["configName"] = state?.configName;
            resourceInputs["configType"] = state?.configType;
            resourceInputs["denyIpAccessRule"] = state?.denyIpAccessRule;
            resourceInputs["denyRefererAccessRule"] = state?.denyRefererAccessRule;
            ...
            resourceInputs["allowIpAccessRule"] = args?.allowIpAccessRule;
            resourceInputs["allowRefererAccessRule"] = args?.allowRefererAccessRule;
            resourceInputs["commonMatchList"] = args?.commonMatchList;
            resourceInputs["configName"] = args?.configName;
            resourceInputs["configType"] = args?.configType;
            resourceInputs["denyIpAccessRule"] = args?.denyIpAccessRule;
            resourceInputs["denyRefererAccessRule"] = args?.denyRefererAccessRule;
...
export interface ShareConfigState {
     ...
     * Specifies the configuration for an IP allowlist, where ConfigType is allow*ip*access*rule.
     */
    allowIpAccessRule?: pulumi.Input<inputs.cdn.ShareConfigAllowIpAccessRule | undefined>;
    /**
     * Indicates a configuration for a Referer allowlist. The corresponding ConfigType is allow*referer*access*rule.
     */
    allowRefererAccessRule?: pulumi.Input<inputs.cdn.ShareConfigAllowRefererAccessRule | undefined>;
    /**
     * Specifies the configuration for a common list, where ConfigType is common*match*list.
     */
    commonMatchList?: pulumi.Input<inputs.cdn.ShareConfigCommonMatchList | undefined>;
    /**
     * Specifies the name of the global configuration. Naming requirements: Names can include Chinese characters, letters, numbers, and underscores (_), and must be 3–45 characters long. One Chinese character counts as 3 characters. The name cannot be the same as any existing global configuration name under the primary account.
     */
     ...
     * Specifies the configuration for an IP denylist, where ConfigType is deny*ip*access*rule.
     */
    denyIpAccessRule?: pulumi.Input<inputs.cdn.ShareConfigDenyIpAccessRule | undefined>;
    /**
     * Indicates a configuration for a Referer denylist. The corresponding ConfigType is deny*referer*access*rule.
     */
    denyRefererAccessRule?: pulumi.Input<inputs.cdn.ShareConfigDenyRefererAccessRule | undefined>;
    /**
     * Indicates the number of accelerated domains associated with this global configuration.
     */
    domainCount?: pulumi.Input<number | undefined>;
    /**
     * Specifies the project name to which the global configuration belongs.
     */
