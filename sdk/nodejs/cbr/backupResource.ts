...
export class BackupResource extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly metaInformation: pulumi.Output<outputs.cbr.BackupResourceMetaInformation>;
    /**
     * List of Associated Backup Plans
     * Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
     */
    declare public /*out*/ readonly plans: pulumi.Output<outputs.cbr.BackupResourcePlan[]>;
    /**
     * Number of Restore Points
     */
    declare public /*out*/ readonly recoveryPointNumber: pulumi.Output<number>;
    /**
     * Backup Source ID
     */
     ...
     */
    declare public /*out*/ readonly usedCapacityInBytes: pulumi.Output<number>;
    ...
    constructor(name: string, argsOrState?: BackupResourceArgs | BackupResourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["metaInformation"] = state?.metaInformation;
            resourceInputs["plans"] = state?.plans;
            resourceInputs["recoveryPointNumber"] = state?.recoveryPointNumber;
            resourceInputs["resourceId"] = state?.resourceId;
            resourceInputs["resourceType"] = state?.resourceType;
            resourceInputs["status"] = state?.status;
            resourceInputs["updatedTime"] = state?.updatedTime;
            resourceInputs["usedCapacityInBytes"] = state?.usedCapacityInBytes;
        } else {
...
export interface BackupResourceState {
     ...
     * Resource meta information (used to store additional configuration when creating a backup plan). ECS full backup parameters: see the EcsBackupConfiguration structure. vePFS backup parameters: see the VePFSBackupConfiguration structure.
     */
    metaInformation?: pulumi.Input<inputs.cbr.BackupResourceMetaInformation | undefined>;
    /**
     * List of Associated Backup Plans
     * Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
     */
    plans?: pulumi.Input<pulumi.Input<inputs.cbr.BackupResourcePlan>[] | undefined>;
    /**
     * Number of Restore Points
     */
    recoveryPointNumber?: pulumi.Input<number | undefined>;
    /**
     * Backup Source ID
     */
     ...
     * Bytes Already Backed Up
     */
    usedCapacityInBytes?: pulumi.Input<number | undefined>;
}
