 ...
 *
 * const cBRBackupPlanDemo = new volcenginecc.cbr.BackupPlan("CBRBackupPlanDemo", {
...
export class BackupPlan extends pulumi.CustomResource {
     ...
     * Backup Policy
     */
    declare public /*out*/ readonly policy: pulumi.Output<outputs.cbr.BackupPlanPolicy>;
    /**
     * Backup Policy ID
     */
     ...
     */
    declare public readonly resourceLists: pulumi.Output<outputs.cbr.BackupPlanResourceList[]>;
    /**
     * Update Time
     */
...
export interface BackupPlanState {
     ...
     * Backup Policy
     */
    policy?: pulumi.Input<inputs.cbr.BackupPlanPolicy | undefined>;
    /**
     * Backup Policy ID
     */
     ...
     * Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
     */
    resourceLists?: pulumi.Input<pulumi.Input<inputs.cbr.BackupPlanResourceList>[] | undefined>;
    /**
     * Update Time
     */
