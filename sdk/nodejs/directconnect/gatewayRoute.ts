...
export class GatewayRoute extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly directConnectGatewayRouteId: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly nextHopType: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: GatewayRouteArgs | GatewayRouteState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["directConnectGatewayRouteId"] = state?.directConnectGatewayRouteId;
...
export interface GatewayRouteState {
     ...
     * Dedicated gateway route ID.
     */
    directConnectGatewayRouteId?: pulumi.Input<string | undefined>;
    /**
     * Next hop instance ID for the dedicated gateway route.
     */
