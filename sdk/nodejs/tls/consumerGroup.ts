...
export class ConsumerGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly heartbeatTtl: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly orderedConsume: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly topicIdLists: pulumi.Output<string[]>;
    ...
    constructor(name: string, argsOrState?: ConsumerGroupArgs | ConsumerGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["heartbeatTtl"] = state?.heartbeatTtl;
            resourceInputs["orderedConsume"] = state?.orderedConsume;
            resourceInputs["projectId"] = state?.projectId;
            resourceInputs["projectName"] = state?.projectName;
            resourceInputs["topicIdLists"] = state?.topicIdLists;
        } else {
            ...
            if (args?.heartbeatTtl === undefined && !opts.urn) {
                throw new Error("Missing required property 'heartbeatTtl'");
            }
            if (args?.orderedConsume === undefined && !opts.urn) {
                throw new Error("Missing required property 'orderedConsume'");
            }
            if (args?.projectId === undefined && !opts.urn) {
                throw new Error("Missing required property 'projectId'");
            }
            if (args?.topicIdLists === undefined && !opts.urn) {
                throw new Error("Missing required property 'topicIdLists'");
            }
            resourceInputs["consumerGroupName"] = args?.consumerGroupName;
            resourceInputs["heartbeatTtl"] = args?.heartbeatTtl;
            resourceInputs["orderedConsume"] = args?.orderedConsume;
            resourceInputs["projectId"] = args?.projectId;
            resourceInputs["topicIdLists"] = args?.topicIdLists;
...
export interface ConsumerGroupState {
     ...
     * Heartbeat timeout in seconds. Value range: 1~300.
     */
    heartbeatTtl?: pulumi.Input<number | undefined>;
    /**
     * Whether to consume in order. true: Consume in order within the Shard. After a Shard splits, finish consuming data from the original Shard first, then consume data from the new Shards created by the split in parallel. After a Shard merges, finish consuming data from the original Shard first, then consume data from the new Shard created by the merge. false: Do not consume in order. All Shards are consumed simultaneously, and any new Shards created by splitting or merging are also consumed immediately.
     */
    orderedConsume?: pulumi.Input<boolean | undefined>;
    /**
     * ID of the log project to which the consumer group belongs.
     */
     ...
     * List of log topic IDs to be consumed by the consumer group.
     */
    topicIdLists?: pulumi.Input<pulumi.Input<string>[] | undefined>;
}
