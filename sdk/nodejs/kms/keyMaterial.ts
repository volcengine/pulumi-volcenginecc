...
export class KeyMaterial extends pulumi.CustomResource {
     ...
     */
    declare public readonly expirationModel: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly importToken: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: KeyMaterialArgs | KeyMaterialState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["importToken"] = state?.importToken;
            ...
            if (args?.encryptedKeyMaterial === undefined && !opts.urn) {
                throw new Error("Missing required property 'encryptedKeyMaterial'");
            }
            if (args?.importToken === undefined && !opts.urn) {
            ...
            resourceInputs["expirationModel"] = args?.expirationModel;
            resourceInputs["importToken"] = args?.importToken;
...
export interface KeyMaterialState {
     ...
     * The import token obtained after the user calls the interface to retrieve import parameters; this value is passed directly to the ImportKeyMaterial interface.
     */
    importToken?: pulumi.Input<string | undefined>;
    /**
     * Unique identifier of the target master key in UUID format; the Origin of this key must be External.
     */
