...
export class Routing extends pulumi.CustomResource {
     ...
     */
    declare public readonly routingEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public /*out*/ readonly routingStatus: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: RoutingArgs | RoutingState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["routingEnabled"] = state?.routingEnabled;
            resourceInputs["routingStatus"] = state?.routingStatus;
        } else {
            const args = argsOrState as RoutingArgs | undefined;
            resourceInputs["gtmId"] = args?.gtmId;
            resourceInputs["routingEnabled"] = args?.routingEnabled;
...
export interface RoutingState {
     ...
     * Start/stop GTM instance. true: Start GTM instance. false: Stop GTM instance.
     */
    routingEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * Indicates the current lifecycle state of the GTM instance. Value description: init: The GTM instance has been successfully created but not yet configured. configuring_address: Basic rule configuration for GTM is complete, but target address configuration is not yet finished. editing: Both basic configuration and target address have been completed, but the instance is not yet enabled. running: The instance is officially enabled.
     */
    routingStatus?: pulumi.Input<string | undefined>;
}
