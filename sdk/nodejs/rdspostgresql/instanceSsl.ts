...
export class InstanceSsl extends pulumi.CustomResource {
     ...
     */
    declare public readonly forceEncryption: pulumi.Output<boolean>;
    /**
     * Instance ID.
     */
     ...
     */
    declare public /*out*/ readonly tlsVersions: pulumi.Output<string[]>;
...
export interface InstanceSslState {
     ...
     * Is force encryption enabled? Value: true: Yes. false: No.
     */
    forceEncryption?: pulumi.Input<boolean | undefined>;
    /**
     * Instance ID.
     */
