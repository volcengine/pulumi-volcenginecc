...
export class Rule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'volcenginecc:config/rule:Rule';
     ...
     */
    declare public readonly scope: pulumi.Output<outputs.config.RuleScope>;
    /**
     ...
     */
    declare public readonly triggers: pulumi.Output<outputs.config.RuleTrigger[]>;
...
export interface RuleState {
     ...
     * Resource evaluation scope
     */
    scope?: pulumi.Input<inputs.config.RuleScope | undefined>;
    /**
     * Whether to trigger regular rule re-evaluation. If true, StartRuleEvaluation is called during update
     */
     ...
     * Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
     */
    triggers?: pulumi.Input<pulumi.Input<inputs.config.RuleTrigger>[] | undefined>;
}
...
export interface RuleArgs {
     ...
     * Resource evaluation scope
     */
    scope: pulumi.Input<inputs.config.RuleScope>;
    /**
     * Whether to trigger regular rule re-evaluation. If true, StartRuleEvaluation is called during update
     */
    startRuleEvaluation?: pulumi.Input<boolean | undefined>;
     ...
     * Important Note: When using SetNestedAttribute, you must fully define all attributes of its nested structure. Incomplete definitions may cause Terraform to detect unexpected differences during plan comparison, triggering unnecessary resource updates and affecting resource stability and predictability.
     */
    triggers: pulumi.Input<pulumi.Input<inputs.config.RuleTrigger>[]>;
}
