...
export class Accesskey extends pulumi.CustomResource {
     ...
     * Last login time.
     */
    declare public /*out*/ readonly lastLoginDate: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly requestTime: pulumi.Output<string>;
    /**
     * Secret Access Key.
     */
    ...
    constructor(name: string, argsOrState?: AccesskeyArgs | AccesskeyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["lastLoginDate"] = state?.lastLoginDate;
            resourceInputs["region"] = state?.region;
            resourceInputs["requestTime"] = state?.requestTime;
