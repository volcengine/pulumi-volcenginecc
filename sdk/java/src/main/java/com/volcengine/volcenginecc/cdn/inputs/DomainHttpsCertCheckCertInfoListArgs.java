...
import com.volcengine.volcenginecc.cdn.inputs.DomainHttpsCertCheckCertInfoListCertificateArgs;
...
public final class DomainHttpsCertCheckCertInfoListArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainHttpsCertCheckCertInfoListArgs Empty = new DomainHttpsCertCheckCertInfoListArgs();
    ...
    private @Nullable Output<DomainHttpsCertCheckCertInfoListCertificateArgs> certificate;

    /**
     * @return Indicates a CA certificate to be uploaded. The uploaded certificate is hosted on the content delivery network.
     * 
     */
    public Optional<Output<DomainHttpsCertCheckCertInfoListCertificateArgs>> certificate() {
    ...
    private DomainHttpsCertCheckCertInfoListArgs() {}

    private DomainHttpsCertCheckCertInfoListArgs(DomainHttpsCertCheckCertInfoListArgs $) {
        this.certId = $.certId;
    ...
    public static Builder builder(DomainHttpsCertCheckCertInfoListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainHttpsCertCheckCertInfoListArgs();
        }

        public Builder(DomainHttpsCertCheckCertInfoListArgs defaults) {
            $ = new DomainHttpsCertCheckCertInfoListArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder certificate(@Nullable Output<DomainHttpsCertCheckCertInfoListCertificateArgs> certificate) {
         ...
         * 
         */
        public Builder certificate(DomainHttpsCertCheckCertInfoListCertificateArgs certificate) {
        ...
        public DomainHttpsCertCheckCertInfoListArgs build() {
            return $;
        }
    }
