...
public final class DefaultNodePoolNodeStatistics {
    ...
    public static Builder builder(DefaultNodePoolNodeStatistics defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer updatingCount;
        public Builder() {}
        public Builder(DefaultNodePoolNodeStatistics defaults) {
        ...
        public DefaultNodePoolNodeStatistics build() {
            final var _resultValue = new DefaultNodePoolNodeStatistics();
