...
public final class InstanceInstanceConfigurationHotNodeResourceSpec {
    ...
    public static Builder builder(InstanceInstanceConfigurationHotNodeResourceSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(InstanceInstanceConfigurationHotNodeResourceSpec defaults) {
        ...
        public InstanceInstanceConfigurationHotNodeResourceSpec build() {
            final var _resultValue = new InstanceInstanceConfigurationHotNodeResourceSpec();
