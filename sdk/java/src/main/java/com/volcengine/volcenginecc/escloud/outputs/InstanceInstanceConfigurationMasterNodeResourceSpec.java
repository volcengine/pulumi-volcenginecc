...
public final class InstanceInstanceConfigurationMasterNodeResourceSpec {
    ...
    public static Builder builder(InstanceInstanceConfigurationMasterNodeResourceSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(InstanceInstanceConfigurationMasterNodeResourceSpec defaults) {
        ...
        public InstanceInstanceConfigurationMasterNodeResourceSpec build() {
            final var _resultValue = new InstanceInstanceConfigurationMasterNodeResourceSpec();
