...
@CustomType
public final class GroupRuleScopeResourceTypes {
    /**
     * @return Exclude list
     * 
     */
    ...
    private GroupRuleScopeResourceTypes() {}
    /**
     * @return Exclude list
     * 
     */
    ...
    public static Builder builder(GroupRuleScopeResourceTypes defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(GroupRuleScopeResourceTypes defaults) {
        ...
        public GroupRuleScopeResourceTypes build() {
            final var _resultValue = new GroupRuleScopeResourceTypes();
