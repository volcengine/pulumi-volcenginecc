...
public final class DomainBrowserCacheCacheAction {
    ...
    public static Builder builder(DomainBrowserCacheCacheAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer ttl;
        public Builder() {}
        public Builder(DomainBrowserCacheCacheAction defaults) {
        ...
        public DomainBrowserCacheCacheAction build() {
            final var _resultValue = new DomainBrowserCacheCacheAction();
