...
@CustomType
public final class GroupRuleScopeProjects {
    /**
     * @return Exclude list
     * 
     */
    ...
    private GroupRuleScopeProjects() {}
    /**
     * @return Exclude list
     * 
     */
    ...
    public static Builder builder(GroupRuleScopeProjects defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(GroupRuleScopeProjects defaults) {
        ...
        public GroupRuleScopeProjects build() {
            final var _resultValue = new GroupRuleScopeProjects();
