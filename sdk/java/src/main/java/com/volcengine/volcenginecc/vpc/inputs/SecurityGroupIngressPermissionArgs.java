...
public final class SecurityGroupIngressPermissionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private SecurityGroupIngressPermissionArgs() {}

    private SecurityGroupIngressPermissionArgs(SecurityGroupIngressPermissionArgs $) {
        this.cidrIp = $.cidrIp;
    ...
    public static Builder builder(SecurityGroupIngressPermissionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityGroupIngressPermissionArgs();
        }

        public Builder(SecurityGroupIngressPermissionArgs defaults) {
            $ = new SecurityGroupIngressPermissionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityGroupIngressPermissionArgs build() {
            return $;
        }
    }
