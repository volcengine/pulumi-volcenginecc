...
@CustomType
public final class GetDomainBrowserCacheCacheAction {
    /**
    ...
    private GetDomainBrowserCacheCacheAction() {}
    /**
     * @return Indicates caching behavior. Currently, you can only specify cache. cache means the behavior is caching.
     *
     */
    ...
    public static Builder builder(GetDomainBrowserCacheCacheAction defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ttl;
        public Builder() {}
        public Builder(GetDomainBrowserCacheCacheAction defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("GetDomainBrowserCacheCacheAction", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder defaultPolicy(String defaultPolicy) {
            if (defaultPolicy == null) {
              throw new MissingRequiredPropertyException("GetDomainBrowserCacheCacheAction", "defaultPolicy");
            }
        ...
        public Builder ignoreCase(Boolean ignoreCase) {
            if (ignoreCase == null) {
              throw new MissingRequiredPropertyException("GetDomainBrowserCacheCacheAction", "ignoreCase");
            }
        ...
        public Builder ttl(Integer ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetDomainBrowserCacheCacheAction", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetDomainBrowserCacheCacheAction build() {
            final var _resultValue = new GetDomainBrowserCacheCacheAction();
