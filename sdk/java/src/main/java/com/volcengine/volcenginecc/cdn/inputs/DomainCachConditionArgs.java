...
import com.volcengine.volcenginecc.cdn.inputs.DomainCachConditionConditionRuleArgs;
...
public final class DomainCachConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainCachConditionArgs Empty = new DomainCachConditionArgs();

    @Import(name="conditionRules")
    private @Nullable Output<List<DomainCachConditionConditionRuleArgs>> conditionRules;

    public Optional<Output<List<DomainCachConditionConditionRuleArgs>>> conditionRules() {
    ...
    private DomainCachConditionArgs() {}

    private DomainCachConditionArgs(DomainCachConditionArgs $) {
    ...
    public static Builder builder(DomainCachConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainCachConditionArgs();
        }

        public Builder(DomainCachConditionArgs defaults) {
            $ = new DomainCachConditionArgs(Objects.requireNonNull(defaults));
        }

        public Builder conditionRules(@Nullable Output<List<DomainCachConditionConditionRuleArgs>> conditionRules) {
            $.conditionRules = conditionRules;
            return this;
        }

        public Builder conditionRules(List<DomainCachConditionConditionRuleArgs> conditionRules) {
            return conditionRules(Output.of(conditionRules));
        }

        public Builder conditionRules(DomainCachConditionConditionRuleArgs... conditionRules) {
        ...
        public DomainCachConditionArgs build() {
            return $;
        }
    }
