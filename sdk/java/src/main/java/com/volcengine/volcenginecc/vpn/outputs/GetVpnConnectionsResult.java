...
public final class GetVpnConnectionsResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder ids(List<String> ids) {
            if (ids == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionsResult", "ids");
            }
            this.ids = ids;
            return this;
        }
        ...
        public GetVpnConnectionsResult build() {
            final var _resultValue = new GetVpnConnectionsResult();
            _resultValue.id = id;
