...
@CustomType
public final class DomainCacheKeyConditionConditionRule {
    /**
    ...
    private DomainCacheKeyConditionConditionRule() {}
    /**
     * @return When Object is query*name or customize, this parameter is valid. If Object is query*name, this parameter indicates the name of a query parameter. If Object is customize, this parameter indicates the name of a custom header. The length of Name cannot exceed 256 characters and can include digits, letters, percent sign (%), underscore (_), and hyphen (-).
     * 
     */
    ...
    public static Builder builder(DomainCacheKeyConditionConditionRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DomainCacheKeyConditionConditionRule defaults) {
        ...
        public DomainCacheKeyConditionConditionRule build() {
            final var _resultValue = new DomainCacheKeyConditionConditionRule();
