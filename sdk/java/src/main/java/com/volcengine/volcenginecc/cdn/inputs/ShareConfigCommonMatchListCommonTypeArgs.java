...
public final class ShareConfigCommonMatchListCommonTypeArgs extends com.pulumi.resources.ResourceArgs {

    public static final ShareConfigCommonMatchListCommonTypeArgs Empty = new ShareConfigCommonMatchListCommonTypeArgs();
    ...
    private ShareConfigCommonMatchListCommonTypeArgs() {}

    private ShareConfigCommonMatchListCommonTypeArgs(ShareConfigCommonMatchListCommonTypeArgs $) {
    ...
    public static Builder builder(ShareConfigCommonMatchListCommonTypeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ShareConfigCommonMatchListCommonTypeArgs();
        }

        public Builder(ShareConfigCommonMatchListCommonTypeArgs defaults) {
            $ = new ShareConfigCommonMatchListCommonTypeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ShareConfigCommonMatchListCommonTypeArgs build() {
            return $;
        }
    }
