...
public final class DomainBrowserCacheConditionConditionRule {
    ...
    public static Builder builder(DomainBrowserCacheConditionConditionRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DomainBrowserCacheConditionConditionRule defaults) {
        ...
        public DomainBrowserCacheConditionConditionRule build() {
            final var _resultValue = new DomainBrowserCacheConditionConditionRule();
