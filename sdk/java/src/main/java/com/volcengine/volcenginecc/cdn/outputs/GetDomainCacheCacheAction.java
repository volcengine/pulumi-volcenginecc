...
public final class GetDomainCacheCacheAction {
    ...
    public static Builder builder(GetDomainCacheCacheAction defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ttl;
        public Builder() {}
        public Builder(GetDomainCacheCacheAction defaults) {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCacheAction", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder defaultPolicy(String defaultPolicy) {
            if (defaultPolicy == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCacheAction", "defaultPolicy");
            }
        ...
        public Builder ignoreCase(Boolean ignoreCase) {
            if (ignoreCase == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCacheAction", "ignoreCase");
            }
        ...
        public Builder ttl(Integer ttl) {
            if (ttl == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCacheAction", "ttl");
            }
            this.ttl = ttl;
            return this;
        }
        public GetDomainCacheCacheAction build() {
            final var _resultValue = new GetDomainCacheCacheAction();
