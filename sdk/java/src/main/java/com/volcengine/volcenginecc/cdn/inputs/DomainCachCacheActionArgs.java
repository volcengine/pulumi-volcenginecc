...
public final class DomainCachCacheActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DomainCachCacheActionArgs() {}

    private DomainCachCacheActionArgs(DomainCachCacheActionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(DomainCachCacheActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainCachCacheActionArgs();
        }

        public Builder(DomainCachCacheActionArgs defaults) {
            $ = new DomainCachCacheActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainCachCacheActionArgs build() {
            return $;
        }
    }
