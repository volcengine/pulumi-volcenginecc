...
@CustomType
public final class InstanceDataVolume {
    /**
    ...
    public static Builder builder(InstanceDataVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String volumeType;
        public Builder() {}
        public Builder(InstanceDataVolume defaults) {
        ...
        public InstanceDataVolume build() {
            final var _resultValue = new InstanceDataVolume();
