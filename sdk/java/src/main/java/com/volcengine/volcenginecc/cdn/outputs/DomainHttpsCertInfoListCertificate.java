...
@CustomType
public final class DomainHttpsCertInfoListCertificate {
    /**
    ...
    private DomainHttpsCertInfoListCertificate() {}
    /**
     * @return Indicates the content of the certificate file. Line breaks in the content must be replaced with \r\n. The certificate file extension is .crt or .pem, and the certificate file must include the complete certificate chain.
     * 
     */
    ...
    public static Builder builder(DomainHttpsCertInfoListCertificate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String privateKey;
        public Builder() {}
        public Builder(DomainHttpsCertInfoListCertificate defaults) {
        ...
        public DomainHttpsCertInfoListCertificate build() {
            final var _resultValue = new DomainHttpsCertInfoListCertificate();
