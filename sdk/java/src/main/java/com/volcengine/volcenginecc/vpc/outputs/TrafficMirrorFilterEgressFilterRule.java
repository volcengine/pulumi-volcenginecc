...
@CustomType
public final class TrafficMirrorFilterEgressFilterRule {
    /**
     * @return 筛选规则实例描述。
     * 
     */
    ...
    public static Builder builder(TrafficMirrorFilterEgressFilterRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String trafficMirrorFilterRuleId;
        public Builder() {}
        public Builder(TrafficMirrorFilterEgressFilterRule defaults) {
        ...
        public TrafficMirrorFilterEgressFilterRule build() {
            final var _resultValue = new TrafficMirrorFilterEgressFilterRule();
