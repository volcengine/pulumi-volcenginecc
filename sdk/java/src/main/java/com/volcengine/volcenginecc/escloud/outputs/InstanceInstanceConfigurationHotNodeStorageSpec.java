...
public final class InstanceInstanceConfigurationHotNodeStorageSpec {
    ...
    public static Builder builder(InstanceInstanceConfigurationHotNodeStorageSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer size;
        public Builder() {}
        public Builder(InstanceInstanceConfigurationHotNodeStorageSpec defaults) {
        ...
        public InstanceInstanceConfigurationHotNodeStorageSpec build() {
            final var _resultValue = new InstanceInstanceConfigurationHotNodeStorageSpec();
