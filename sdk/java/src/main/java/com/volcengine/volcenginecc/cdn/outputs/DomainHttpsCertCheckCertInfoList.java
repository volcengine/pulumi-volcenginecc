...
import com.volcengine.volcenginecc.cdn.outputs.DomainHttpsCertCheckCertInfoListCertificate;
...
@CustomType
public final class DomainHttpsCertCheckCertInfoList {
    /**
     ...
     * 
     */
    private @Nullable DomainHttpsCertCheckCertInfoListCertificate certificate;
    /**
    ...
    private DomainHttpsCertCheckCertInfoList() {}
    /**
     * @return 表示一个托管在内容分发网络的 CA 证书的 ID。ID 是以 cert_hosting  - 开头的。
     * 
     */
     ...
     * 
     */
    public Optional<DomainHttpsCertCheckCertInfoListCertificate> certificate() {
    ...
    public static Builder builder(DomainHttpsCertCheckCertInfoList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String source;
        public Builder() {}
        public Builder(DomainHttpsCertCheckCertInfoList defaults) {
        ...
        @CustomType.Setter
        public Builder certificate(@Nullable DomainHttpsCertCheckCertInfoListCertificate certificate) {
        ...
        public DomainHttpsCertCheckCertInfoList build() {
            final var _resultValue = new DomainHttpsCertCheckCertInfoList();
