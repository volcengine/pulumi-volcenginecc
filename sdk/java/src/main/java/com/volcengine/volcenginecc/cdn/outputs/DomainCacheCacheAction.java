...
@CustomType
public final class DomainCacheCacheAction {
    /**
    ...
    private DomainCacheCacheAction() {}
    /**
     * @return Indicates caching behavior. Currently, you can only specify cache. cache means the behavior is caching.
     *
     */
    ...
    public static Builder builder(DomainCacheCacheAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer ttl;
        public Builder() {}
        public Builder(DomainCacheCacheAction defaults) {
        ...
        public DomainCacheCacheAction build() {
            final var _resultValue = new DomainCacheCacheAction();
