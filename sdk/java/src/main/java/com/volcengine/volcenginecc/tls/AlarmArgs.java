...
public final class AlarmArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<AlarmRequestCycleArgs> requestCycle;

    /**
     * @return Monitoring task execution statement.
     * 
     */
    public Output<AlarmRequestCycleArgs> requestCycle() {
     ...
     * 
     */
    @Import(name="triggerPeriod", required=true)
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder requestCycle(Output<AlarmRequestCycleArgs> requestCycle) {
         ...
         * 
         */
        public Builder triggerPeriod(Output<Integer> triggerPeriod) {
        ...
        public AlarmArgs build() {
            if ($.alarmName == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "alarmName");
            }
            if ($.alarmNotifyGroups == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "alarmNotifyGroups");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "projectId");
            }
            if ($.queryRequests == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "queryRequests");
            }
            if ($.requestCycle == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "requestCycle");
            }
            if ($.triggerPeriod == null) {
                throw new MissingRequiredPropertyException("AlarmArgs", "triggerPeriod");
            }
            return $;
        }
    }
