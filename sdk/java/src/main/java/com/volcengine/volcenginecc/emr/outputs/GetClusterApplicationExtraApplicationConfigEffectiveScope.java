...
@CustomType
public final class GetClusterApplicationExtraApplicationConfigEffectiveScope {
    /**
    ...
    private GetClusterApplicationExtraApplicationConfigEffectiveScope() {}
    /**
     * @return Component name list. Required when EffectiveType=COMPONENT_NAME.
     * 
     */
    ...
    public static Builder builder(GetClusterApplicationExtraApplicationConfigEffectiveScope defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> nodeNames;
        public Builder() {}
        public Builder(GetClusterApplicationExtraApplicationConfigEffectiveScope defaults) {
        ...
        public Builder componentNames(List<String> componentNames) {
            if (componentNames == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "componentNames");
            }
        ...
        public Builder effectiveType(String effectiveType) {
            if (effectiveType == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "effectiveType");
            }
        ...
        public Builder nodeGroupIds(List<String> nodeGroupIds) {
            if (nodeGroupIds == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "nodeGroupIds");
            }
        ...
        public Builder nodeGroupNames(List<String> nodeGroupNames) {
            if (nodeGroupNames == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "nodeGroupNames");
            }
        ...
        public Builder nodeGroupTypes(List<String> nodeGroupTypes) {
            if (nodeGroupTypes == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "nodeGroupTypes");
            }
        ...
        public Builder nodeIds(List<String> nodeIds) {
            if (nodeIds == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "nodeIds");
            }
        ...
        public Builder nodeNames(List<String> nodeNames) {
            if (nodeNames == null) {
              throw new MissingRequiredPropertyException("GetClusterApplicationExtraApplicationConfigEffectiveScope", "nodeNames");
            }
        ...
        public GetClusterApplicationExtraApplicationConfigEffectiveScope build() {
            final var _resultValue = new GetClusterApplicationExtraApplicationConfigEffectiveScope();
