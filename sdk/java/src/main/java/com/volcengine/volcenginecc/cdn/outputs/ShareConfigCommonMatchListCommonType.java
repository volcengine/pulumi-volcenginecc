...
@CustomType
public final class ShareConfigCommonMatchListCommonType {
    /**
    ...
    private ShareConfigCommonMatchListCommonType() {}
    /**
     * @return 表示 Rules 中的条目是否区分大小写。该参数有以下取值：true：表示不区分大小写。false：表示区分大小写。该参数的默认值是 true。
     * 
     */
    ...
    public static Builder builder(ShareConfigCommonMatchListCommonType defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> rules;
        public Builder() {}
        public Builder(ShareConfigCommonMatchListCommonType defaults) {
        ...
        public ShareConfigCommonMatchListCommonType build() {
            final var _resultValue = new ShareConfigCommonMatchListCommonType();
