...
@CustomType
public final class VolumeBaselinePerformance {
    /**
    ...
    private VolumeBaselinePerformance() {}
    /**
     * @return 云盘的总IOPS，即云盘的基准IOPS和额外IOPS之和。
     * 
     */
    ...
    public static Builder builder(VolumeBaselinePerformance defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double throughput;
        public Builder() {}
        public Builder(VolumeBaselinePerformance defaults) {
        ...
        public VolumeBaselinePerformance build() {
            final var _resultValue = new VolumeBaselinePerformance();
