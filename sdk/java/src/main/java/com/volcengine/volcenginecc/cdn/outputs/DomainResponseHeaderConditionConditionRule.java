...
@CustomType
public final class DomainResponseHeaderConditionConditionRule {
    /**
    ...
    private DomainResponseHeaderConditionConditionRule() {}
    /**
     * @return 当 Object 是 query*name 或者 customize 时，该参数有效。如果 Object 是 query*name，该参数表示一个查询参数的名称。如果 Object 是 customize，该参数表示一个自定义头部的名称。Name 的长度不能超过 256 个字符，可以包含数字、字母、百分号（%）、下划线（_）、中划线（-）。
     * 
     */
    ...
    public static Builder builder(DomainResponseHeaderConditionConditionRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DomainResponseHeaderConditionConditionRule defaults) {
        ...
        public DomainResponseHeaderConditionConditionRule build() {
            final var _resultValue = new DomainResponseHeaderConditionConditionRule();
