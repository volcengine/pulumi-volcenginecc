...
public final class ChildCertInstanceEncryptionCertificateDetailIssuerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ChildCertInstanceEncryptionCertificateDetailIssuerArgs Empty = new ChildCertInstanceEncryptionCertificateDetailIssuerArgs();
    ...
    private ChildCertInstanceEncryptionCertificateDetailIssuerArgs() {}

    private ChildCertInstanceEncryptionCertificateDetailIssuerArgs(ChildCertInstanceEncryptionCertificateDetailIssuerArgs $) {
    ...
    public static Builder builder(ChildCertInstanceEncryptionCertificateDetailIssuerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ChildCertInstanceEncryptionCertificateDetailIssuerArgs();
        }

        public Builder(ChildCertInstanceEncryptionCertificateDetailIssuerArgs defaults) {
            $ = new ChildCertInstanceEncryptionCertificateDetailIssuerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ChildCertInstanceEncryptionCertificateDetailIssuerArgs build() {
            return $;
        }
    }
