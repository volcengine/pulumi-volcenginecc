...
public final class NodePoolNodeStatisticsArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodePoolNodeStatisticsArgs Empty = new NodePoolNodeStatisticsArgs();
    ...
    private NodePoolNodeStatisticsArgs() {}

    private NodePoolNodeStatisticsArgs(NodePoolNodeStatisticsArgs $) {
    ...
    public static Builder builder(NodePoolNodeStatisticsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeStatisticsArgs();
        }

        public Builder(NodePoolNodeStatisticsArgs defaults) {
            $ = new NodePoolNodeStatisticsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NodePoolNodeStatisticsArgs build() {
            return $;
        }
    }
