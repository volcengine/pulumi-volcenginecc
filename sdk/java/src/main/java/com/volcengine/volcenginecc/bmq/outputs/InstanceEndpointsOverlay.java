...
@CustomType
public final class InstanceEndpointsOverlay {
    /**
     * @return 域名映射地址。
     * 
     */
    ...
    private InstanceEndpointsOverlay() {}
    /**
     * @return 域名映射地址。
     * 
     */
    ...
    public static Builder builder(InstanceEndpointsOverlay defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> vpcIds;
        public Builder() {}
        public Builder(InstanceEndpointsOverlay defaults) {
        ...
        public InstanceEndpointsOverlay build() {
            final var _resultValue = new InstanceEndpointsOverlay();
