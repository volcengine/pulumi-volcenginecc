...
@CustomType
public final class LaunchTemplateLaunchTemplateVersionVolume {
    /**
    ...
    public static Builder builder(LaunchTemplateLaunchTemplateVersionVolume defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String volumeType;
        public Builder() {}
        public Builder(LaunchTemplateLaunchTemplateVersionVolume defaults) {
        ...
        public LaunchTemplateLaunchTemplateVersionVolume build() {
            final var _resultValue = new LaunchTemplateLaunchTemplateVersionVolume();
