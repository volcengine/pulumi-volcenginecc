...
@CustomType
public final class RuleScopeRegions {
    /**
    ...
    public static Builder builder(RuleScopeRegions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(RuleScopeRegions defaults) {
        ...
        public RuleScopeRegions build() {
            final var _resultValue = new RuleScopeRegions();
