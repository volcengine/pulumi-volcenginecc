...
public final class DomainNegativeCacheNegativeCacheRule {
    ...
    public static Builder builder(DomainNegativeCacheNegativeCacheRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer ttl;
        public Builder() {}
        public Builder(DomainNegativeCacheNegativeCacheRule defaults) {
        ...
        public DomainNegativeCacheNegativeCacheRule build() {
            final var _resultValue = new DomainNegativeCacheNegativeCacheRule();
