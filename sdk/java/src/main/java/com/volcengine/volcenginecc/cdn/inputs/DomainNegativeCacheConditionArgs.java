...
import com.volcengine.volcenginecc.cdn.inputs.DomainNegativeCacheConditionConditionRuleArgs;
...
public final class DomainNegativeCacheConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainNegativeCacheConditionArgs Empty = new DomainNegativeCacheConditionArgs();
    ...
    private @Nullable Output<List<DomainNegativeCacheConditionConditionRuleArgs>> conditionRules;
     ...
     *
     */
    public Optional<Output<List<DomainNegativeCacheConditionConditionRuleArgs>>> conditionRules() {
    ...
    private DomainNegativeCacheConditionArgs() {}

    private DomainNegativeCacheConditionArgs(DomainNegativeCacheConditionArgs $) {
    ...
    public static Builder builder(DomainNegativeCacheConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainNegativeCacheConditionArgs();
        }

        public Builder(DomainNegativeCacheConditionArgs defaults) {
            $ = new DomainNegativeCacheConditionArgs(Objects.requireNonNull(defaults));
        }
         ...
         *
         */
        public Builder conditionRules(@Nullable Output<List<DomainNegativeCacheConditionConditionRuleArgs>> conditionRules) {
         ...
         *
         */
        public Builder conditionRules(List<DomainNegativeCacheConditionConditionRuleArgs> conditionRules) {
         ...
         *
         */
        public Builder conditionRules(DomainNegativeCacheConditionConditionRuleArgs... conditionRules) {
        ...
        public DomainNegativeCacheConditionArgs build() {
            return $;
        }
    }
