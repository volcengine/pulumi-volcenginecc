...
@CustomType
public final class ClusterBootstrapScriptEffectiveScope {
    /**
    ...
    public static Builder builder(ClusterBootstrapScriptEffectiveScope defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> nodeNames;
        public Builder() {}
        public Builder(ClusterBootstrapScriptEffectiveScope defaults) {
        ...
        public ClusterBootstrapScriptEffectiveScope build() {
            final var _resultValue = new ClusterBootstrapScriptEffectiveScope();
