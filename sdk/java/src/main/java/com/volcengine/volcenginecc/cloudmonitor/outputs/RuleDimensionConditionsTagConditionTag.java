...
public final class RuleDimensionConditionsTagConditionTag {
    ...
    public static Builder builder(RuleDimensionConditionsTagConditionTag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(RuleDimensionConditionsTagConditionTag defaults) {
        ...
        public RuleDimensionConditionsTagConditionTag build() {
            final var _resultValue = new RuleDimensionConditionsTagConditionTag();
