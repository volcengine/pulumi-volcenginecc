...
public final class DomainNegativeCacheNegativeCacheRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainNegativeCacheNegativeCacheRuleArgs Empty = new DomainNegativeCacheNegativeCacheRuleArgs();
    ...
    private DomainNegativeCacheNegativeCacheRuleArgs() {}

    private DomainNegativeCacheNegativeCacheRuleArgs(DomainNegativeCacheNegativeCacheRuleArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(DomainNegativeCacheNegativeCacheRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainNegativeCacheNegativeCacheRuleArgs();
        }

        public Builder(DomainNegativeCacheNegativeCacheRuleArgs defaults) {
            $ = new DomainNegativeCacheNegativeCacheRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainNegativeCacheNegativeCacheRuleArgs build() {
            return $;
        }
    }
