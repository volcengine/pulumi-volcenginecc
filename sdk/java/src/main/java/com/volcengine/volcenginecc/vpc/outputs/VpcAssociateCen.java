...
public final class VpcAssociateCen {
    ...
    public static Builder builder(VpcAssociateCen defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String cenStatus;
        public Builder() {}
        public Builder(VpcAssociateCen defaults) {
        ...
        public VpcAssociateCen build() {
            final var _resultValue = new VpcAssociateCen();
