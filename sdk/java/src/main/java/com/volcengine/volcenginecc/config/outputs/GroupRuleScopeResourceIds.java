...
@CustomType
public final class GroupRuleScopeResourceIds {
    /**
     * @return Exclude list
     * 
     */
    ...
    private GroupRuleScopeResourceIds() {}
    /**
     * @return Exclude list
     * 
     */
    ...
    public static Builder builder(GroupRuleScopeResourceIds defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(GroupRuleScopeResourceIds defaults) {
        ...
        public GroupRuleScopeResourceIds build() {
            final var _resultValue = new GroupRuleScopeResourceIds();
