...
import com.volcengine.volcenginecc.tls.outputs.GetIndexKeyValueValueJsonKey;
...
@CustomType
public final class GetIndexKeyValueValue {
    /**
     ...
     * 
     */
    private List<GetIndexKeyValueValueJsonKey> jsonKeys;
    /**
     ...
     * 
     */
    public List<GetIndexKeyValueValueJsonKey> jsonKeys() {
    ...
    public static Builder builder(GetIndexKeyValueValue defaults) {
    ...
    public static final class Builder {
        ...
        private String valueType;
        public Builder() {}
        public Builder(GetIndexKeyValueValue defaults) {
        ...
        public Builder autoIndexFlag(Boolean autoIndexFlag) {
            if (autoIndexFlag == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "autoIndexFlag");
            }
        ...
        public Builder caseSensitive(Boolean caseSensitive) {
            if (caseSensitive == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "caseSensitive");
            }
        ...
        public Builder delimiter(String delimiter) {
            if (delimiter == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "delimiter");
            }
        ...
        public Builder includeChinese(Boolean includeChinese) {
            if (includeChinese == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "includeChinese");
            }
        ...
        public Builder indexAll(Boolean indexAll) {
            if (indexAll == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "indexAll");
            }
        ...
        public Builder indexSqlAll(Boolean indexSqlAll) {
            if (indexSqlAll == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "indexSqlAll");
            }
            this.indexSqlAll = indexSqlAll;
            return this;
        }
        @CustomType.Setter
        public Builder jsonKeys(List<GetIndexKeyValueValueJsonKey> jsonKeys) {
            if (jsonKeys == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "jsonKeys");
            }
            this.jsonKeys = jsonKeys;
            return this;
        }
        public Builder jsonKeys(GetIndexKeyValueValueJsonKey... jsonKeys) {
            return jsonKeys(List.of(jsonKeys));
        }
        @CustomType.Setter
        public Builder sqlFlag(Boolean sqlFlag) {
            if (sqlFlag == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "sqlFlag");
            }
        ...
        public Builder valueType(String valueType) {
            if (valueType == null) {
              throw new MissingRequiredPropertyException("GetIndexKeyValueValue", "valueType");
            }
            this.valueType = valueType;
            return this;
        }
        public GetIndexKeyValueValue build() {
            final var _resultValue = new GetIndexKeyValueValue();
