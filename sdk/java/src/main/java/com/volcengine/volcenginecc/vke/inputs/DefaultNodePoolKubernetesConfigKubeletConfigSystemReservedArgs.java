...
public final class DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs() {}

    private DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs(DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs();
        }

        public Builder(DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs defaults) {
            $ = new DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DefaultNodePoolKubernetesConfigKubeletConfigSystemReservedArgs build() {
            return $;
        }
    }
