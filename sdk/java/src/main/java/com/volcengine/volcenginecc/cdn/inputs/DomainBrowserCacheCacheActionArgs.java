...
public final class DomainBrowserCacheCacheActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainBrowserCacheCacheActionArgs Empty = new DomainBrowserCacheCacheActionArgs();
    ...
    private DomainBrowserCacheCacheActionArgs() {}

    private DomainBrowserCacheCacheActionArgs(DomainBrowserCacheCacheActionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(DomainBrowserCacheCacheActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainBrowserCacheCacheActionArgs();
        }

        public Builder(DomainBrowserCacheCacheActionArgs defaults) {
            $ = new DomainBrowserCacheCacheActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainBrowserCacheCacheActionArgs build() {
            return $;
        }
    }
