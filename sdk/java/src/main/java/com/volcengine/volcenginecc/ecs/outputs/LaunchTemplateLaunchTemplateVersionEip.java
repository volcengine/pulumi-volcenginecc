...
@CustomType
public final class LaunchTemplateLaunchTemplateVersionEip {
    /**
    ...
    private LaunchTemplateLaunchTemplateVersionEip() {}
    /**
     * @return Public IP bandwidth cap, unit: Mbps. Value range: 1–200. Default: 1.
     * 
     */
    ...
    public static Builder builder(LaunchTemplateLaunchTemplateVersionEip defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> securityProtectionTypes;
        public Builder() {}
        public Builder(LaunchTemplateLaunchTemplateVersionEip defaults) {
        ...
        public LaunchTemplateLaunchTemplateVersionEip build() {
            final var _resultValue = new LaunchTemplateLaunchTemplateVersionEip();
