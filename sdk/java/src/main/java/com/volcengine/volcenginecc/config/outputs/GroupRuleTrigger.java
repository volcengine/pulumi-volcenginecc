...
@CustomType
public final class GroupRuleTrigger {
    /**
    ...
    public static Builder builder(GroupRuleTrigger defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String triggerType;
        public Builder() {}
        public Builder(GroupRuleTrigger defaults) {
        ...
        public GroupRuleTrigger build() {
            final var _resultValue = new GroupRuleTrigger();
