...
import com.volcengine.volcenginecc.cdn.outputs.GetDomainCacheConditionConditionRule;
...
public final class GetDomainCacheCondition {
    ...
    public static Builder builder(GetDomainCacheCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String connective;
        public Builder() {}
        public Builder(GetDomainCacheCondition defaults) {
        ...
        @CustomType.Setter
        public Builder conditionRules(List<GetDomainCacheConditionConditionRule> conditionRules) {
            if (conditionRules == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCondition", "conditionRules");
            }
            this.conditionRules = conditionRules;
            return this;
        }
        public Builder conditionRules(GetDomainCacheConditionConditionRule... conditionRules) {
            return conditionRules(List.of(conditionRules));
        }
        @CustomType.Setter
        public Builder connective(String connective) {
            if (connective == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheCondition", "connective");
            }
            this.connective = connective;
            return this;
        }
        public GetDomainCacheCondition build() {
            final var _resultValue = new GetDomainCacheCondition();
