...
import com.volcengine.volcenginecc.cdn.inputs.DomainBrowserCacheConditionConditionRuleArgs;
...
public final class DomainBrowserCacheConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainBrowserCacheConditionArgs Empty = new DomainBrowserCacheConditionArgs();
    ...
    private @Nullable Output<List<DomainBrowserCacheConditionConditionRuleArgs>> conditionRules;
     ...
     *
     */
    public Optional<Output<List<DomainBrowserCacheConditionConditionRuleArgs>>> conditionRules() {
    ...
    private DomainBrowserCacheConditionArgs() {}

    private DomainBrowserCacheConditionArgs(DomainBrowserCacheConditionArgs $) {
    ...
    public static Builder builder(DomainBrowserCacheConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainBrowserCacheConditionArgs();
        }

        public Builder(DomainBrowserCacheConditionArgs defaults) {
            $ = new DomainBrowserCacheConditionArgs(Objects.requireNonNull(defaults));
        }
         ...
         *
         */
        public Builder conditionRules(@Nullable Output<List<DomainBrowserCacheConditionConditionRuleArgs>> conditionRules) {
         ...
         *
         */
        public Builder conditionRules(List<DomainBrowserCacheConditionConditionRuleArgs> conditionRules) {
         ...
         *
         */
        public Builder conditionRules(DomainBrowserCacheConditionConditionRuleArgs... conditionRules) {
        ...
        public DomainBrowserCacheConditionArgs build() {
            return $;
        }
    }
