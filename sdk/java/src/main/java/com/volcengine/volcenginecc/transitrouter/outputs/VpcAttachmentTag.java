...
public final class VpcAttachmentTag {
    ...
    public static Builder builder(VpcAttachmentTag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(VpcAttachmentTag defaults) {
        ...
        public VpcAttachmentTag build() {
            final var _resultValue = new VpcAttachmentTag();
