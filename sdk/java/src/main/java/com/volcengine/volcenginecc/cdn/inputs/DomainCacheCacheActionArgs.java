...
public final class DomainCacheCacheActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainCacheCacheActionArgs Empty = new DomainCacheCacheActionArgs();
    ...
    private DomainCacheCacheActionArgs() {}

    private DomainCacheCacheActionArgs(DomainCacheCacheActionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(DomainCacheCacheActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainCacheCacheActionArgs();
        }

        public Builder(DomainCacheCacheActionArgs defaults) {
            $ = new DomainCacheCacheActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainCacheCacheActionArgs build() {
            return $;
        }
    }
