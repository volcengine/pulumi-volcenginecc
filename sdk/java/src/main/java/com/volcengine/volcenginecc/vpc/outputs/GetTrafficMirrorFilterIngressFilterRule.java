...
@CustomType
public final class GetTrafficMirrorFilterIngressFilterRule {
    /**
    ...
    private GetTrafficMirrorFilterIngressFilterRule() {}
    /**
     * @return Filter rule instance description
     * 
     */
    ...
    public static Builder builder(GetTrafficMirrorFilterIngressFilterRule defaults) {
    ...
    public static final class Builder {
        ...
        private String trafficMirrorFilterRuleId;
        public Builder() {}
        public Builder(GetTrafficMirrorFilterIngressFilterRule defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "description");
            }
        ...
        public Builder destinationCidrBlock(String destinationCidrBlock) {
            if (destinationCidrBlock == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "destinationCidrBlock");
            }
        ...
        public Builder destinationPortRange(String destinationPortRange) {
            if (destinationPortRange == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "destinationPortRange");
            }
        ...
        public Builder policy(String policy) {
            if (policy == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "policy");
            }
            this.policy = policy;
            return this;
        }
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "priority");
            }
        ...
        public Builder projectName(String projectName) {
            if (projectName == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "projectName");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "protocol");
            }
        ...
        public Builder sourceCidrBlock(String sourceCidrBlock) {
            if (sourceCidrBlock == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "sourceCidrBlock");
            }
        ...
        public Builder sourcePortRange(String sourcePortRange) {
            if (sourcePortRange == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "sourcePortRange");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder trafficDirection(String trafficDirection) {
            if (trafficDirection == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "trafficDirection");
            }
        ...
        public Builder trafficMirrorFilterId(String trafficMirrorFilterId) {
            if (trafficMirrorFilterId == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "trafficMirrorFilterId");
            }
        ...
        public Builder trafficMirrorFilterRuleId(String trafficMirrorFilterRuleId) {
            if (trafficMirrorFilterRuleId == null) {
              throw new MissingRequiredPropertyException("GetTrafficMirrorFilterIngressFilterRule", "trafficMirrorFilterRuleId");
            }
            this.trafficMirrorFilterRuleId = trafficMirrorFilterRuleId;
            return this;
        }
        public GetTrafficMirrorFilterIngressFilterRule build() {
            final var _resultValue = new GetTrafficMirrorFilterIngressFilterRule();
