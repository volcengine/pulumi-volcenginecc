...
@CustomType
public final class RuleScopeResourceTypes {
    /**
    ...
    private RuleScopeResourceTypes() {}
    /**
     * @return Exclusion list
     * 
     */
    ...
    public static Builder builder(RuleScopeResourceTypes defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(RuleScopeResourceTypes defaults) {
        ...
        public RuleScopeResourceTypes build() {
            final var _resultValue = new RuleScopeResourceTypes();
