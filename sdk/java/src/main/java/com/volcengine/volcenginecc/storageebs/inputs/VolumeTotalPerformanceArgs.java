...
public final class VolumeTotalPerformanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final VolumeTotalPerformanceArgs Empty = new VolumeTotalPerformanceArgs();
    ...
    private VolumeTotalPerformanceArgs() {}

    private VolumeTotalPerformanceArgs(VolumeTotalPerformanceArgs $) {
        this.iops = $.iops;
    ...
    public static Builder builder(VolumeTotalPerformanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VolumeTotalPerformanceArgs();
        }

        public Builder(VolumeTotalPerformanceArgs defaults) {
            $ = new VolumeTotalPerformanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VolumeTotalPerformanceArgs build() {
            return $;
        }
    }
