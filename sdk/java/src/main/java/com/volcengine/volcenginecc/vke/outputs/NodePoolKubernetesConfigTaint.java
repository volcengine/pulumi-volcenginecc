...
public final class NodePoolKubernetesConfigTaint {
    ...
    public static Builder builder(NodePoolKubernetesConfigTaint defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(NodePoolKubernetesConfigTaint defaults) {
        ...
        public NodePoolKubernetesConfigTaint build() {
            final var _resultValue = new NodePoolKubernetesConfigTaint();
