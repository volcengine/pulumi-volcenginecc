...
@CustomType
public final class RuleScopeResourceIds {
    /**
    ...
    public static Builder builder(RuleScopeResourceIds defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(RuleScopeResourceIds defaults) {
        ...
        public RuleScopeResourceIds build() {
            final var _resultValue = new RuleScopeResourceIds();
