...
public final class RuleDimensionConditionsTagConditionTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleDimensionConditionsTagConditionTagArgs() {}

    private RuleDimensionConditionsTagConditionTagArgs(RuleDimensionConditionsTagConditionTagArgs $) {
    ...
    public static Builder builder(RuleDimensionConditionsTagConditionTagArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleDimensionConditionsTagConditionTagArgs();
        }

        public Builder(RuleDimensionConditionsTagConditionTagArgs defaults) {
            $ = new RuleDimensionConditionsTagConditionTagArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuleDimensionConditionsTagConditionTagArgs build() {
            return $;
        }
    }
