...
public final class InstanceDataVolumeArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceDataVolumeArgs Empty = new InstanceDataVolumeArgs();
    ...
    private InstanceDataVolumeArgs() {}

    private InstanceDataVolumeArgs(InstanceDataVolumeArgs $) {
    ...
    public static Builder builder(InstanceDataVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceDataVolumeArgs();
        }

        public Builder(InstanceDataVolumeArgs defaults) {
            $ = new InstanceDataVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceDataVolumeArgs build() {
            return $;
        }
    }
