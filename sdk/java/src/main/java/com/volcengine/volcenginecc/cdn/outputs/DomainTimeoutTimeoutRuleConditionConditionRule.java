...
public final class DomainTimeoutTimeoutRuleConditionConditionRule {
    ...
    public static Builder builder(DomainTimeoutTimeoutRuleConditionConditionRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(DomainTimeoutTimeoutRuleConditionConditionRule defaults) {
        ...
        public DomainTimeoutTimeoutRuleConditionConditionRule build() {
            final var _resultValue = new DomainTimeoutTimeoutRuleConditionConditionRule();
