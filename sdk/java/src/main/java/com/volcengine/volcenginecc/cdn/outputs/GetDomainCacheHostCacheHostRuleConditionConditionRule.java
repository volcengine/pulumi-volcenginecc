...
@CustomType
public final class GetDomainCacheHostCacheHostRuleConditionConditionRule {
    /**
    ...
    private GetDomainCacheHostCacheHostRuleConditionConditionRule() {}
    /**
     * @return When Object is query*name or customize, this parameter is valid. If Object is query*name, this parameter indicates the name of a query parameter. If Object is customize, this parameter indicates the name of a custom header. The length of Name cannot exceed 256 characters and can include digits, letters, percent sign (%), underscore (_), and hyphen (-).
     * 
     */
    ...
    public static Builder builder(GetDomainCacheHostCacheHostRuleConditionConditionRule defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(GetDomainCacheHostCacheHostRuleConditionConditionRule defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheHostCacheHostRuleConditionConditionRule", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheHostCacheHostRuleConditionConditionRule", "object");
            }
            this.object = object;
            return this;
        }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheHostCacheHostRuleConditionConditionRule", "operator");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheHostCacheHostRuleConditionConditionRule", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainCacheHostCacheHostRuleConditionConditionRule", "value");
            }
            this.value = value;
            return this;
        }
        public GetDomainCacheHostCacheHostRuleConditionConditionRule build() {
            final var _resultValue = new GetDomainCacheHostCacheHostRuleConditionConditionRule();
