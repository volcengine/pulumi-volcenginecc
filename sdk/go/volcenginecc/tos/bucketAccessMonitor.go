...
func NewBucketAccessMonitor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcenginecc:tos/bucketAccessMonitor:BucketAccessMonitor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketAccessMonitor(ctx *pulumi.Context,
	...
	var resource BucketAccessMonitor
	err := ctx.ReadResource("volcenginecc:tos/bucketAccessMonitor:BucketAccessMonitor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
