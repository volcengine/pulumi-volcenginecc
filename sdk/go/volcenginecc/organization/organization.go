...
func NewOrganization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcenginecc:organization/organization:Organization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganization(ctx *pulumi.Context,
	...
	var resource Organization
	err := ctx.ReadResource("volcenginecc:organization/organization:Organization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
