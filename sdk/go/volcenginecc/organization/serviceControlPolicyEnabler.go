...
type ServiceControlPolicyEnabler struct {
	...
	CanFullAccessDetach pulumi.BoolOutput `pulumi:"canFullAccessDetach"`
	// Organization ID
...
func NewServiceControlPolicyEnabler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcenginecc:organization/serviceControlPolicyEnabler:ServiceControlPolicyEnabler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceControlPolicyEnabler(ctx *pulumi.Context,
	...
	var resource ServiceControlPolicyEnabler
	err := ctx.ReadResource("volcenginecc:organization/serviceControlPolicyEnabler:ServiceControlPolicyEnabler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ServiceControlPolicyEnablerState struct {
	// Can the FullAccess policy be unbound?
	CanFullAccessDetach pulumi.BoolPtrInput
	// Organization ID
...
// Can the FullAccess policy be unbound?
func (o ServiceControlPolicyEnablerOutput) CanFullAccessDetach() pulumi.BoolOutput {
	return o.ApplyT(func(v *ServiceControlPolicyEnabler) pulumi.BoolOutput { return v.CanFullAccessDetach }).(pulumi.BoolOutput)
}

// Organization ID
func (o ServiceControlPolicyEnablerOutput) OrganizationId() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceControlPolicyEnabler) pulumi.StringOutput { return v.OrganizationId }).(pulumi.StringOutput)
}

// Activation status, Enabled Disabled PendingEnable PendingDisable
func (o ServiceControlPolicyEnablerOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceControlPolicyEnabler) pulumi.StringOutput { return v.Status }).(pulumi.StringOutput)
}
