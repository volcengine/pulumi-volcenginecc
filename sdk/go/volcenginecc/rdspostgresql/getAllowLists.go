...
func GetAllowLists(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetAllowListsResult, error) {
	...
	err := ctx.Invoke("volcenginecc:rdspostgresql/getAllowLists:getAllowLists", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAllowListsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAllowListsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetAllowListsResultOutput, error) {
		...
		return ctx.InvokeOutput("volcenginecc:rdspostgresql/getAllowLists:getAllowLists", nil, GetAllowListsResultOutput{}, options).(GetAllowListsResultOutput), nil
