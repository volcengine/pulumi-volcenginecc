...
func GetDatabases(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetDatabasesResult, error) {
	...
	err := ctx.Invoke("volcenginecc:rdspostgresql/getDatabases:getDatabases", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDatabasesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetDatabasesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetDatabasesResultOutput, error) {
		...
		return ctx.InvokeOutput("volcenginecc:rdspostgresql/getDatabases:getDatabases", nil, GetDatabasesResultOutput{}, options).(GetDatabasesResultOutput), nil
