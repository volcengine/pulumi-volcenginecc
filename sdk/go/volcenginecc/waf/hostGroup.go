...
func NewHostGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("volcenginecc:waf/hostGroup:HostGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostGroup(ctx *pulumi.Context,
	...
	var resource HostGroup
	err := ctx.ReadResource("volcenginecc:waf/hostGroup:HostGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Project name.
func (o HostGroupOutput) ProjectName() pulumi.StringOutput {
	return o.ApplyT(func(v *HostGroup) pulumi.StringOutput { return v.ProjectName }).(pulumi.StringOutput)
}
