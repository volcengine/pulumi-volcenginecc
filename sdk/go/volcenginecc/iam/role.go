...
//				TrustPolicyDocument: pulumi.String(json0),
...
// Service associated with the service-linked role to be created.
func (o RoleOutput) ServiceName() pulumi.StringOutput {
	return o.ApplyT(func(v *Role) pulumi.StringOutput { return v.ServiceName }).(pulumi.StringOutput)
}
