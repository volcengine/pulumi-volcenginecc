...
func GetGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetGroupsResult, error) {
	...
	err := ctx.Invoke("volcenginecc:cloudidentity/getGroups:getGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("volcenginecc:cloudidentity/getGroups:getGroups", nil, GetGroupsResultOutput{}, options).(GetGroupsResultOutput), nil
