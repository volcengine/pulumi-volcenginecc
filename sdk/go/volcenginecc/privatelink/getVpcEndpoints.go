...
func GetVpcEndpoints(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpcEndpointsResult, error) {
	opts = internal.PkgInvokeDefaultOpts(opts)
	var rv GetVpcEndpointsResult
	err := ctx.Invoke("volcenginecc:privatelink/getVpcEndpoints:getVpcEndpoints", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpcEndpointsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpcEndpointsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpcEndpointsResultOutput, error) {
		options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
		return ctx.InvokeOutput("volcenginecc:privatelink/getVpcEndpoints:getVpcEndpoints", nil, GetVpcEndpointsResultOutput{}, options).(GetVpcEndpointsResultOutput), nil
