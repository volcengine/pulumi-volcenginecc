...
func GetRepositories(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetRepositoriesResult, error) {
	...
	err := ctx.Invoke("volcenginecc:cr/getRepositories:getRepositories", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRepositoriesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetRepositoriesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetRepositoriesResultOutput, error) {
		...
		return ctx.InvokeOutput("volcenginecc:cr/getRepositories:getRepositories", nil, GetRepositoriesResultOutput{}, options).(GetRepositoriesResultOutput), nil
...
// Set of Resource Identifiers.
func (o GetRepositoriesResultOutput) Ids() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetRepositoriesResult) []string { return v.Ids }).(pulumi.StringArrayOutput)
}
